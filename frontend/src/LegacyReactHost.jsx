...
const LEGACY_STYLES = [
  ...
  "/legacy/excalidraw-dist/rtm-canvas.css?v=049.2.5",
  "/legacy/v040-layout.css?v=046.3",
  "/legacy/v040-inline.css?v=046.3",
  "/legacy/v046-layout.css?v=049.2.5",
  "/legacy/v0492.css?v=049.2.5",
];

const LEGACY_SCRIPTS = [
  ["/legacy/v046-shell.js?v=049.2.5", false],
  ["/legacy/kb-data.js?v=046.3", false],
  ["/legacy/app.js?v=049.2.5", false],
  ["/legacy/v037-overrides.js?v=046.3", false],
  ["/legacy/v039-patch.js?v=046.3", false],
  ["/legacy/v040-assets.js?v=046.3", false],
  ["/legacy/excalidraw-dist/rtm-canvas.js?v=049.2.5", true],
