...
const LEGACY_SCRIPTS = [
  ...
  ["/legacy/excalidraw-dist/rtm-canvas.js?v=050.3.7", true],
  ["/legacy/v046-canvas.js?v=050.3.7", false],
  ...
  ["/legacy/v5037-knowledge.js?v=050.3.7", false],
];
...
export function LegacyReactHost() {
  ...
  useEffect(() => {
    let active = true;
    fetch("/legacy/index.html?v=050.3.7", { cache: "no-store" })
      .then((response) => {
  ...
  if (error) return <div className="v48-load-error">Ошибка запуска v50.3.7: {error}</div>;
