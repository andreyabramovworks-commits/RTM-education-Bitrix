...
const LEGACY_STYLES = [
  ...
  "/legacy/excalidraw-dist/rtm-canvas.css?v=050.2.1",
  "/legacy/v040-layout.css?v=046.3",
  "/legacy/v040-inline.css?v=046.3",
  "/legacy/v046-layout.css?v=050.2.1",
  "/legacy/v0492.css?v=050.2.1",
  "/legacy/v050.css?v=050.2.1",
  "/legacy/v051.css?v=050.2.1",
  "/legacy/v052.css?v=050.2.1",
];

const LEGACY_SCRIPTS = [
  ["/legacy/v046-shell.js?v=050.2.1", false],
  ["/legacy/kb-data.js?v=046.3", false],
  ["/legacy/app.js?v=050.2.1", false],
  ["/legacy/v037-overrides.js?v=046.3", false],
  ["/legacy/v039-patch.js?v=046.3", false],
  ["/legacy/v040-assets.js?v=046.3", false],
  ["/legacy/excalidraw-dist/rtm-canvas.js?v=050.2.1", true],
  ["/legacy/v046-canvas.js?v=050.2.1", false],
  ["/legacy/v047-api.js?v=050.2.1", false],
  ["/legacy/v049.js?v=050.2.1", false],
  ["/legacy/v0492.js?v=050.2.1", false],
  ["/legacy/v050.js?v=050.2.1", false],
  ["/legacy/v051.js?v=050.2.1", false],
  ["/legacy/v052.js?v=050.2.1", false],
];
...
export function LegacyReactHost() {
  ...
  useEffect(() => {
    let active = true;
    fetch("/legacy/index.html?v=050.2.1", { cache: "no-store" })
      .then((response) => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        document.documentElement.dataset.rtmVersion = "50.2.1";
      } catch (cause) {
  ...
  if (error) return <div className="v48-load-error">Ошибка запуска v50.2.1: {error}</div>;
