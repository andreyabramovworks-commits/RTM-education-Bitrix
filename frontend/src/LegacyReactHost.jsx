...
const LEGACY_STYLES = [
  ...
  "/legacy/excalidraw-dist/rtm-canvas.css?v=049.2.8",
...
export function LegacyReactHost() {
  ...
  useEffect(() => {
    let active = true;
    fetch("/legacy/index.html?v=049.2.8", { cache: "no-store" })
      .then((response) => {
