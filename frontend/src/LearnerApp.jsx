...
export function LearnerApp({ bridge, onSetMode }) {
  ...
  const [history, setHistory] = useState([]), [music, setMusic] = useState(false), [track, setTrack] = useState(0), [volume, setVolume] = useState(() => { const saved = Number(localStorage.getItem("rtm_music_volume")); return saved >= 0 && saved <= 0.2 ? saved : 0.1; });
