import { g as q } from "./percentages-BXMCSKIN-CnnmhUBh.js";
function X(P, Y) {
  for (var d = 0; d < Y.length; d++) {
    ...
    if (typeof I != "string" && !Array.isArray(I)) {
      for (const G in I)
        if (G !== "default" && !(G in P)) {
          const _ = Object.getOwnPropertyDescriptor(I, G);
          _ && Object.defineProperty(P, G, _.get ? _ : {
            enumerable: !0,
            get: () => I[G]
          });
        }
  ...
  (function(d) {
    ...
    return (/* @__PURE__ */ function() {
      function d(I, G, _) {
        ...
        for (var A = typeof T == "function" && T, n = 0; n < _.length; n++) o(_[n]);
        return o;
      }
      return d;
    }())({ 1: [function(d, I, G) {
      var _ = d("inherits"), o = d("multimath"), A = d("./mm_unsharp_mask"), n = d("./mm_resize");
      function a(t) {
        var e = t || [], i = {
          js: e.indexOf("js") >= 0,
      ...
      _(a, o), a.prototype.resizeAndUnsharp = function(e, i) {
      ...
      function o(n, a, t, e, i, h) {
        var c, u, v, p, m, w, B, y, E, R, b, F = 0, D = 0;
        for (E = 0; E < e; E++) {
          for (m = 0, R = 0; R < i; R++) {
            for (w = h[m++], B = h[m++], y = F + w * 4 | 0, c = u = v = p = 0; B > 0; B--)
              b = h[m++], p = p + b * n[y + 3] | 0, v = v + b * n[y + 2] | 0, u = u + b * n[y + 1] | 0, c = c + b * n[y] | 0, y = y + 4 | 0;
            a[D + 3] = _(
              p + 8192 >> 14
              /*FIXED_FRAC_BITS*/
            ), a[D + 2] = _(
      ...
      var _ = d("./resize_filter_gen"), o = d("./convolve").convolveHorizontally, A = d("./convolve").convolveVertically;
      function n(a, t, e) {
        for (var i = 3, h = t * e * 4 | 0; i < h; )
          a[i] = 255, i = i + 4 | 0;
      }
      I.exports = function(t) {
        var e = t.src, i = t.width, h = t.height, c = t.toWidth, u = t.toHeight, v = t.scaleX || t.toWidth / t.width, p = t.scaleY || t.toHeight / t.height, m = t.offsetX || 0, w = t.offsetY || 0, B = t.dest || new Uint8Array(c * u * 4), y = typeof t.quality > "u" ? 3 : t.quality, E = t.alpha || !1, R = _(y, i, c, v, m), b = _(y, h, u, p, w), F = new Uint8Array(c * h * 4);
        return o(e, F, i, h, c, R), A(F, B, h, c, u, b), E || n(B, c, u), B;
      };
    }, { "./convolve": 2, "./resize_filter_gen": 6 }], 6: [function(d, I, G) {
      var _ = d("./resize_filter_info"), o = 14;
      function A(n) {
        return Math.round(n * ((1 << o) - 1));
      }
      I.exports = function(a, t, e, i, h) {
        var c = _[a].filter, u = 1 / i, v = Math.min(1, i), p = _[a].win / v, m, w, B, y, E, R, b, F, D, x, S, j, k, r, f, s, l, g = Math.floor((p + 1) * 2), M = new Int16Array((g + 2) * e), C = 0, Q = !M.subarray || !M.set;
        for (m = 0; m < e; m++) {
          for (w = (m + 0.5) * u + h, B = Math.max(0, Math.floor(w - p)), y = Math.min(t - 1, Math.ceil(w + p)), E = y - B + 1, R = new Float32Array(E), b = new Int16Array(E), F = 0, D = B, x = 0; D <= y; D++, x++)
            S = c((D + 0.5 - w) * v), F += S, R[x] = S;
      ...
      var _ = d("glur/mono16");
      function o(A, n, a) {
        for (var t = n * a, e = new Uint16Array(t), i, h, c, u, v = 0; v < t; v++)
          i = A[4 * v], h = A[4 * v + 1], c = A[4 * v + 2], u = i >= h && i >= c ? i : h >= c && h >= i ? h : c, e[v] = u << 8;
        return e;
      }
      I.exports = function(n, a, t, e, i, h) {
        ...
        if (!(e === 0 || i < 0.5)) {
          ...
          for (var y = e / 100 * 4096 + 0.5 | 0, E = h << 8, R = a * t, b = 0; b < R; b++)
            c = w[b], p = c - B[b], Math.abs(p) >= E && (u = c + (y * p + 2048 >> 12), u = u > 65280 ? 65280 : u, u = u < 0 ? 0 : u, c = c !== 0 ? c : 1, v = (u << 12) / c | 0, m = b * 4, n[m] = n[m] * v + 2048 >> 12, n[m + 1] = n[m + 1] * v + 2048 >> 12, n[m + 2] = n[m + 2] * v + 2048 >> 12);
        }
      };
      ...
      I.exports = function(o, A, n, a, t, e) {
        if (!(a === 0 || t < 0.5)) {
          t > 2 && (t = 2);
          var i = A * n, h = i * 4, c = i * 2, u = i * 2, v = Math.max(A, n) * 4, p = 8 * 4, m = 0, w = h, B = w + c, y = B + u, E = y + u, R = E + v, b = this.__instance("unsharp_mask", h + c + u * 2 + v + p, {
            exp: Math.exp
      ...
      I.exports = function(A, n, a, t, e, i) {
        var h = a / A, c = t / n, u = (2 * i + _ + 1) / e;
        if (u > 0.5) return [[a, t]];
        var v = Math.ceil(Math.log(Math.min(h, c)) / Math.log(u));
        if (v <= 1) return [[a, t]];
        for (var p = [], m = 0; m < v; m++) {
          var w = Math.round(Math.pow(Math.pow(A, v - m - 1) * Math.pow(a, m + 1), 1 / v)), B = Math.round(Math.pow(Math.pow(n, v - m - 1) * Math.pow(t, m + 1), 1 / v));
          p.push([w, B]);
        }
        return p;
      };
      ...
      function o(n) {
        var a = Math.round(n);
        return Math.abs(n - a) < _ ? a : Math.floor(n);
      }
      function A(n) {
        var a = Math.round(n);
        return Math.abs(n - a) < _ ? a : Math.ceil(n);
      }
      I.exports = function(a) {
        ...
        for (p = 0; p < a.toHeight; p += h)
          for (v = 0; v < a.toWidth; v += i)
            c = v - a.destTileBorder, c < 0 && (c = 0), m = v + i + a.destTileBorder - c, c + m >= a.toWidth && (m = a.toWidth - c), u = p - a.destTileBorder, u < 0 && (u = 0), w = p + h + a.destTileBorder - u, u + w >= a.toHeight && (w = a.toHeight - u), y = {
              toX: c,
              toY: u,
              toWidth: m,
              toHeight: w,
      ...
      function h(v) {
        v < 0.5 && (v = 0.5);
        var p = Math.exp(0.726 * 0.726) / v, m = Math.exp(-p), w = Math.exp(-2 * p), B = (1 - m) * (1 - m) / (1 + 2 * p * m - w);
        return _ = B, o = B * (p - 1) * m, A = B * (p + 1) * m, n = -B * w, a = 2 * m, t = -w, e = (_ + o) / (1 - a - t), i = (A + n) / (1 - a - t), new Float32Array([_, o, A, n, a, t, e, i]);
      }
      function c(v, p, m, w, B, y) {
        var E, R, b, F, D, x, S, j, k, r, f, s, l, g;
        for (k = 0; k < y; k++) {
          for (x = k * B, S = k, j = 0, E = v[x], D = E * w[6], F = D, f = w[0], s = w[1], l = w[4], g = w[5], r = 0; r < B; r++)
            R = v[x], b = R * f + E * s + F * l + D * g, D = F, F = b, E = R, m[j] = F, j++, x++;
          for (x--, j--, S += y * (B - 1), E = v[x], D = E * w[7], F = D, R = E, f = w[2], s = w[3], r = B - 1; r >= 0; r--)
            b = R * f + E * s + F * l + D * g, D = F, F = b, E = R, R = v[x], p[S] = m[j] + F, x--, j--, S -= y;
        }
      }
      function u(v, p, m, w) {
        if (w) {
          var B = new Uint16Array(v.length), y = new Float32Array(Math.max(p, m)), E = h(w);
          c(v, B, y, E, p, m), c(B, v, y, E, m, p);
        }
      }
      I.exports = u;
    }, {}], 19: [function(d, I, G) {
      ...
      var _ = d("object-assign"), o = d("./lib/base64decode"), A = d("./lib/wa_detect"), n = {
        js: !0,
        wasm: !0
      };
      function a(t) {
      ...
      I.exports = function(A) {
        for (var n = A.replace(/[\r\n=]/g, ""), a = n.length, t = new Uint8Array(a * 3 >> 2), e = 0, i = 0, h = 0; h < a; h++)
          h % 4 === 0 && h && (t[i++] = e >> 16 & 255, t[i++] = e >> 8 & 255, t[i++] = e & 255), e = e << 6 | _.indexOf(n.charAt(h));
        var c = a % 4 * 6;
      ...
      var _;
      I.exports = function() {
        if (typeof _ < "u" || (_ = !1, typeof WebAssembly > "u")) return _;
        try {
          ...
          return a.exports.test(4) !== 0 && (_ = !0), _;
        } catch {
        }
        return _;
      };
    }, {}], 23: [function(d, I, G) {
      var _ = Object.getOwnPropertySymbols, o = Object.prototype.hasOwnProperty, A = Object.prototype.propertyIsEnumerable;
      function n(t) {
        if (t == null)
      ...
      var _ = arguments[3], o = arguments[4], A = arguments[5], n = JSON.stringify;
      I.exports = function(a, t) {
        for (var e, i = Object.keys(A), h = 0, c = i.length; h < c; h++) {
          var u = i[h], v = A[u].exports;
          if (v === a || v && v.default === a) {
            e = u;
            break;
          }
        }
        ...
        var E = "(" + _ + ")({" + Object.keys(B).map(function(x) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
      ...
      var e = d("object-assign"), i = d("webworkify"), h = d("./lib/mathlib"), c = d("./lib/pool"), u = d("./lib/utils"), v = d("./lib/worker"), p = d("./lib/stepper"), m = d("./lib/tiler"), w = {}, B = !1;
      try {
      ...
      k.prototype.init = function() {
        ...
        var M = r.shift(), C = _(M, 2), Q = C[0], U = C[1], O = r.length === 0;
        l = e({}, l, {
          toWidth: Q,
          toHeight: U,
...
var z = W.exports;
const N = /* @__PURE__ */ q(z), K = /* @__PURE__ */ X({
  __proto__: null,
  default: N
}, [z]);
export {
