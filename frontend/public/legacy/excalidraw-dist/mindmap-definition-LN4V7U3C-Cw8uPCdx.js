import { g as oe } from "./chunk-XXDRQBXY-CJivf3X_.js";
import { s as ce } from "./chunk-VR4S4FIN-CMV6Or-p.js";
import { _ as h, l as R, v as le, x as he, z as de, D as z, c as U, i as H, b6 as ge, aa as ue, ab as pe, ac as fe } from "./index-DHQwMcnw.js";
const _ = [];
for (let t = 0; t < 256; ++t)
...
function be(t, e, o) {
  var n;
  t = t || {};
  const l = t.random ?? ((n = t.rng) == null ? void 0 : n.call(t)) ?? Ee();
  if (l.length < 16)
    throw new Error("Random bytes length must be >= 16");
  return l[6] = l[6] & 15 | 64, l[8] = l[8] & 63 | 128, me(l);
}
var K = function() {
  var t = /* @__PURE__ */ h(function(O, s, i, a) {
    for (i = i || {}, a = O.length; a--; i[O[a]] = s) ;
    return i;
  }, "o"), e = [1, 4], o = [1, 13], l = [1, 12], n = [1, 15], d = [1, 16], p = [1, 20], y = [1, 19], E = [6, 7, 8], k = [1, 26], L = [1, 24], D = [1, 25], b = [6, 7, 11], $ = [1, 6, 13, 15, 16, 19, 22], f = [1, 33], B = [1, 34], P = [1, 6, 7, 11, 13, 15, 16, 19, 22], W = {
    ...
    performAction: /* @__PURE__ */ h(function(s, i, a, c, u, r, M) {
      var g = r.length - 1;
      switch (u) {
        case 6:
        case 7:
    ...
    table: [{ 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: e }, { 1: [3] }, { 1: [2, 1] }, { 4: 6, 6: [1, 7], 7: [1, 8], 8: e }, { 6: o, 7: [1, 10], 9: 9, 12: 11, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: p, 22: y }, t(E, [2, 3]), { 1: [2, 2] }, t(E, [2, 4]), t(E, [2, 5]), { 1: [2, 6], 6: o, 12: 21, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: p, 22: y }, { 6: o, 9: 22, 12: 11, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: p, 22: y }, { 6: k, 7: L, 10: 23, 11: D }, t(b, [2, 22], { 17: 17, 18: 18, 14: 27, 15: [1, 28], 16: [1, 29], 19: p, 22: y }), t(b, [2, 18]), t(b, [2, 19]), t(b, [2, 20]), t(b, [2, 21]), t(b, [2, 23]), t(b, [2, 24]), t(b, [2, 26], { 19: [1, 30] }), { 20: [1, 31] }, { 6: k, 7: L, 10: 32, 11: D }, { 1: [2, 7], 6: o, 12: 21, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: p, 22: y }, t($, [2, 14], { 7: f, 11: B }), t(P, [2, 8]), t(P, [2, 9]), t(P, [2, 10]), t(b, [2, 15]), t(b, [2, 16]), t(b, [2, 17]), { 20: [1, 35] }, { 21: [1, 36] }, t($, [2, 13], { 7: f, 11: B }), t(P, [2, 11]), t(P, [2, 12]), { 21: [1, 37] }, t(b, [2, 25]), t(b, [2, 27])],
    ...
    parse: /* @__PURE__ */ h(function(s) {
      var i = this, a = [0], c = [], u = [null], r = [], M = this.table, g = "", F = 0, Q = 0, ie = 2, Z = 1, se = r.slice.call(arguments, 1), m = Object.create(this.lexer), C = { yy: {} };
      for (var X in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, X) && (C.yy[X] = this.yy[X]);
      m.setInput(s, C.yy), C.yy.lexer = m, C.yy.parser = this, typeof m.yylloc > "u" && (m.yylloc = {});
      var Y = m.yylloc;
      r.push(Y);
      ...
      function ae(x) {
        a.length = a.length - 2 * x, u.length = u.length - x, r.length = r.length - x;
      }
      h(ae, "popStack");
      function ee() {
        var x;
        return x = c.pop() || m.lex() || Z, typeof x != "number" && (x instanceof Array && (c = x, x = c.pop()), x = i.symbols_[x] || x), x;
      }
      h(ee, "lex");
      for (var S, I, N, q, w = {}, G, v, te, j; ; ) {
        if (I = a[a.length - 1], this.defaultActions[I] ? N = this.defaultActions[I] : ((S === null || typeof S > "u") && (S = ee()), N = M[I] && M[I][S]), typeof N > "u" || !N.length || !N[0]) {
          var J = "";
          j = [];
          for (G in M[I])
            this.terminals_[G] && G > ie && j.push("'" + this.terminals_[G] + "'");
          m.showPosition ? J = "Parse error on line " + (F + 1) + `:
` + m.showPosition() + `
Expecting ` + j.join(", ") + ", got '" + (this.terminals_[S] || S) + "'" : J = "Parse error on line " + (F + 1) + ": Unexpected " + (S == Z ? "end of input" : "'" + (this.terminals_[S] || S) + "'"), this.parseError(J, {
            text: m.match,
        ...
        switch (N[0]) {
          case 1:
            a.push(S), u.push(m.yytext), r.push(m.yylloc), a.push(N[1]), S = null, Q = m.yyleng, g = m.yytext, F = m.yylineno, Y = m.yylloc;
            break;
          case 2:
            if (v = this.productions_[N[1]][1], w.$ = u[u.length - v], w._$ = {
              ...
              return q;
            v && (a = a.slice(0, -1 * v * 2), u = u.slice(0, -1 * v), r = r.slice(0, -1 * v)), a.push(this.productions_[N[1]][0]), u.push(w.$), r.push(w._$), te = M[a[a.length - 2]][a[a.length - 1]], a.push(te);
            break;
          case 3:
            return !0;
        }
    ...
    var O = {
      EOF: 1,
      parseError: /* @__PURE__ */ h(function(i, a) {
        if (this.yy.parser)
        ...
        for (var u = this._currentRules(), r = 0; r < u.length; r++)
          if (a = this._input.match(this.rules[u[r]]), a && (!i || a[0].length > i[0].length)) {
            if (i = a, c = r, this.options.backtrack_lexer) {
              if (s = this.test_match(a, u[r]), s !== !1)
                return s;
              if (this._backtrack) {
                i = !1;
                continue;
...
` + this.showPosition(), {
      ...
      performAction: /* @__PURE__ */ h(function(i, a, c, u) {
        switch (c) {
          case 0:
...
var ke = K, Se = 12, T = {
  ...
  addNode(e, o, l, n) {
    ...
    const E = {
      ...
      type: n,
      children: [],
      width: ((D = p.mindmap) == null ? void 0 : D.maxNodeWidth) ?? z.mindmap.maxNodeWidth,
      padding: y,
      isRoot: d
    }, k = this.getParent(e);
    if (k)
  ...
  getType(e, o) {
    switch (R.debug("In get type", e, o), e) {
      case "[":
  ...
  decorateNode(e) {
    if (!e)
      return;
    const o = U(), l = this.nodes[this.nodes.length - 1];
    e.icon && (l.icon = H(e.icon, o)), e.class && (l.class = H(e.class, o));
  }
  type2Str(e) {
    switch (e) {
  ...
  flattenNodes(e, o) {
    ...
    const d = n.join(" "), p = /* @__PURE__ */ h((E) => {
      var D;
      const L = (((D = l.theme) == null ? void 0 : D.toLowerCase()) ?? "").includes("redux");
      switch (E) {
        case T.CIRCLE:
  ...
  generateEdges(e, o) {
    ...
    for (const n of e.children) {
      ...
      o.push(y), this.generateEdges(n, o);
    }
  }
  /**
   ...
   */
  getData() {
    const e = this.getMindmap(), o = U(), n = ge().layout !== void 0, d = o;
    ...
    R.debug("getData: mindmapRoot", e, o), this.assignSections(e);
    const p = [], y = [];
...
}, h(A, "MindmapDB"), A), Ne = /* @__PURE__ */ h(async (t, e, o, l) => {
  var b, $;
  R.debug(`Rendering mindmap diagram
` + t);
  const n = l.db, d = n.getData(), p = oe(e, d.config.securityLevel);
  ...
  const { themeVariables: E } = de(), { useGradient: k, gradientStart: L, gradientStop: D } = E;
  if (k && L && D) {
    const f = p.attr("id"), B = p.append("defs").append("linearGradient").attr("id", `${f}-gradient`).attr("gradientUnits", "objectBoundingBox").attr("x1", "0%").attr("y1", "0%").attr("x2", "100%").attr("y2", "0%");
    B.append("stop").attr("offset", "0%").attr("stop-color", L).attr("stop-opacity", 1), B.append("stop").attr("offset", "100%").attr("stop-color", D).attr("stop-opacity", 1);
  }
  ce(
    p,
    ((b = d.config.mindmap) == null ? void 0 : b.padding) ?? z.mindmap.padding,
    "mindmapDiagram",
    (($ = d.config.mindmap) == null ? void 0 : $.useMaxWidth) ?? z.mindmap.useMaxWidth
  );
}, "draw"), De = {
  draw: Ne
}, Le = /* @__PURE__ */ h((t) => {
  ...
  for (let n = 0; n < t.THEME_COLOR_LIMIT; n++) {
    const d = "" + (o === "neo" ? Math.max(10 - (n - 1) * 2, 2) : 17 - 3 * n);
    l += `
  ...
  return l;
}, "genSections"), ve = /* @__PURE__ */ h((t, e, o) => {
  let l = "";
  for (let n = 0; n < t; n++)
    l += `
    [data-look="neo"].mindmap-node.section-${n - 1} rect, [data-look="neo"].mindmap-node.section-${n - 1} path, [data-look="neo"].mindmap-node.section-${n - 1} circle, [data-look="neo"].mindmap-node.section-${n - 1} polygon {
  ...
  const { theme: e } = t, o = t.svgId, l = t.dropShadow ? t.dropShadow.replace("url(#drop-shadow)", `url(${o}-drop-shadow)`) : "none";
  return `
  .edge {
    stroke-width: 3;
  }
