import { p as $ } from "./chunk-JWPE2WC7-Cu2y2Gig.js";
import { _ as b, B as m, F as C, e as S, l as w, b as D, a as T, o as z, p as F, g as P, s as E, z as A, D as W, q as _ } from "./index-Cy1zwdz5.js";
import { p as N } from "./cynefin-VYW2F7L2-Cilhcs7p.js";
var L = W.packet, u, v = (u = class {
  constructor() {
    this.packet = [], this.setAccTitle = D, this.getAccTitle = T, this.setDiagramTitle = z, this.getDiagramTitle = F, this.getAccDescription = P, this.setAccDescription = E;
  }
  getConfig() {
    const t = m({
      ...L,
  ...
  for (let { start: a, end: i, bits: d, label: c } of e.blocks) {
    ...
    for (i ?? (i = a + (d ?? 1) - 1), d ?? (d = i - a + 1), s = i, w.debug(`Packet block ${a} - ${s} with label ${c}`); r.length <= l + 1 && t.getPacket().length < M; ) {
      const [p, o] = I({ start: a, end: i, bits: d, label: c }, n, l);
...
}, "draw"), j = /* @__PURE__ */ b((e, t, s, { rowHeight: r, paddingX: n, paddingY: l, bitWidth: a, bitsPerRow: i, showBits: d }) => {
