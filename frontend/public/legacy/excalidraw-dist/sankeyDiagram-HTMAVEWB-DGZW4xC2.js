import { o as xt, p as _t, s as vt, g as bt, b as St, a as wt, _ as d, c as lt, b8 as Lt, d as H, ad as Et, q as At, k as Tt } from "./index-CwchMzCG.js";
...
function Bt() {
  let t = 0, n = 0, s = 1, a = 1, u = 24, y = 8, p, m = Dt, o = kt, l, h, x = jt, _ = zt, g = 6;
  function v() {
    const i = { nodes: x.apply(null, arguments), links: _.apply(null, arguments) };
  ...
  v.update = function(i) {
    ...
    return arguments.length ? (y = p = +i, v) : y;
  }, v.nodes = function(i) {
    return arguments.length ? (x = typeof i == "function" ? i : X(i), v) : x;
  }, v.links = function(i) {
    ...
    return arguments.length ? (g = +i, v) : g;
  };
  function T({ nodes: i, links: f }) {
    for (const [e, r] of i.entries())
      r.index = e, r.sourceLinks = [], r.targetLinks = [];
    const c = new Map(i.map((e, r) => [m(e, r, i), e]));
    for (const [e, r] of f.entries()) {
      r.index = e;
      let { source: k, target: b } = r;
      typeof k != "object" && (k = r.source = ft(c, k)), typeof b != "object" && (b = r.target = ft(c, b)), k.sourceLinks.push(r), b.targetLinks.push(r);
    }
    if (h != null)
  ...
  function N({ nodes: i }) {
    ...
    for (const r of i) {
      const k = Math.max(0, Math.min(f - 1, Math.floor(o.call(null, r, f))));
      r.layer = k, r.x0 = t + k * c, r.x1 = r.x0 + u, e[k] ? e[k].push(r) : e[k] = [r];
    }
  ...
  function D(i) {
    const f = pt(i, (c) => (a - n - (c.length - 1) * p) / nt(c, it));
    for (const c of i) {
      let e = n;
      for (const r of c) {
        r.y0 = e, r.y1 = e + r.value * f, e = r.y1 + p;
  ...
  function S(i) {
    const f = N(i);
    p = Math.min(y, (a - n) / (ct(f, (c) => c.length) - 1)), D(f);
    for (let c = 0; c < g; ++c) {
      const e = Math.pow(0.99, c), r = Math.max(1 - e, (c + 1) / g);
      R(f, e, r), C(f, e, r);
    }
  }
  function C(i, f, c) {
  ...
  function j(i, f) {
    ...
    O(i, e.y0 - p, c - 1, f), V(i, e.y1 + p, c + 1, f), O(i, a, i.length - 1, f), V(i, n, 0, f);
  }
  function V(i, f, c, e) {
    for (; c < i.length; ++c) {
      const r = i[c], k = (f - r.y0) * e;
      k > 1e-6 && (r.y0 += k, r.y1 += k), f = r.y1 + p;
    }
  }
  function O(i, f, c, e) {
    for (; c >= 0; --c) {
      const r = i[c], k = (r.y1 - f) * e;
  ...
  function P(i, f) {
    let c = i.y0 - (i.sourceLinks.length - 1) * p / 2;
  ...
  function E(i, f) {
    let c = f.y0 - (f.targetLinks.length - 1) * p / 2;
    for (const { source: e, width: r } of f.targetLinks) {
      if (e === i) break;
      c += r + p;
    }
...
ot.prototype = mt.prototype = {
  ...
  arcTo: function(t, n, s, a, u) {
    t = +t, n = +n, s = +s, a = +a, u = +u;
    var y = this._x1, p = this._y1, m = s - t, o = a - n, l = y - t, h = p - n, x = l * l + h * h;
    if (u < 0) throw new Error("negative radius: " + u);
    if (this._x1 === null)
      this._ += "M" + (this._x1 = t) + "," + (this._y1 = n);
    else if (x > F) if (!(Math.abs(h * m - o * l) > F) || !u)
      this._ += "L" + (this._x1 = t) + "," + (this._y1 = n);
    else {
      var _ = s - y, g = a - p, v = m * m + o * o, T = _ * _ + g * g, A = Math.sqrt(v), M = Math.sqrt(x), I = u * Math.tan((rt - Math.acos((v + x - T) / (2 * A * M))) / 2), N = I / M, D = I / A;
      Math.abs(N - 1) > F && (this._ += "L" + (t + N * l) + "," + (n + N * h)), this._ += "A" + u + "," + u + ",0,0," + +(h * _ > l * g) + "," + (this._x1 = t + D * m) + "," + (this._y1 = n + D * o);
    }
  },
  arc: function(t, n, s, a, u, y) {
    t = +t, n = +n, s = +s, y = !!y;
    var p = s * Math.cos(a), m = s * Math.sin(a), o = t + p, l = n + m, h = 1 ^ y, x = y ? a - u : u - a;
    if (s < 0) throw new Error("negative radius: " + s);
    this._x1 === null ? this._ += "M" + o + "," + l : (Math.abs(this._x1 - o) > F || Math.abs(this._y1 - l) > F) && (this._ += "L" + o + "," + l), s && (x < 0 && (x = x % st + st), x > Ft ? this._ += "A" + s + "," + s + ",0,1," + h + "," + (t - p) + "," + (n - m) + "A" + s + "," + s + ",0,1," + h + "," + (this._x1 = o) + "," + (this._y1 = l) : x > F && (this._ += "A" + s + "," + s + ",0," + +(x >= rt) + "," + h + "," + (this._x1 = t + s * Math.cos(u)) + "," + (this._y1 = n + s * Math.sin(u))));
  },
...
function Yt(t) {
  var n = Gt, s = Ut, a = Rt, u = Vt, y = null;
  function p() {
    var m, o = Wt.call(arguments), l = n.apply(this, o), h = s.apply(this, o);
    if (y || (y = m = mt()), t(y, +a.apply(this, (o[0] = l, o)), +u.apply(this, o), +a.apply(this, (o[0] = h, o)), +u.apply(this, o)), m) return y = null, m + "" || null;
  }
  return p.source = function(m) {
    ...
    return arguments.length ? (a = typeof m == "function" ? m : dt(+m), p) : a;
  }, p.y = function(m) {
    return arguments.length ? (u = typeof m == "function" ? m : dt(+m), p) : u;
...
var at = function() {
  var t = /* @__PURE__ */ d(function(m, o, l, h) {
    ...
    performAction: /* @__PURE__ */ d(function(o, l, h, x, _, g, v) {
      var T = g.length - 1;
      switch (_) {
        case 7:
    ...
    parseError: /* @__PURE__ */ d(function(o, l) {
      if (l.recoverable)
        this.trace(o);
      else {
        var h = new Error(o);
    ...
    parse: /* @__PURE__ */ d(function(o) {
      var l = this, h = [0], x = [], _ = [null], g = [], v = this.table, T = "", A = 0, M = 0, I = 2, N = 1, D = g.slice.call(arguments, 1), S = Object.create(this.lexer), C = { yy: {} };
      ...
      function O(L) {
        h.length = h.length - 2 * L, _.length = _.length - L, g.length = g.length - L;
      }
      d(O, "popStack");
      function z() {
        var L;
        return L = x.pop() || S.lex() || N, typeof L != "number" && (L instanceof Array && (x = L, L = x.pop()), L = l.symbols_[L] || L), L;
      }
      d(z, "lex");
      for (var w, P, E, i, f = {}, c, e, r, k; ; ) {
        if (P = h[h.length - 1], this.defaultActions[P] ? E = this.defaultActions[P] : ((w === null || typeof w > "u") && (w = z()), E = v[P] && v[P][w]), typeof E > "u" || !E.length || !E[0]) {
          ...
          k = [];
          for (c in v[P])
            this.terminals_[c] && c > I && k.push("'" + this.terminals_[c] + "'");
...
Expecting ` + k.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : b = "Parse error on line " + (A + 1) + ": Unexpected " + (w == N ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(b, {
        ...
        switch (E[0]) {
          case 1:
            h.push(w), _.push(S.yytext), g.push(S.yylloc), h.push(E[1]), w = null, M = S.yyleng, T = S.yytext, A = S.yylineno, j = S.yylloc;
            break;
          case 2:
            if (e = this.productions_[E[1]][1], f.$ = _[_.length - e], f._$ = {
              ...
              return i;
            e && (h = h.slice(0, -1 * e * 2), _ = _.slice(0, -1 * e), g = g.slice(0, -1 * e)), h.push(this.productions_[E[1]][0]), _.push(f.$), g.push(f._$), r = v[h[h.length - 2]][h[h.length - 1]], h.push(r);
            break;
          case 3:
            return !0;
        }
    ...
    var m = {
      EOF: 1,
      parseError: /* @__PURE__ */ d(function(l, h) {
        if (this.yy.parser)
      ...
      setInput: /* @__PURE__ */ d(function(o, l) {
...
` + l + "^";
      ...
      test_match: /* @__PURE__ */ d(function(o, l) {
        var h, x, _;
        ...
        }, this.options.ranges && (_.yylloc.range = this.yylloc.range.slice(0))), x = o[0].match(/(?:\r\n?|\n).*/g), x && (this.yylineno += x.length), this.yylloc = {
      ...
      next: /* @__PURE__ */ d(function() {
        ...
        for (var _ = this._currentRules(), g = 0; g < _.length; g++)
          if (h = this._input.match(this.rules[_[g]]), h && (!l || h[0].length > l[0].length)) {
            if (l = h, x = g, this.options.backtrack_lexer) {
              if (o = this.test_match(h, _[g]), o !== !1)
                return o;
              if (this._backtrack) {
                l = !1;
                continue;
        ...
        return l ? (o = this.test_match(l, _[x]), o !== !1 ? o : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      performAction: /* @__PURE__ */ d(function(l, h, x, _) {
        switch (x) {
          case 0:
  ...
  return d(p, "Parser"), p.prototype = u, u.Parser = p, new p();
}();
at.parser = at;
...
}, d(W, "SankeyLink"), W), te = /* @__PURE__ */ d((t, n, s) => {
  J.push(new Jt(t, n, s));
...
${v}${Math.round(r * 100) / 100}${T}` : e, "getText"), w = /* @__PURE__ */ d((e) => N === "outlined" ? (e.layer ?? 0) < j ? { x: e.x0 - 6, anchor: "end" } : { x: e.x1 + 6, anchor: "start" } : e.x0 < h / 2 ? { x: e.x1 + 6, anchor: "start" } : { x: e.x0 - 6, anchor: "end" }, "getLabelPosition"), P = l.append("g").attr("class", "node-labels").attr("font-size", 14), E = /* @__PURE__ */ d((e) => P.selectAll(e ? `.${e}` : "text").data(S.nodes).join("text").attr("class", e ?? null).attr("x", (r) => w(r).x).attr("y", (r) => (r.y1 + r.y0) / 2).attr("dy", `${A ? "0" : "0.35"}em`).attr("text-anchor", (r) => w(r).anchor).text(z), "appendLabel");
  N === "outlined" ? (E("sankey-label-bg"), E("sankey-label-fg")) : E();
  const i = l.append("g").attr("class", "links").attr("fill", "none").attr("stroke-opacity", 0.5).selectAll(".link").data(S.links).join("g").attr("class", "link").style("mix-blend-mode", "multiply"), f = (y == null ? void 0 : y.linkColor) ?? "gradient";
  if (f === "gradient") {
  ...
  switch (f) {
    case "gradient":
      c = /* @__PURE__ */ d((e) => e.uid, "coloring");
      break;
    case "source":
      c = /* @__PURE__ */ d((e) => O(e.source.id), "coloring");
      break;
    case "target":
      c = /* @__PURE__ */ d((e) => O(e.target.id), "coloring");
      break;
    default:
      c = f;
  }
