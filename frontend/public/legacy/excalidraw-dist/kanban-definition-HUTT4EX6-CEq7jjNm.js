import { _ as c, l as te, c as W, F as fe, af as ye, ag as be, ah as me, ad as _e, D as K, i as G, Y as ke, Z as Ee, aa as Se, ab as le, ac as ce } from "./index-DWydl2tC.js";
import { g as Ne } from "./chunk-5VM5RSS4-DLF0fQQ5.js";
var $ = function() {
    ...
    parse: /* @__PURE__ */ c(function(s) {
      ...
      for (var E, R, v, q, F = {}, X, I, oe, Y; ; ) {
        if (R = a[a.length - 1], this.defaultActions[R] ? v = this.defaultActions[R] : ((E === null || typeof E > "u") && (E = ae()), v = B[R] && B[R][E]), typeof v > "u" || !v.length || !v[0]) {
          ...
          m.showPosition ? Q = "Parse error on line " + (z + 1) + `:
` + m.showPosition() + `
Expecting ` + Y.join(", ") + ", got '" + (this.terminals_[E] || E) + "'" : Q = "Parse error on line " + (z + 1) + ": Unexpected " + (E == re ? "end of input" : "'" + (this.terminals_[E] || E) + "'"), this.parseError(Q, {
            text: m.match,
        ...
        switch (v[0]) {
          case 1:
            a.push(E), u.push(m.yytext), e.push(m.yylloc), a.push(v[1]), E = null, ie = m.yyleng, l = m.yytext, z = m.yylineno, Z = m.yylloc;
            break;
          case 2:
