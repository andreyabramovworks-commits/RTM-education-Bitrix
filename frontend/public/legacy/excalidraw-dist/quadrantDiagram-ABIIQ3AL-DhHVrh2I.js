...
var Vt = function() {
  var t = /* @__PURE__ */ o(function(j, r, l, g) {
    ...
    performAction: /* @__PURE__ */ o(function(r, l, g, f, A, e, pt) {
      var s = e.length - 1;
      switch (A) {
        case 23:
          this.$ = e[s];
    ...
    parse: /* @__PURE__ */ o(function(r) {
      var l = this, g = [0], f = [], A = [null], e = [], pt = this.table, s = "", mt = 0, Jt = 0, me = 2, $t = 1, be = e.slice.call(arguments, 1), D = Object.create(this.lexer), K = { yy: {} };
      for (var Ct in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, Ct) && (K.yy[Ct] = this.yy[Ct]);
      D.setInput(r, K.yy), K.yy.lexer = D, K.yy.parser = this, typeof D.yylloc > "u" && (D.yylloc = {});
      var Lt = D.yylloc;
      e.push(Lt);
      ...
      function _e(R) {
        g.length = g.length - 2 * R, A.length = A.length - R, e.length = e.length - R;
      }
      o(_e, "popStack");
      function te() {
        var R;
        return R = f.pop() || D.lex() || $t, typeof R != "number" && (R instanceof Array && (f = R, R = f.pop()), R = l.symbols_[R] || R), R;
      }
      o(te, "lex");
      for (var B, Z, W, Et, lt = {}, bt, M, ee, St; ; ) {
        if (Z = g[g.length - 1], this.defaultActions[Z] ? W = this.defaultActions[Z] : ((B === null || typeof B > "u") && (B = te()), W = pt[Z] && pt[Z][B]), typeof W > "u" || !W.length || !W[0]) {
          var Dt = "";
          St = [];
          for (bt in pt[Z])
            this.terminals_[bt] && bt > me && St.push("'" + this.terminals_[bt] + "'");
          D.showPosition ? Dt = "Parse error on line " + (mt + 1) + `:
` + D.showPosition() + `
Expecting ` + St.join(", ") + ", got '" + (this.terminals_[B] || B) + "'" : Dt = "Parse error on line " + (mt + 1) + ": Unexpected " + (B == $t ? "end of input" : "'" + (this.terminals_[B] || B) + "'"), this.parseError(Dt, {
            text: D.match,
        ...
        switch (W[0]) {
          case 1:
            g.push(B), A.push(D.yytext), e.push(D.yylloc), g.push(W[1]), B = null, Jt = D.yyleng, s = D.yytext, mt = D.yylineno, Lt = D.yylloc;
            break;
          case 2:
            if (M = this.productions_[W[1]][1], lt.$ = A[A.length - M], lt._$ = {
              ...
              A,
              e
            ].concat(be)), typeof Et < "u")
              return Et;
            M && (g = g.slice(0, -1 * M * 2), A = A.slice(0, -1 * M), e = e.slice(0, -1 * M)), g.push(this.productions_[W[1]][0]), A.push(lt.$), e.push(lt._$), ee = pt[g[g.length - 2]][g[g.length - 1]], g.push(ee);
            break;
          case 3:
            return !0;
        }
...
` + l + "^";
      ...
      test_match: /* @__PURE__ */ o(function(r, l) {
        ...
        }, this.options.ranges && (A.yylloc.range = this.yylloc.range.slice(0))), f = r[0].match(/(?:\r\n?|\n).*/g), f && (this.yylineno += f.length), this.yylloc = {
      ...
      next: /* @__PURE__ */ o(function() {
        ...
        for (var A = this._currentRules(), e = 0; e < A.length; e++)
          if (g = this._input.match(this.rules[A[e]]), g && (!l || g[0].length > l[0].length)) {
            if (l = g, f = e, this.options.backtrack_lexer) {
              if (r = this.test_match(g, A[e]), r !== !1)
                return r;
              if (this._backtrack) {
                l = !1;
                continue;
        ...
        return l ? (r = this.test_match(l, A[f]), r !== !1 ? r : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      performAction: /* @__PURE__ */ o(function(l, g, f, A) {
        switch (f) {
          case 0:
            break;
          case 1:
...
var ze = Vt, I = De(), ht, Ve = (ht = class {
  ...
  getDefaultConfig() {
    var n, u, c, h, p, y, S, a, k, d, T, q, m, b, x, _, Y, G;
    return {
      showXAxis: !0,
      showYAxis: !0,
      showTitle: !0,
      chartHeight: ((n = z.quadrantChart) == null ? void 0 : n.chartWidth) || 500,
      chartWidth: ((u = z.quadrantChart) == null ? void 0 : u.chartHeight) || 500,
      titlePadding: ((c = z.quadrantChart) == null ? void 0 : c.titlePadding) || 10,
      titleFontSize: ((h = z.quadrantChart) == null ? void 0 : h.titleFontSize) || 20,
      quadrantPadding: ((p = z.quadrantChart) == null ? void 0 : p.quadrantPadding) || 5,
      xAxisLabelPadding: ((y = z.quadrantChart) == null ? void 0 : y.xAxisLabelPadding) || 5,
      yAxisLabelPadding: ((S = z.quadrantChart) == null ? void 0 : S.yAxisLabelPadding) || 5,
      xAxisLabelFontSize: ((a = z.quadrantChart) == null ? void 0 : a.xAxisLabelFontSize) || 16,
      yAxisLabelFontSize: ((k = z.quadrantChart) == null ? void 0 : k.yAxisLabelFontSize) || 16,
      quadrantLabelFontSize: ((d = z.quadrantChart) == null ? void 0 : d.quadrantLabelFontSize) || 16,
      quadrantTextTopPadding: ((T = z.quadrantChart) == null ? void 0 : T.quadrantTextTopPadding) || 5,
      pointTextPadding: ((q = z.quadrantChart) == null ? void 0 : q.pointTextPadding) || 5,
      pointLabelFontSize: ((m = z.quadrantChart) == null ? void 0 : m.pointLabelFontSize) || 12,
      pointRadius: ((b = z.quadrantChart) == null ? void 0 : b.pointRadius) || 5,
      xAxisPosition: ((x = z.quadrantChart) == null ? void 0 : x.xAxisPosition) || "top",
      yAxisPosition: ((_ = z.quadrantChart) == null ? void 0 : _.yAxisPosition) || "left",
      quadrantInternalBorderStrokeWidth: ((Y = z.quadrantChart) == null ? void 0 : Y.quadrantInternalBorderStrokeWidth) || 1,
      quadrantExternalBorderStrokeWidth: ((G = z.quadrantChart) == null ? void 0 : G.quadrantExternalBorderStrokeWidth) || 2
    };
  }
  ...
  calculateSpace(n, u, c, h) {
    ...
    }, k = this.config.titleFontSize + this.config.titlePadding * 2, d = {
      top: h ? k : 0
    }, T = this.config.quadrantPadding + a.left, q = this.config.quadrantPadding + y.top + d.top, m = this.config.chartWidth - this.config.quadrantPadding * 2 - a.left - a.right, b = this.config.chartHeight - this.config.quadrantPadding * 2 - y.top - y.bottom - d.top, x = m / 2, _ = b / 2;
    return {
      xAxisSpace: y,
      yAxisSpace: a,
      titleSpace: d,
  ...
  getQuadrantPoints(n) {
    const { quadrantSpace: u } = n, { quadrantHeight: c, quadrantLeft: h, quadrantTop: p, quadrantWidth: y } = u, S = ie().domain([0, 1]).range([h, y + h]), a = ie().domain([0, 1]).range([c + p, p]);
...
function Te() {
  ...
  return u && V.setConfig(u), V.setThemeConfig({
...
` + t);
  ...
  let k;
  a === "sandbox" && (k = zt("#i" + n));
  const T = (a === "sandbox" ? zt(k.nodes()[0].contentDocument.body) : zt("body")).select(`[id="${n}"]`), q = T.append("g").attr("class", "main"), m = ((xt = S.quadrantChart) == null ? void 0 : xt.chartWidth) ?? 500, b = ((ft = S.quadrantChart) == null ? void 0 : ft.chartHeight) ?? 500;
  Ce(T, b, m, ((gt = S.quadrantChart) == null ? void 0 : gt.useMaxWidth) ?? !0), T.attr("viewBox", "0 0 " + m + " " + b), c.db.setHeight(b), c.db.setWidth(m);
  const x = c.db.getQuadrantData(), _ = q.append("g").attr("class", "quadrants"), Y = q.append("g").attr("class", "border"), G = q.append("g").attr("class", "data-points"), yt = q.append("g").attr("class", "labels"), Tt = q.append("g").attr("class", "title");
  ...
  const dt = _.selectAll("g.quadrant").data(x.quadrants).enter().append("g").attr("class", "quadrant");
