import { _ as o, c as ot, a1 as ut, F as dt, al as yt, q as ft, k as pt, o as it, a as gt, b as kt, g as wt, s as mt, p as _t, e as bt } from "./index-DWydl2tC.js";
var tt = function() {
  var e = /* @__PURE__ */ o(function(M, t, s, i) {
    ...
    parse: /* @__PURE__ */ o(function(t) {
      ...
      for (var W in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, W) && (C.yy[W] = this.yy[W]);
      ...
      o(z, "lex");
      for (var A, F, B, K, H = {}, X, V, et, Y; ; ) {
        if (F = i[i.length - 1], this.defaultActions[F] ? B = this.defaultActions[F] : ((A === null || typeof A > "u") && (A = z()), B = v[F] && v[F][A]), typeof B > "u" || !B.length || !B[0]) {
          var Q = "";
          Y = [];
          for (X in v[F])
...
Expecting ` + Y.join(", ") + ", got '" + (this.terminals_[A] || A) + "'" : Q = "Parse error on line " + (I + 1) + ": Unexpected " + (A == E ? "end of input" : "'" + (this.terminals_[A] || A) + "'"), this.parseError(Q, {
        ...
        if (B[0] instanceof Array && B.length > 1)
          throw new Error("Parse Error: multiple actions possible at state: " + F + ", token: " + A);
        switch (B[0]) {
          case 1:
...
var xt = tt, Z, vt = (Z = class {
  ...
  if (!y)
    return;
  const f = ot(), { look: d, handDrawnSeed: w, themeVariables: c } = f, k = ut(f.fontSize)[0] ?? St, g = d === "handDrawn", _ = y.children ?? [], x = ((C = f.ishikawa) == null ? void 0 : C.diagramPadding) ?? 20, N = ((W = f.ishikawa) == null ? void 0 : W.useMaxWidth) ?? !1, O = dt(h), $ = O.append("g").attr("class", "ishikawa"), M = g ? yt.svg(O.node()) : void 0, t = M ? {
    roughSvg: M,
    seed: w ?? 0,
