...
var dk = (t, e, r) => e in t ? fk(t, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : t[e] = r;
var jr = (t, e, r) => dk(t, typeof e != "symbol" ? e + "" : e, r);
var pk = Object.create, Lu = Object.defineProperty, mk = Object.getOwnPropertyDescriptor, vh = Object.getOwnPropertyNames, hk = Object.getPrototypeOf, yk = Object.prototype.hasOwnProperty, s = (t, e) => Lu(t, "name", { value: e, configurable: !0 }), gk = (t, e) => function() {
  return t && (e = (0, t[vh(t)[0]])(t = 0)), e;
}, X = (t, e) => function() {
  return e || (0, t[vh(t)[0]])((e = { exports: {} }).exports, e), e.exports;
}, en = (t, e) => {
  for (var r in e)
    Lu(t, r, { get: e[r], enumerable: !0 });
}, Th = (t, e, r, n) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let a of vh(e))
      !yk.call(t, a) && a !== r && Lu(t, a, { get: () => e[a], enumerable: !(n = mk(e, a)) || n.enumerable });
  return t;
}, kf = (t, e, r) => (Th(t, e, "default"), r), $h = (t, e, r) => (r = t != null ? pk(hk(t)) : {}, Th(
  // If the importer is in node compatibility mode or this is not an ESM
  // file that has been converted to a CommonJS file using a Babel-
  // compatible transform (i.e. "__esModule" has not been set), then set
  // "default" to the CommonJS "module.exports" for node compatibility.
  Lu(r, "default", { value: t, enumerable: !0 }),
  t
)), Rh = (t) => Th(Lu({}, "__esModule", { value: !0 }), t), Of = {};
en(Of, {
  AnnotatedTextEdit: () => Rr,
  ChangeAnnotation: () => pn,
  ChangeAnnotationIdentifier: () => et,
  CodeAction: () => Zp,
  CodeActionContext: () => Jp,
  CodeActionKind: () => Xp,
  CodeActionTriggerKind: () => Yl,
  CodeDescription: () => wp,
  CodeLens: () => Qp,
  Color: () => Ac,
  ColorInformation: () => Ap,
  ColorPresentation: () => Ep,
  Command: () => dn,
  CompletionItem: () => Gp,
  CompletionItemKind: () => kp,
  CompletionItemLabelDetails: () => Mp,
  CompletionItemTag: () => Lp,
  CompletionList: () => Fp,
  CreateFile: () => ba,
  DeleteFile: () => Sa,
  Diagnostic: () => Wl,
  DiagnosticRelatedInformation: () => Ec,
  DiagnosticSeverity: () => _p,
  DiagnosticTag: () => Sp,
  DocumentHighlight: () => Kp,
  DocumentHighlightKind: () => Up,
  DocumentLink: () => tm,
  DocumentSymbol: () => Yp,
  DocumentUri: () => Tp,
  EOL: () => x$,
  FoldingRange: () => bp,
  FoldingRangeKind: () => Cp,
  FormattingOptions: () => em,
  Hover: () => zp,
  InlayHint: () => cm,
  InlayHintKind: () => _c,
  InlayHintLabelPart: () => Sc,
  InlineCompletionContext: () => ym,
  InlineCompletionItem: () => dm,
  InlineCompletionList: () => pm,
  InlineCompletionTriggerKind: () => mm,
  InlineValueContext: () => um,
  InlineValueEvaluatableExpression: () => lm,
  InlineValueText: () => sm,
  InlineValueVariableLookup: () => om,
  InsertReplaceEdit: () => Dp,
  InsertTextFormat: () => Op,
  InsertTextMode: () => xp,
  Location: () => Kl,
  LocationLink: () => Rp,
  ...
  MarkupContent: () => wa,
  MarkupKind: () => bc,
  OptionalVersionedTextDocumentIdentifier: () => Vl,
  ParameterInformation: () => jp,
  Position: () => oe,
  Range: () => te,
  RenameFile: () => _a,
  SelectedCompletionInfo: () => hm,
  SelectionRange: () => rm,
  SemanticTokenModifiers: () => am,
  SemanticTokenTypes: () => nm,
  SemanticTokens: () => im,
  SignatureInformation: () => Bp,
  StringValue: () => fm,
  SymbolInformation: () => Vp,
  SymbolKind: () => Wp,
  SymbolTag: () => qp,
  TextDocument: () => vm,
  TextDocumentEdit: () => ql,
  TextDocumentIdentifier: () => Ip,
  TextDocumentItem: () => Pp,
  TextEdit: () => nr,
  URI: () => Rc,
  VersionedTextDocumentIdentifier: () => Np,
  WorkspaceChange: () => D$,
  WorkspaceEdit: () => Cc,
  WorkspaceFolder: () => gm,
  WorkspaceSymbol: () => Hp,
...
var Tp, Rc, $p, Ul, oe, te, Kl, Rp, Ac, Ap, Ep, Cp, bp, Ec, _p, Sp, wp, Wl, dn, nr, pn, et, Rr, ql, ba, _a, Sa, Cc, Pl, Bd, D$, Ip, Np, Vl, Pp, bc, wa, kp, Op, Lp, Dp, xp, Mp, Gp, Fp, Hl, zp, jp, Bp, Up, Kp, Wp, qp, Vp, Hp, Yp, Xp, Yl, Jp, Zp, Qp, em, tm, rm, nm, am, im, sm, om, lm, um, _c, Sc, cm, fm, dm, pm, mm, hm, ym, gm, x$, vm, av, C, Du = gk({
  "../../node_modules/.pnpm/vscode-languageserver-types@3.17.5/node_modules/vscode-languageserver-types/lib/esm/main.js"() {
    ...
    (function(a) {
      ...
      function i(u, l) {
        return u === Number.MAX_VALUE && (u = Ul.MAX_VALUE), l === Number.MAX_VALUE && (l = Ul.MAX_VALUE), { line: u, character: l };
      }
      ...
      function o(u) {
        let l = u;
        return C.objectLiteral(l) && oe.is(l.start) && oe.is(l.end);
      }
      s(o, "is"), a.is = o;
    }(te || (te = {})), function(a) {
      function i(u, l) {
      ...
      function o(u) {
        let l = u;
        return C.objectLiteral(l) && te.is(l.targetRange) && C.string(l.targetUri) && te.is(l.targetSelectionRange) && (te.is(l.originSelectionRange) || C.undefined(l.originSelectionRange));
      }
      s(o, "is"), a.is = o;
    }(Rp || (Rp = {})), function(a) {
      function i(u, l, c, f) {
      ...
      function o(u) {
        const l = u;
        return C.objectLiteral(l) && C.numberRange(l.red, 0, 1) && C.numberRange(l.green, 0, 1) && C.numberRange(l.blue, 0, 1) && C.numberRange(l.alpha, 0, 1);
      }
      s(o, "is"), a.is = o;
    }(Ac || (Ac = {})), function(a) {
      function i(u, l) {
      ...
      function o(u) {
        const l = u;
        return C.objectLiteral(l) && te.is(l.range) && Ac.is(l.color);
      }
      s(o, "is"), a.is = o;
    }(Ap || (Ap = {})), function(a) {
      function i(u, l, c) {
      ...
      function o(u) {
        const l = u;
        return C.objectLiteral(l) && C.string(l.label) && (C.undefined(l.textEdit) || nr.is(l)) && (C.undefined(l.additionalTextEdits) || C.typedArray(l.additionalTextEdits, nr.is));
      }
      s(o, "is"), a.is = o;
    }(Ep || (Ep = {})), function(a) {
      ...
      function i(u, l, c, f, d, p) {
        ...
        return C.defined(c) && (h.startCharacter = c), C.defined(f) && (h.endCharacter = f), C.defined(d) && (h.kind = d), C.defined(p) && (h.collapsedText = p), h;
      }
      s(i, "create"), a.create = i;
      function o(u) {
        const l = u;
        return C.objectLiteral(l) && C.uinteger(l.startLine) && C.uinteger(l.startLine) && (C.undefined(l.startCharacter) || C.uinteger(l.startCharacter)) && (C.undefined(l.endCharacter) || C.uinteger(l.endCharacter)) && (C.undefined(l.kind) || C.string(l.kind));
      }
      s(o, "is"), a.is = o;
    }(bp || (bp = {})), function(a) {
      function i(u, l) {
      ...
      function o(u) {
        let l = u;
        return C.defined(l) && Kl.is(l.location) && C.string(l.message);
      }
      s(o, "is"), a.is = o;
    }(Ec || (Ec = {})), function(a) {
      ...
      function i(u, l, c, f, d, p) {
        ...
        return C.defined(c) && (h.severity = c), C.defined(f) && (h.code = f), C.defined(d) && (h.source = d), C.defined(p) && (h.relatedInformation = p), h;
      }
      s(i, "create"), a.create = i;
      function o(u) {
        var l;
        let c = u;
        return C.defined(c) && te.is(c.range) && C.string(c.message) && (C.number(c.severity) || C.undefined(c.severity)) && (C.integer(c.code) || C.string(c.code) || C.undefined(c.code)) && (C.undefined(c.codeDescription) || C.string((l = c.codeDescription) === null || l === void 0 ? void 0 : l.href)) && (C.string(c.source) || C.undefined(c.source)) && (C.undefined(c.relatedInformation) || C.typedArray(c.relatedInformation, Ec.is));
      }
      s(o, "is"), a.is = o;
    }(Wl || (Wl = {})), function(a) {
      function i(u, l, ...c) {
      ...
      function o(u) {
        const l = u;
        return C.objectLiteral(l) && C.string(l.label) && (C.boolean(l.needsConfirmation) || l.needsConfirmation === void 0) && (C.string(l.description) || l.description === void 0);
      }
      s(o, "is"), a.is = o;
    }(pn || (pn = {})), function(a) {
      function i(o) {
      ...
      function l(c) {
        const f = c;
        return nr.is(f) && (pn.is(f.annotationId) || et.is(f.annotationId));
      }
      s(l, "is"), a.is = l;
    }(Rr || (Rr = {})), function(a) {
      function i(u, l) {
      ...
      function o(u) {
        let l = u;
        return C.defined(l) && Vl.is(l.textDocument) && Array.isArray(l.edits);
      }
      s(o, "is"), a.is = o;
    }(ql || (ql = {})), function(a) {
      function i(u, l, c) {
      ...
      function o(u) {
        let l = u;
        return l && l.kind === "create" && C.string(l.uri) && (l.options === void 0 || (l.options.overwrite === void 0 || C.boolean(l.options.overwrite)) && (l.options.ignoreIfExists === void 0 || C.boolean(l.options.ignoreIfExists))) && (l.annotationId === void 0 || et.is(l.annotationId));
      }
      s(o, "is"), a.is = o;
    }(ba || (ba = {})), function(a) {
      function i(u, l, c, f) {
      ...
      function o(u) {
        let l = u;
        return l && l.kind === "rename" && C.string(l.oldUri) && C.string(l.newUri) && (l.options === void 0 || (l.options.overwrite === void 0 || C.boolean(l.options.overwrite)) && (l.options.ignoreIfExists === void 0 || C.boolean(l.options.ignoreIfExists))) && (l.annotationId === void 0 || et.is(l.annotationId));
      }
      s(o, "is"), a.is = o;
    }(_a || (_a = {})), function(a) {
      function i(u, l, c) {
      ...
      function o(u) {
        let l = u;
        return l && l.kind === "delete" && C.string(l.uri) && (l.options === void 0 || (l.options.recursive === void 0 || C.boolean(l.options.recursive)) && (l.options.ignoreIfNotExists === void 0 || C.boolean(l.options.ignoreIfNotExists))) && (l.annotationId === void 0 || et.is(l.annotationId));
      }
      s(o, "is"), a.is = o;
    }(Sa || (Sa = {})), function(a) {
      function i(o) {
        let u = o;
        return u && (u.changes !== void 0 || u.documentChanges !== void 0) && (u.documentChanges === void 0 || u.documentChanges.every((l) => C.string(l.kind) ? ba.is(l) || _a.is(l) || Sa.is(l) : ql.is(l)));
      }
      s(i, "is"), a.is = i;
    }(Cc || (Cc = {})), Pl = (t = class {
      constructor(i, o) {
    ...
    }, s(t, "TextEditChangeImpl"), t), Bd = (e = class {
      constructor(i) {
    ...
    }, s(e, "ChangeAnnotations"), e), D$ = (r = class {
      constructor(i) {
        this._textEditChanges = /* @__PURE__ */ Object.create(null), i !== void 0 ? (this._workspaceEdit = i, i.documentChanges ? (this._changeAnnotations = new Bd(i.changeAnnotations), i.changeAnnotations = this._changeAnnotations.all(), i.documentChanges.forEach((o) => {
          if (ql.is(o)) {
            const u = new Pl(o.edits, this._changeAnnotations);
            this._textEditChanges[o.textDocument.uri] = u;
          }
        })) : i.changes && Object.keys(i.changes).forEach((o) => {
          const u = new Pl(i.changes[o]);
      ...
      getTextEditChange(i) {
        if (Vl.is(i)) {
          ...
          if (!u) {
            ...
            this._workspaceEdit.documentChanges.push(c), u = new Pl(l, this._changeAnnotations), this._textEditChanges[o.uri] = u;
          }
          return u;
        } else {
          ...
          if (!o) {
            let u = [];
            this._workspaceEdit.changes[i] = u, o = new Pl(u), this._textEditChanges[i] = o;
          }
          return o;
        }
      }
      initDocumentChanges() {
        this._workspaceEdit.documentChanges === void 0 && this._workspaceEdit.changes === void 0 && (this._changeAnnotations = new Bd(), this._workspaceEdit.documentChanges = [], this._workspaceEdit.changeAnnotations = this._changeAnnotations.all());
      }
      initChanges() {
      ...
      createFile(i, o, u) {
        if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0)
          throw new Error("Workspace edit is not configured for document changes.");
        let l;
        pn.is(o) || et.is(o) ? l = o : u = o;
        let c, f;
        if (l === void 0 ? c = ba.create(i, u) : (f = et.is(l) ? l : this._changeAnnotations.manage(l), c = ba.create(i, u, f)), this._workspaceEdit.documentChanges.push(c), f !== void 0)
          return f;
      }
      renameFile(i, o, u, l) {
        if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0)
          throw new Error("Workspace edit is not configured for document changes.");
        let c;
        pn.is(u) || et.is(u) ? c = u : l = u;
        let f, d;
        if (c === void 0 ? f = _a.create(i, o, l) : (d = et.is(c) ? c : this._changeAnnotations.manage(c), f = _a.create(i, o, l, d)), this._workspaceEdit.documentChanges.push(f), d !== void 0)
          return d;
      }
      deleteFile(i, o, u) {
        if (this.initDocumentChanges(), this._workspaceEdit.documentChanges === void 0)
        ...
        pn.is(o) || et.is(o) ? l = o : u = o;
        let c, f;
        if (l === void 0 ? c = Sa.create(i, u) : (f = et.is(l) ? l : this._changeAnnotations.manage(l), c = Sa.create(i, u, f)), this._workspaceEdit.documentChanges.push(c), f !== void 0)
          return f;
      }
      ...
      function o(u) {
        let l = u;
        return C.defined(l) && C.string(l.uri) && C.string(l.languageId) && C.integer(l.version) && C.string(l.text);
      }
      s(o, "is"), a.is = o;
    }(Pp || (Pp = {})), function(a) {
      ...
      function i(o) {
        const u = o;
        return C.objectLiteral(o) && bc.is(u.kind) && C.string(u.value);
      }
      s(i, "is"), a.is = i;
    }(wa || (wa = {})), function(a) {
      ...
      function i(o) {
        const u = o;
        return u && (C.string(u.detail) || u.detail === void 0) && (C.string(u.description) || u.description === void 0);
      }
      s(i, "is"), a.is = i;
    }(Mp || (Mp = {})), function(a) {
      function i(o) {
      ...
      function i(o) {
        let u = o;
        return !!u && C.objectLiteral(u) && (wa.is(u.contents) || Hl.is(u.contents) || C.typedArray(u.contents, Hl.is)) && (o.range === void 0 || te.is(o.range));
      }
      s(i, "is"), a.is = i;
    }(zp || (zp = {})), function(a) {
      function i(o, u) {
      ...
      function i(u, l, c, f, d, p) {
        ...
        return p !== void 0 && (h.children = p), h;
      }
      s(i, "create"), a.create = i;
      function o(u) {
        let l = u;
        return l && C.string(l.name) && C.number(l.kind) && te.is(l.range) && te.is(l.selectionRange) && (l.detail === void 0 || C.string(l.detail)) && (l.deprecated === void 0 || C.boolean(l.deprecated)) && (l.children === void 0 || Array.isArray(l.children)) && (l.tags === void 0 || Array.isArray(l.tags));
      }
      s(o, "is"), a.is = o;
    }(Yp || (Yp = {})), function(a) {
      ...
      function o(u) {
        let l = u;
        return C.defined(l) && C.typedArray(l.diagnostics, Wl.is) && (l.only === void 0 || C.typedArray(l.only, C.string)) && (l.triggerKind === void 0 || l.triggerKind === Yl.Invoked || l.triggerKind === Yl.Automatic);
      }
      s(o, "is"), a.is = o;
    }(Jp || (Jp = {})), function(a) {
      function i(u, l, c) {
        let f = { title: u }, d = !0;
        return typeof l == "string" ? (d = !1, f.kind = l) : dn.is(l) ? f.command = l : f.edit = l, d && c !== void 0 && (f.kind = c), f;
      }
      s(i, "create"), a.create = i;
      function o(u) {
        let l = u;
        return l && C.string(l.title) && (l.diagnostics === void 0 || C.typedArray(l.diagnostics, Wl.is)) && (l.kind === void 0 || C.string(l.kind)) && (l.edit !== void 0 || l.command !== void 0) && (l.command === void 0 || dn.is(l.command)) && (l.isPreferred === void 0 || C.boolean(l.isPreferred)) && (l.edit === void 0 || Cc.is(l.edit));
      }
      s(o, "is"), a.is = o;
    }(Zp || (Zp = {})), function(a) {
      function i(u, l) {
      ...
      function o(u) {
        let l = u;
        return C.defined(l) && te.is(l.range) && (C.undefined(l.command) || dn.is(l.command));
      }
      s(o, "is"), a.is = o;
    }(Qp || (Qp = {})), function(a) {
      function i(u, l) {
      ...
      function i(o) {
        const u = o;
        return C.objectLiteral(u) && (u.resultId === void 0 || typeof u.resultId == "string") && Array.isArray(u.data) && (u.data.length === 0 || typeof u.data[0] == "number");
      }
      s(i, "is"), a.is = i;
    }(im || (im = {})), function(a) {
      function i(u, l) {
      ...
      function o(u) {
        const l = u;
        return l != null && te.is(l.range) && C.boolean(l.caseSensitiveLookup) && (C.string(l.variableName) || l.variableName === void 0);
      }
      s(o, "is"), a.is = o;
    }(om || (om = {})), function(a) {
      function i(u, l) {
      ...
      function o(u) {
        const l = u;
        return C.objectLiteral(l) && (l.tooltip === void 0 || C.string(l.tooltip) || wa.is(l.tooltip)) && (l.location === void 0 || Kl.is(l.location)) && (l.command === void 0 || dn.is(l.command));
      }
      s(o, "is"), a.is = o;
    }(Sc || (Sc = {})), function(a) {
      function i(u, l, c) {
      ...
      function o(u) {
        const l = u;
        return C.objectLiteral(l) && oe.is(l.position) && (C.string(l.label) || C.typedArray(l.label, Sc.is)) && (l.kind === void 0 || _c.is(l.kind)) && l.textEdits === void 0 || C.typedArray(l.textEdits, nr.is) && (l.tooltip === void 0 || C.string(l.tooltip) || wa.is(l.tooltip)) && (l.paddingLeft === void 0 || C.boolean(l.paddingLeft)) && (l.paddingRight === void 0 || C.boolean(l.paddingRight));
      }
      s(o, "is"), a.is = o;
    }(cm || (cm = {})), function(a) {
      function i(o) {
      ...
      function i(o) {
        const u = o;
        return C.objectLiteral(u) && Rc.is(u.uri) && C.string(u.name);
      }
      s(i, "is"), a.is = i;
    }(gm || (gm = {})), x$ = [`
`, `\r
`, "\r"], function(a) {
      function i(c, f, d, p) {
        return new av(c, f, d, p);
      }
      s(i, "create"), a.create = i;
      function o(c) {
        let f = c;
        return !!(C.defined(f) && C.string(f.uri) && (C.undefined(f.languageId) || C.string(f.languageId)) && C.uinteger(f.lineCount) && C.func(f.getText) && C.func(f.positionAt) && C.func(f.offsetAt));
      }
      s(o, "is"), a.is = o;
      function u(c, f) {
        let d = c.getText(), p = l(f, (y, v) => {
          let E = y.range.start.line - v.range.start.line;
          return E === 0 ? y.range.start.character - v.range.start.character : E;
        }), h = d.length;
        for (let y = p.length - 1; y >= 0; y--) {
          let v = p[y], E = c.offsetAt(v.range.start), T = c.offsetAt(v.range.end);
          if (T <= h)
            d = d.substring(0, E) + v.newText + d.substring(T, d.length);
          else
      ...
      function l(c, f) {
        if (c.length <= 1)
          return c;
        const d = c.length / 2 | 0, p = c.slice(0, d), h = c.slice(d);
        l(p, f), l(h, f);
        let y = 0, v = 0, E = 0;
        for (; y < p.length && v < h.length; )
          f(p[y], h[v]) <= 0 ? c[E++] = p[y++] : c[E++] = h[v++];
        for (; y < p.length; )
          c[E++] = p[y++];
        for (; v < h.length; )
          c[E++] = h[v++];
...
` && l++;
      ...
      function d(T, w, b) {
        return i.call(T) === "[object Number]" && w <= T && T <= b;
      }
      ...
      function E(T, w) {
        return Array.isArray(T) && T.every(w);
      }
      s(E, "typedArray"), a.typedArray = E;
    }(C || (C = {}));
  }
}), Wn = X({
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/cancellation.js"(t) {
    ...
    (function(f) {
      ...
      function d(p) {
        const h = p;
        return h && (h === f.None || h === f.Cancelled || r.boolean(h.isCancellationRequested) && !!h.onCancellationRequested);
      }
      s(d, "is"), f.is = d;
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/messages.js"(t) {
    var k, _, $, I, R, A, S, L, x, O, z, M, Y, V, Z, ae, Le, pe, Ce, qe, De, ee, Qe, ce, Ve;
    ...
    t.RequestType5 = p;
    var h = (z = class extends i {
      constructor(G) {
        super(G, 6);
      }
    }, s(z, "RequestType6"), z);
    t.RequestType6 = h;
    var y = (M = class extends i {
      constructor(G) {
        super(G, 7);
      }
    }, s(M, "RequestType7"), M);
    t.RequestType7 = y;
    var v = (Y = class extends i {
      constructor(G) {
        super(G, 8);
      }
    }, s(Y, "RequestType8"), Y);
    t.RequestType8 = v;
    var E = (V = class extends i {
      constructor(G) {
        super(G, 9);
      }
    }, s(V, "RequestType9"), V);
    ...
    var B = (Ce = class extends i {
      constructor(G) {
        super(G, 3);
      }
    }, s(Ce, "NotificationType3"), Ce);
    ...
    var J = (De = class extends i {
      constructor(G) {
        super(G, 5);
      }
    }, s(De, "NotificationType5"), De);
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/sharedArrayCancellation.js"(t) {
    ...
    var n = (u = class {
      ...
      enableCancellation(p) {
        if (p.id === null)
          return;
        const h = new SharedArrayBuffer(4), y = new Int32Array(h, 0, 1);
        y[0] = r.Continue, this.buffers.set(p.id, h), p.$cancellationData = h;
      }
      async sendCancellation(p, h) {
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/messageReader.js"(t) {
    ...
    var e = Wn(), r = xu(), n = nl(), a = F$(), i;
    (function(d) {
      function p(h) {
        let y = h;
        return y && r.func(y.listen) && r.func(y.dispose) && r.func(y.onError) && r.func(y.onClose) && r.func(y.onPartialMessage);
      }
      s(p, "is"), d.is = p;
    })(i || (t.MessageReader = i = {}));
    var o = (c = class {
    ...
    (function(d) {
      function p(h) {
        ...
        if (h === void 0 || typeof h == "string")
          ...
          if (y = h.charset ?? "utf-8", h.contentDecoder !== void 0 && (v = h.contentDecoder, E.set(v.name, v)), h.contentDecoders !== void 0)
            for (const b of h.contentDecoders)
              E.set(b.name, b);
          if (h.contentTypeDecoder !== void 0 && (T = h.contentTypeDecoder, w.set(T.name, T)), h.contentTypeDecoders !== void 0)
            for (const b of h.contentTypeDecoders)
              w.set(b.name, b);
        }
        return T === void 0 && (T = (0, e.default)().applicationJson.decoder, w.set(T.name, T)), { charset: y, contentDecoder: v, contentDecoders: E, contentTypeDecoder: T, contentTypeDecoders: w };
      }
      s(p, "fromOptions"), d.fromOptions = p;
    })(u || (u = {}));
    var l = (f = class extends o {
      constructor(p, h) {
        super(), this.readable = p, this.options = u.fromOptions(h), this.buffer = (0, e.default)().messageBuffer.create(this.options.charset), this._partialMessageTimeout = 1e4, this.nextMessageLength = -1, this.messageToken = 0, this.readSemaphore = new a.Semaphore(1);
      }
...
${JSON.stringify(Object.fromEntries(y))}`));
            ...
            this.clearPartialMessageTimer(), this.nextMessageLength = -1, this.readSemaphore.lock(async () => {
              const y = this.options.contentDecoder !== void 0 ? await this.options.contentDecoder.decode(h) : h, v = await this.options.contentTypeDecoder.decode(y, this.options);
              this.callback(v);
            }).catch((y) => {
              this.fireError(y);
            });
      ...
      setPartialMessageTimer() {
        this.clearPartialMessageTimer(), !(this._partialMessageTimeout <= 0) && (this.partialMessageTimer = (0, e.default)().timer.setTimeout((p, h) => {
          this.partialMessageTimer = void 0, p === this.messageToken && (this.firePartialMessage({ messageToken: p, waitingTime: h }), this.setPartialMessageTimer());
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/messageWriter.js"(t) {
    ...
    var e = Wn(), r = xu(), n = F$(), a = nl(), i = "Content-Length: ", o = `\r
`, u;
    (function(h) {
      function y(v) {
        let E = v;
        return E && r.func(E.dispose) && r.func(E.onClose) && r.func(E.onError) && r.func(E.write);
      }
      s(y, "is"), h.is = y;
    })(u || (t.MessageWriter = u = {}));
    var l = (d = class {
      ...
      fireError(y, v, E) {
        this.errorEmitter.fire([this.asError(y), v, E]);
      }
      get onClose() {
        return this.closeEmitter.event;
      }
      ...
      asError(y) {
        return y instanceof Error ? y : new Error(`Writer received error. Reason: ${r.string(y.message) ? y.message : "unknown"}`);
      }
    ...
    (function(h) {
      function y(v) {
        return v === void 0 || typeof v == "string" ? { charset: v ?? "utf-8", contentTypeEncoder: (0, e.default)().applicationJson.encoder } : { charset: v.charset ?? "utf-8", contentEncoder: v.contentEncoder, contentTypeEncoder: v.contentTypeEncoder ?? (0, e.default)().applicationJson.encoder };
      }
      s(y, "fromOptions"), h.fromOptions = y;
    })(c || (c = {}));
    var f = (p = class extends l {
      constructor(y, v) {
        super(), this.writable = y, this.options = c.fromOptions(v), this.errorCount = 0, this.writeSemaphore = new n.Semaphore(1), this.writable.onError((E) => this.fireError(E)), this.writable.onClose(() => this.fireClose());
      }
      async write(y) {
        return this.writeSemaphore.lock(async () => this.options.contentTypeEncoder.encode(y, this.options).then((E) => this.options.contentEncoder !== void 0 ? this.options.contentEncoder.encode(E) : E).then((E) => {
          const T = [];
          return T.push(i, E.byteLength.toString(), o), T.push(o), this.doWrite(y, T, E);
        }, (E) => {
      ...
      async doWrite(y, v, E) {
        try {
          return await this.writable.write(v.join(""), "ascii"), this.writable.write(E);
        } catch (T) {
...
`, a = (i = class {
      ...
      tryReadHeaders(u = !1) {
        ...
        if (l !== 4)
          return;
        const p = this._read(d + f), h = /* @__PURE__ */ new Map(), y = this.toString(p, "ascii").split(n);
        if (y.length < 2)
          return h;
        for (let v = 0; v < y.length - 2; v++) {
          const E = y[v], T = E.indexOf(":");
          if (T === -1)
            throw new Error(`Message header must separate key and value using ':'
${E}`);
          const w = E.substr(0, T), b = E.substr(T + 1).trim();
          h.set(u ? w.toLowerCase() : w, b);
        }
        return h;
      }
      tryReadBody(u) {
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/common/connection.js"(t) {
    ...
    var e = Wn(), r = xu(), n = M$(), a = G$(), i = nl(), o = Lf(), u;
    (function($) {
    ...
    (function($) {
      function I(R) {
        const A = R;
        return A && (he.is(A.cancellationStrategy) || b.is(A.connectionStrategy) || Ee.is(A.messageStrategy));
      }
      s(I, "is"), $.is = I;
    ...
    function ot($, I, R, A) {
      ...
      let Le, pe = new a.LinkedMap(), Ce = /* @__PURE__ */ new Map(), qe = /* @__PURE__ */ new Set(), De = /* @__PURE__ */ new Map(), ee = p.Off, Qe = y.Text, ce, Ve = ue.New;
      ...
      s(da, "createRequestQueueKey");
      function ml(g) {
        return g === null ? "res-unknown-" + (++O).toString() : "res-" + g.toString();
      }
      s(ml, "createResponseQueueKey");
      function hl() {
        return "not-" + (++x).toString();
      }
      s(hl, "createNotificationQueueKey");
      function yl(g, P) {
        n.Message.isRequest(P) ? g.set(da(P.id), P) : n.Message.isResponse(P) ? g.set(ml(P.id), P) : g.set(hl(), P);
      }
      s(yl, "addMessageToQueue");
      function gl(g) {
      }
      s(gl, "cancelUndispatched");
      function pa() {
      ...
      s(vl, "readErrorHandler");
      function Tl(g) {
        ge.fire(g);
      }
      s(Tl, "writeErrorHandler"), $.onClose(ha), $.onError(vl), I.onClose(ha), I.onError(Tl);
      function ya() {
        Le || pe.size === 0 || (Le = (0, e.default)().timer.setImmediate(() => {
          Le = void 0, $l();
        }));
      }
      s(ya, "triggerMessageQueue");
      function ga(g) {
        n.Message.isRequest(g) ? Rl(g) : n.Message.isNotification(g) ? El(g) : n.Message.isResponse(g) ? Al(g) : Cl(g);
      }
      s(ga, "handleMessage");
      function $l() {
        if (pe.size === 0)
        ...
        const g = pe.shift();
        try {
          const P = A == null ? void 0 : A.messageStrategy;
          Ee.is(P) ? P.handleMessage(g, ga) : ga(g);
        } finally {
          ya();
        }
      }
      s($l, "processMessageQueue");
      const rc = /* @__PURE__ */ s((g) => {
        try {
          if (n.Message.isNotification(g) && g.method === u.type.method) {
            const P = g.params.id, D = da(P), F = pe.get(D);
            if (n.Message.isRequest(F)) {
              const me = A == null ? void 0 : A.connectionStrategy, Te = me && me.cancelUndispatched ? me.cancelUndispatched(F, gl) : void 0;
              if (Te && (Te.error !== void 0 || Te.result !== void 0)) {
                pe.delete(D), De.delete(P), Te.id = F.id, zr(Te, g.method, Date.now()), I.write(Te).catch(() => S.error("Sending response for canceled message failed."));
                return;
              }
            }
            const be = De.get(P);
      ...
      function Rl(g) {
        ...
        function P(ie, Pe, fe) {
          ...
          ie instanceof n.ResponseError ? Ue.error = ie.toJson() : Ue.result = ie === void 0 ? null : ie, zr(Ue, Pe, fe), I.write(Ue).catch(() => S.error("Sending response failed."));
        }
        s(P, "reply");
        function D(ie, Pe, fe) {
          const Ue = {
          ...
          zr(Ue, Pe, fe), I.write(Ue).catch(() => S.error("Sending response failed."));
        }
        s(D, "replyError");
        function F(ie, Pe, fe) {
          ie === void 0 && (ie = null);
        ...
        s(F, "replySuccess"), Sl(g);
        const be = Y.get(g.method);
        let me, Te;
        be && (me = be.type, Te = be.handler);
        const Ge = Date.now();
        if (Te || M) {
          const ie = g.id ?? String(Date.now()), Pe = N.is(ve.receiver) ? ve.receiver.createCancellationTokenSource(ie) : ve.receiver.createCancellationTokenSource(g);
          g.id !== null && qe.has(g.id) && Pe.cancel(), g.id !== null && De.set(ie, Pe);
          try {
            let fe;
            if (Te)
              if (g.params === void 0) {
            ...
            else M && (fe = M(g.method, g.params, Pe.token));
            const Ue = fe;
            fe ? Ue.then ? Ue.then((lt) => {
              De.delete(ie), P(lt, g.method, Ge);
            }, (lt) => {
              De.delete(ie), lt instanceof n.ResponseError ? D(lt, g.method, Ge) : lt && r.string(lt.message) ? D(new n.ResponseError(n.ErrorCodes.InternalError, `Request ${g.method} failed with message: ${lt.message}`), g.method, Ge) : D(new n.ResponseError(n.ErrorCodes.InternalError, `Request ${g.method} failed unexpectedly without providing any details.`), g.method, Ge);
            }) : (De.delete(ie), P(fe, g.method, Ge)) : (De.delete(ie), F(fe, g.method, Ge));
          } catch (fe) {
            De.delete(ie), fe instanceof n.ResponseError ? P(fe, g.method, Ge) : fe && r.string(fe.message) ? D(new n.ResponseError(n.ErrorCodes.InternalError, `Request ${g.method} failed with message: ${fe.message}`), g.method, Ge) : D(new n.ResponseError(n.ErrorCodes.InternalError, `Request ${g.method} failed unexpectedly without providing any details.`), g.method, Ge);
          }
        } else
...
`), ce.log(`Received request '${g.method} - (${g.id})'.`, P);
      ...
      s(Sl, "traceReceivedRequest");
      function sn(g) {
        if (!(ee === p.Off || !ce || g.method === E.type.method))
          if (Qe === y.Text) {
            let P;
            (ee === p.Verbose || ee === p.Compact) && (g.params ? P = `Params: ${Dt(g.params)}
...
`), ce.log(`Received notification '${g.method}'.`, P);
      ...
      s(sn, "traceReceivedNotification");
      function wl(g, P) {
        if (!(ee === p.Off || !ce))
          if (Qe === y.Text) {
            let D;
...
`)), P) {
      ...
      function vr() {
        if (ma())
          throw new w(T.Closed, "Connection is closed.");
        if (Qt())
          throw new w(T.Disposed, "Connection is disposed.");
      }
      s(vr, "throwIfClosedOrDisposed");
      function Il() {
        if (pa())
          throw new w(T.AlreadyListening, "Connection is already listening");
      }
      s(Il, "throwIfListening");
      function Nl() {
        if (!pa())
          throw new Error("Call listen() first.");
      }
      s(Nl, "throwIfNotListening");
      function m(g) {
      ...
      function Ne(g, P) {
        ...
        switch (F) {
          ...
          default:
            D = [];
            for (let be = 0; be < P.length && be < F; be++)
              D.push(m(P[be]));
            if (P.length < F)
              for (let be = P.length; be < F; be++)
                D.push(null);
            break;
        }
        return D;
      ...
      const va = {
        sendNotification: /* @__PURE__ */ s((g, ...P) => {
          ...
          if (r.string(g)) {
            D = g;
            const me = P[0];
            let Te = 0, Ge = n.ParameterStructures.auto;
            n.ParameterStructures.is(me) && (Te = 1, Ge = me);
            let ie = P.length;
            const Pe = ie - Te;
            switch (Pe) {
              case 0:
              ...
              default:
                ...
                F = P.slice(Te, ie).map((fe) => m(fe));
                break;
            }
          } else {
            const me = P;
            D = g.method, F = Ne(g, me);
          }
          const be = {
            jsonrpc: z,
            method: D,
          ...
          return _l(be), I.write(be).catch((me) => {
        ...
        sendProgress: /* @__PURE__ */ s((g, P, D) => va.sendNotification(c.type, { token: P, value: D }), "sendProgress"),
        ...
        sendRequest: /* @__PURE__ */ s((g, ...P) => {
          ...
          if (r.string(g)) {
            ...
            switch (tr) {
              ...
              default:
                ...
                F = P.slice(fe, lt).map((ck) => m(ck));
                break;
            }
          } else {
            const ie = P;
            D = g.method, F = Ne(g, ie);
            const Pe = g.numberOfParams;
            be = o.CancellationToken.is(ie[Pe]) ? ie[Pe] : void 0;
          }
          const me = L++;
          let Te;
          be && (Te = be.onCancellationRequested(() => {
            const ie = ve.sender.sendCancellation(va, me);
          ...
          return bl(Ge), typeof ve.sender.enableCancellation == "function" && ve.sender.enableCancellation(Ge), new Promise(async (ie, Pe) => {
            const fe = /* @__PURE__ */ s((tr) => {
              ie(tr), ve.sender.cleanup(me), Te == null || Te.dispose();
            }, "resolveWithCleanup"), Ue = /* @__PURE__ */ s((tr) => {
              Pe(tr), ve.sender.cleanup(me), Te == null || Te.dispose();
            }, "rejectWithCleanup"), lt = { method: D, timerStart: Date.now(), resolve: fe, reject: Ue };
            try {
              await I.write(Ge), Ce.set(me, lt);
            } catch (tr) {
        ...
        hasPendingResponse: /* @__PURE__ */ s(() => Ce.size > 0, "hasPendingResponse"),
        trace: /* @__PURE__ */ s(async (g, P, D) => {
          let F = !1, be = y.Text;
          D !== void 0 && (r.boolean(D) ? F = D : (F = D.sendNotification || !1, be = D.traceFormat || y.Text)), ee = g, Qe = be, ee === p.Off ? ce = void 0 : ce = P, F && !ma() && !Qt() && await va.sendNotification(v.type, { value: p.toString(g) });
        }, "trace"),
        onError: ge.event,
        onClose: G.event,
        ...
        dispose: /* @__PURE__ */ s(() => {
          ...
          for (const P of Ce.values())
            P.reject(g);
          Ce = /* @__PURE__ */ new Map(), De = /* @__PURE__ */ new Map(), qe = /* @__PURE__ */ new Set(), pe = new a.LinkedMap(), r.func(I.dispose) && I.dispose(), r.func($.dispose) && $.dispose();
        }, "dispose"),
        listen: /* @__PURE__ */ s(() => {
          vr(), Il(), Ve = ue.Listening, $.listen(rc);
        }, "listen"),
        inspect: /* @__PURE__ */ s(() => {
          (0, e.default)().console.log("inspect");
        }, "inspect")
      };
      return va.onNotification(E.type, (g) => {
        if (ee === p.Off || !ce)
          return;
        const P = ee === p.Verbose || ee === p.Compact;
        ce.log(g.message, P ? g.verbose : void 0);
      }), va.onNotification(c.type, (g) => {
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/browser/ril.js"(t) {
    var l, c, f;
    Object.defineProperty(t, "__esModule", { value: !0 });
    var e = Tm(), r = (l = class extends e.AbstractMessageBuffer {
      constructor(p = "utf-8") {
      ...
      toString(p, h) {
        return h === "ascii" ? this.asciiDecoder.decode(p) : new TextDecoder(h).decode(p);
      }
      asNative(p, h) {
        return h === void 0 ? p : p.slice(0, h);
      }
      allocNative(p) {
    ...
    var n = (c = class {
      constructor(p) {
        this.socket = p, this._onData = new e.Emitter(), this._messageListener = (h) => {
          h.data.arrayBuffer().then((v) => {
      ...
      write(p, h) {
        if (typeof p == "string") {
          if (h !== void 0 && h !== "utf-8")
            throw new Error(`In a Browser environments only utf-8 text encoding is supported. But got encoding: ${h}`);
          this.socket.send(p);
        } else
          this.socket.send(p);
      ...
      timer: Object.freeze({
        setTimeout(d, p, ...h) {
          const y = setTimeout(d, p, ...h);
          return { dispose: /* @__PURE__ */ s(() => clearTimeout(y), "dispose") };
        },
        setImmediate(d, ...p) {
          const h = setTimeout(d, 0, ...p);
          return { dispose: /* @__PURE__ */ s(() => clearTimeout(h), "dispose") };
        },
        setInterval(d, p, ...h) {
          const y = setInterval(d, p, ...h);
          return { dispose: /* @__PURE__ */ s(() => clearInterval(y), "dispose") };
        }
      })
    });
    function u() {
  ...
  "../../node_modules/.pnpm/vscode-jsonrpc@8.2.0/node_modules/vscode-jsonrpc/lib/browser/main.js"(t) {
    var l, c;
    var e = t && t.__createBinding || (Object.create ? function(f, d, p, h) {
      h === void 0 && (h = p);
      var y = Object.getOwnPropertyDescriptor(d, p);
      (!y || ("get" in y ? !d.__esModule : y.writable || y.configurable)) && (y = { enumerable: !0, get: /* @__PURE__ */ s(function() {
        return d[p];
      }, "get") }), Object.defineProperty(f, h, y);
    } : function(f, d, p, h) {
      h === void 0 && (h = p), f[h] = d[p];
    ...
    function u(f, d, p, h) {
      return p === void 0 && (p = a.NullLogger), a.ConnectionStrategy.is(h) && (h = { connectionStrategy: h }), (0, a.createMessageConnection)(f, d, p, h);
    }
  ...
  "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.notebook.js"(t) {
    ...
    (function(y) {
      function v(T, w, b, N) {
        return { uri: T, notebookType: w, version: b, cells: N };
      }
      s(v, "create"), y.create = v;
      function E(T) {
        const w = T;
    ...
    var l;
    (function(y) {
      y.method = "notebookDocument/sync", y.messageDirection = n.MessageDirection.clientToServer, y.type = new n.RegistrationType(y.method);
    })(l || (t.NotebookDocumentSyncRegistrationType = l = {}));
    var c;
    (function(y) {
      y.method = "notebookDocument/didOpen", y.messageDirection = n.MessageDirection.clientToServer, y.type = new n.ProtocolNotificationType(y.method), y.registrationMethod = l.method;
    ...
    (function(y) {
      ...
      s(v, "is"), y.is = v;
      function E(T, w, b) {
        const N = { start: T, deleteCount: w };
        return b !== void 0 && (N.cells = b), N;
      }
      s(E, "create"), y.create = E;
    })(f || (t.NotebookCellArrayChange = f = {}));
    var d;
    (function(y) {
      y.method = "notebookDocument/didChange", y.messageDirection = n.MessageDirection.clientToServer, y.type = new n.ProtocolNotificationType(y.method), y.registrationMethod = l.method;
    })(d || (t.DidChangeNotebookDocumentNotification = d = {}));
    var p;
    (function(y) {
      y.method = "notebookDocument/didSave", y.messageDirection = n.MessageDirection.clientToServer, y.type = new n.ProtocolNotificationType(y.method), y.registrationMethod = l.method;
    })(p || (t.DidSaveNotebookDocumentNotification = p = {}));
    var h;
    (function(y) {
      y.method = "notebookDocument/didClose", y.messageDirection = n.MessageDirection.clientToServer, y.type = new n.ProtocolNotificationType(y.method), y.registrationMethod = l.method;
  ...
  "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/protocol.js"(t) {
    ...
    Object.defineProperty(t, "LinkedEditingRangeRequest", { enumerable: !0, get: /* @__PURE__ */ s(function() {
      return E.LinkedEditingRangeRequest;
    }, "get") });
    var T = Gk();
    ...
    })(De || (t.DidOpenTextDocumentNotification = De = {}));
    var ee;
    (function(m) {
      function le(H) {
        let Ne = H;
        return Ne != null && typeof Ne.text == "string" && Ne.range !== void 0 && (Ne.rangeLength === void 0 || typeof Ne.rangeLength == "number");
      }
    ...
    })(gl || (t.CompletionResolveRequest = gl = {}));
    var pa;
    (function(m) {
    ...
    })(pa || (t.HoverRequest = pa = {}));
    var ma;
    (function(m) {
      m.Invoked = 1, m.TriggerCharacter = 2, m.ContentChange = 3;
    })(ma || (t.SignatureHelpTriggerKind = ma = {}));
    var Qt;
    (function(m) {
    ...
    })(El || (t.CodeLensResolveRequest = El = {}));
    var Cl;
    (function(m) {
    ...
    })(Cl || (t.CodeLensRefreshRequest = Cl = {}));
    var Dt;
    (function(m) {
    ...
    })(bl || (t.DocumentLinkResolveRequest = bl = {}));
    var _l;
    (function(m) {
    ...
    })(_l || (t.DocumentFormattingRequest = _l = {}));
    var zr;
    (function(m) {
    ...
    })(Sl || (t.DocumentRangesFormattingRequest = Sl = {}));
    var sn;
    (function(m) {
    ...
    })(sn || (t.DocumentOnTypeFormattingRequest = sn = {}));
    var wl;
    (function(m) {
      m.Identifier = 1;
    })(wl || (t.PrepareSupportDefaultBehavior = wl = {}));
    var er;
    (function(m) {
    ...
    })(Nl || (t.ApplyWorkspaceEditRequest = Nl = {}));
  }
}), Vk = X({
  ...
  "../../node_modules/.pnpm/vscode-languageserver-protocol@3.17.5/node_modules/vscode-languageserver-protocol/lib/common/api.js"(t) {
    ...
    Object.defineProperty(t, "__esModule", { value: !0 }), t.LSPErrorCodes = t.createProtocolConnection = void 0, r(al(), t), r((Du(), Rh(Of)), t), r(Oe(), t), r(qk(), t);
    var n = Vk();
...
en(z$, {
  ...
  AbstractCstNode: () => Sg,
  AbstractLangiumParser: () => Ig,
  AbstractParserErrorMessageProvider: () => SN,
  AbstractThreadedAsyncParser: () => TB,
  AstUtils: () => _h,
  BiMap: () => wf,
  Cancellation: () => Re,
  CompositeCstNodeImpl: () => Nd,
  ContextCache: () => Md,
  CstNodeBuilder: () => CN,
  CstUtils: () => Eh,
  DEFAULT_TOKENIZE_OPTIONS: () => Vg,
  DONE_RESULT: () => ut,
  DatatypeSymbol: () => Cf,
  DefaultAstNodeDescriptionProvider: () => nP,
  DefaultAstNodeLocator: () => iP,
  DefaultAsyncParser: () => EP,
  DefaultCommentProvider: () => AP,
  DefaultConfigurationProvider: () => sP,
  DefaultDocumentBuilder: () => oP,
  DefaultDocumentValidator: () => rP,
  DefaultHydrator: () => bP,
  DefaultIndexManager: () => lP,
  DefaultJsonSerializer: () => ZN,
  DefaultLangiumDocumentFactory: () => UN,
  DefaultLangiumDocuments: () => KN,
  DefaultLangiumProfiler: () => CB,
  DefaultLexer: () => Hg,
  DefaultLexerErrorMessageProvider: () => cP,
  DefaultLinker: () => WN,
  DefaultNameProvider: () => qN,
  DefaultReferenceDescriptionProvider: () => aP,
  DefaultReferences: () => VN,
  DefaultScopeComputation: () => HN,
  DefaultScopeProvider: () => JN,
  DefaultServiceRegistry: () => QN,
  DefaultTokenBuilder: () => Od,
  DefaultValueConverter: () => xg,
  DefaultWorkspaceLock: () => CP,
  DefaultWorkspaceManager: () => uP,
  Deferred: () => Lr,
  Disposable: () => Gn,
  DisposableCache: () => xd,
  DocumentCache: () => XN,
  ...
  EMPTY_STREAM: () => qo,
  EmptyFileSystem: () => st,
  EmptyFileSystemProvider: () => wP,
  ErrorWithLocation: () => Uf,
  GrammarAST: () => U$,
  GrammarUtils: () => ry,
  IndentationAwareLexer: () => RB,
  IndentationAwareTokenBuilder: () => SP,
  JSDocDocumentationProvider: () => RP,
  LangiumCompletionParser: () => wN,
  LangiumParser: () => _N,
  LangiumParserErrorMessageProvider: () => Ng,
  LeafCstNodeImpl: () => Ef,
  LexingMode: () => xn,
  MapScope: () => mB,
  Module: () => Qm,
  ...
  UriTrie: () => zg,
  UriUtils: () => ft,
  VALIDATE_EACH_NODE: () => tP,
  ValidationCategory: () => If,
  ValidationRegistry: () => eP,
  ValueConverter: () => sr,
  WorkspaceCache: () => Ug,
  assertCondition: () => ny,
  assertUnreachable: () => tn,
  createCompletionParser: () => Og,
  createDefaultCoreModule: () => Xe,
  createDefaultSharedCoreModule: () => Je,
  createGrammarConfig: () => Ay,
  createLangiumParser: () => Lg,
  createParser: () => Pd,
  delayNextTick: () => Ld,
  diagnosticData: () => Dn,
  eagerLoad: () => tv,
  getDiagnosticRange: () => Wg,
  indentationBuilderDefaultOptions: () => th,
  inject: () => re,
  interruptAndCheck: () => Ye,
  isAstNode: () => Be,
  isAstNodeDescription: () => Ch,
  isAstNodeWithComment: () => Kg,
  isCompositeCstNode: () => _r,
  isIMultiModeLexerDefinition: () => zd,
  isJSDoc: () => Xg,
  isLeafCstNode: () => qn,
  isLinkingError: () => Rn,
  isMultiReference: () => cr,
  isNamed: () => jg,
  isOperationCancelled: () => fa,
  isReference: () => ct,
  isRootCstNode: () => Df,
  isTokenTypeArray: () => Fd,
  isTokenTypeDictionary: () => Nf,
  loadGrammarFromJson: () => Ze,
  parseJSDoc: () => Yg,
  prepareLangiumParser: () => Dg,
  setInterruptionPeriod: () => Mg,
  startCancelableOperation: () => Dd,
  stream: () => de,
  toDiagnosticData: () => qg,
  toDiagnosticSeverity: () => yu
});
var Eh = {};
en(Eh, {
  DefaultNameRegexp: () => Jh,
  RangeComparison: () => or,
  compareRange: () => Yh,
  findCommentNode: () => Zh,
  findDeclarationNodeAtOffset: () => lR,
  findLeafNodeAtOffset: () => Bf,
  findLeafNodeBeforeOffset: () => Qh,
  flattenCst: () => oR,
  getDatatypeNode: () => sR,
  getInteriorNodes: () => fR,
  getNextNode: () => uR,
...
var At, lr = (At = class {
  ...
  join(e = ",") {
    ...
    let n = "", a, i = !1;
    do
      a = r.next(), a.done || (i && (n += e), n += j$(a.value)), i = !0;
    while (!a.done);
    return n;
  }
  indexOf(e, r = 0) {
  ...
  return t.length > 1 ? new lr(() => ({ collIndex: 0, arrIndex: 0 }), (e) => {
    do {
      ...
      if (e.collIndex < t.length) {
        ...
        gu(r) ? e.iterator = r[Symbol.iterator]() : r && typeof r.length == "number" && (e.array = r);
      }
...
var _h = {};
en(_h, {
  assignMandatoryProperties: () => Sh,
  copyAstNode: () => qc,
  findRootNode: () => Ha,
  getContainerOfType: () => Vn,
  getDocument: () => Wt,
  getReferenceNodes: () => Kc,
  hasContainerOfType: () => B$,
  linkContentToContainer: () => Ho,
...
function Ho(t, e = {}) {
  for (const [r, n] of Object.entries(t))
    r.startsWith("$") || (Array.isArray(n) ? n.forEach((a, i) => {
      Be(a) && (a.$container = t, a.$containerProperty = r, a.$containerIndex = i, e.deep && Ho(a, e));
    }) : Be(n) && (n.$container = t, n.$containerProperty = r, e.deep && Ho(n, e)));
}
s(Ho, "linkContentToContainer");
function Vn(t, e) {
  let r = t;
  for (; r; ) {
    if (e(r))
...
s(B$, "hasContainerOfType");
function Wt(t) {
  const r = Ha(t).$document;
  if (!r)
...
function xr(t, e) {
  ...
  return new Vo(t, (r) => Mu(r, e));
}
s(xr, "streamAllContents");
function qt(t, e) {
  if (t) {
    if (e != null && e.range && !Wc(t, e.range))
      return new Vo(t, () => []);
  } else throw new Error("Root node must be an AstNode.");
  return new Vo(t, (r) => Mu(r, e), { includeRoot: !0 });
}
s(qt, "streamAst");
function Wc(t, e) {
  var n;
...
s(Sh, "assignMandatoryProperties");
function wh(t) {
  ...
  for (const [a, i] of Object.entries(t))
    if (!a.startsWith("$"))
      if (Be(i))
        ...
        const o = [];
        for (const u of i)
          Be(u) ? o.push(qc(u, e, r)) : ct(u) ? o.push(e(n, a, u.$refNode, u.$refText, u)) : o.push(u);
        n[a] = o;
      } else
        n[a] = i;
  return Ho(n, { deep: !0 }), n;
}
s(qc, "copyAstNode");
var U$ = {};
en(U$, {
  AbstractElement: () => $t,
  AbstractParserRule: () => ru,
  AbstractRule: () => za,
  AbstractType: () => St,
  Action: () => Ur,
  Alternatives: () => nu,
  ...
  InferredType: () => Zc,
  InfixRule: () => ir,
  InfixRuleOperatorList: () => su,
  InfixRuleOperators: () => Qc,
  Interface: () => ja,
  Keyword: () => Ba,
  LangiumGrammarAstReflection: () => Vh,
  LangiumGrammarTerminals: () => Xk,
  NamedArgument: () => Ua,
  NegatedToken: () => En,
  Negation: () => ef,
  NumberLiteral: () => tf,
  Parameter: () => Ka,
  ParameterReference: () => rf,
  ParserRule: () => Bt,
  ReferenceType: () => ou,
  RegexToken: () => Cn,
  ReturnType: () => nf,
  ...
  ValueLiteral: () => kn,
  Wildcard: () => qa,
  isAbstractElement: () => xf,
  isAbstractParserRule: () => Hn,
  isAbstractRule: () => K$,
  isAbstractType: () => W$,
  isAction: () => Yr,
  isAlternatives: () => Mf,
  ...
  isInferredType: () => Gu,
  isInfixRule: () => Xo,
  isInfixRuleOperatorList: () => X$,
  isInfixRuleOperators: () => J$,
  isInterface: () => Dh,
  isKeyword: () => wr,
  isNamedArgument: () => Z$,
  isNegatedToken: () => xh,
  ...
  isSimpleType: () => Gf,
  isStringLiteral: () => tR,
  isTerminalAlternatives: () => Bh,
  isTerminalElement: () => rR,
  isTerminalGroup: () => Uh,
  isTerminalRule: () => zt,
  isTerminalRuleCall: () => Ff,
  isType: () => zf,
  isTypeAttribute: () => nR,
  isTypeDefinition: () => aR,
  isUnionType: () => Kh,
...
s(aR, "isTypeDefinition");
var sf = {
  $type: "UnionType",
  types: "types"
};
function Kh(t) {
  return U.isInstance(t, sf.$type);
}
s(Kh, "isUnionType");
var uu = {
  $type: "UnorderedGroup",
...
}, s(ei, "LangiumGrammarAstReflection"), ei), U = new Vh();
function sR(t) {
  let e = t, r = !1;
  for (; e; ) {
    const n = Vn(e.grammarSource, pt);
    if (n && n.dataType)
      e = e.container, r = !0;
    else return r ? e : void 0;
  }
}
s(sR, "getDatatypeNode");
function Jo(t) {
  return new Vo(t, (e) => _r(e) ? e.content : [], { includeRoot: !0 });
}
s(Jo, "streamCst");
function oR(t) {
  return Jo(t).filter(qn);
}
s(oR, "flattenCst");
function Hh(t, e) {
  for (; t.container; )
...
s(Yh, "compareRange");
function Xh(t, e) {
  return Yh(t, e) > or.After;
}
s(Xh, "inRange");
var Jh = /^[\w\p{L}]$/u;
function lR(t, e, r = Jh) {
  if (t) {
    if (e > 0) {
...
s(lR, "findDeclarationNodeAtOffset");
function Zh(t, e) {
  if (t) {
    const r = ty(t, !0);
    if (r && of(r, e))
...
s(cR, "getStartlineNode");
function fR(t, e) {
  const r = dR(t, e);
  return r ? r.parent.content.slice(r.a + 1, r.b) : [];
}
s(fR, "getInteriorNodes");
function dR(t, e) {
  const r = $m(t), n = $m(e);
  let a;
...
en(ry, {
  findAssignment: () => hy,
  findNameAssignment: () => Xf,
  findNodeForKeyword: () => my,
  findNodeForProperty: () => Vf,
  findNodesForKeyword: () => $R,
  findNodesForKeywordInternal: () => Yf,
  findNodesForProperty: () => py,
  getActionAtElement: () => gy,
  getActionType: () => Ty,
  getAllReachableRules: () => qf,
  getAllRulesUsedForCrossReferences: () => TR,
  getCrossReferenceTerminal: () => fy,
  getEntryRule: () => ly,
  getExplicitRuleType: () => zu,
  getHiddenRules: () => uy,
  getRuleType: () => $y,
  getRuleTypeName: () => bR,
  getTypeName: () => jn,
  isArrayCardinality: () => AR,
  isArrayOperator: () => ER,
  isCommentTerminal: () => dy,
  isDataType: () => CR,
  isDataTypeRule: () => Fu,
  isOptionalCardinality: () => RR,
  terminalRegex: () => ju
});
var ti, Uf = (ti = class extends Error {
  constructor(e, r) {
    super(e ? `${r} at ${e.range.start.line}:${e.range.start.character}` : r);
  }
}, s(ti, "ErrorWithLocation"), ti);
function tn(t, e = "Error: Got unexpected value.") {
  throw new Error(e);
}
s(tn, "assertUnreachable");
function ny(t, e = "Error: Condition is violated.") {
  if (!t)
    throw new Error(e);
}
s(ny, "assertCondition");
var ay = {};
en(ay, {
  NEWLINE_REGEXP: () => hR,
  escapeRegExp: () => il,
  getTerminalParts: () => gR,
  isMultilineComment: () => iy,
  isWhitespace: () => Wf,
  partialMatches: () => sy,
  partialRegExp: () => oy,
  whitespaceCharacters: () => vR
});
function W(t) {
...
`),
  ...
  W("　"),
  W("\uFEFF")
], Jk = /[0-9a-fA-F]/, nc = /[0-9]/, Zk = /[1-9]/, ri, mR = (ri = class {
  constructor() {
  ...
  atom() {
    ...
    if (e === void 0 && this.isPatternCharacter() && (e = this.patternCharacter()), mn(e))
...
`:
  ...
  characterClass() {
    ...
    for (this.consumeChar("["), this.peekChar(0) === "^" && (this.consumeChar("^"), r = !0); this.isClassAtom(); ) {
      ...
      if (n.type, Rm(n) && this.isRangeDash()) {
        this.consumeChar("-");
        ...
        if (a.type, Rm(a)) {
          ...
          wc(n.value, e), e.push(W("-")), wc(a.value, e);
      } else
        wc(n.value, e);
    }
...
`:
  ...
  isDigit() {
    return nc.test(this.peekChar(0));
  }
  isClassAtom(e = 0) {
...
}, s(ri, "RegExpParser"), ri), ni, Kf = (ni = class {
  visitChildren(e) {
    for (const r in e) {
      const n = e[r];
...
}, s(ni, "BaseRegExpVisitor"), ni), hR = /\r?\n/gm, yR = new mR(), ai, Qk = (ai = class extends Kf {
  constructor() {
...
}, s(ai, "TerminalRegExpVisitor"), ai), On = new Qk();
function gR(t) {
  try {
    typeof t != "string" && (t = t.source), t = `/${t}/`;
    const e = yR.pattern(t), r = [];
    for (const n of e.value.value)
      On.reset(t), On.visit(n), r.push({
        start: On.startRegexp,
        end: On.endRegex
      });
    return r;
  } catch {
...
s(gR, "getTerminalParts");
function iy(t) {
  try {
    return typeof t == "string" && (t = new RegExp(t)), t = t.toString(), On.reset(t), On.visit(yR.pattern(t)), On.multiline;
  } catch {
    return !1;
  }
}
s(iy, "isMultilineComment");
var vR = `\f
\r	\v              \u2028\u2029  　\uFEFF`.split("");
function Wf(t) {
  const e = typeof t == "string" ? new RegExp(t) : t;
  return vR.some((r) => e.test(r));
}
s(Wf, "isWhitespace");
function il(t) {
  return t.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
...
s(uy, "getHiddenRules");
function qf(t, e) {
  const r = /* @__PURE__ */ new Set(), n = ly(t);
  if (!n)
    return new Set(t.rules);
  const a = [n].concat(uy(t));
  for (const o of a)
    cy(o, r, e);
...
s(qf, "getAllReachableRules");
function cy(t, e, r) {
  e.add(t.name), xr(t).forEach((n) => {
    if (Ir(n) || r && Ff(n)) {
      const a = n.rule.ref;
      a && !e.has(a.name) && cy(a, e, r);
    }
  });
}
s(cy, "ruleDfs");
function TR(t) {
  ...
  return xr(t).forEach((r) => {
    Yn(r) && (pt(r.type.ref) && e.add(r.type.ref), Gu(r.type.ref) && pt(r.type.ref.$container) && e.add(r.type.ref.$container));
  }), e;
}
s(TR, "getAllRulesUsedForCrossReferences");
function fy(t) {
  if (t.terminal)
    return t.terminal;
  if (t.type.ref) {
...
s(fy, "getCrossReferenceTerminal");
function dy(t) {
  return t.hidden && !Wf(ju(t));
}
s(dy, "isCommentTerminal");
function py(t, e) {
  return !t || !e ? [] : Hf(t, e, t.astNode, !0);
}
s(py, "findNodesForProperty");
function Vf(t, e, r) {
  if (!t || !e)
    return;
  const n = Hf(t, e, t.astNode, !0);
  if (n.length !== 0)
    return r !== void 0 ? r = Math.max(0, Math.min(r, n.length - 1)) : r = 0, n[r];
}
s(Vf, "findNodeForProperty");
function Hf(t, e, r, n) {
  if (!n) {
    const a = Vn(t.grammarSource, Sr);
    if (a && a.feature === e)
      return [t];
  }
  return _r(t) && t.astNode === r ? t.content.flatMap((a) => Hf(a, e, r, !1)) : [];
}
s(Hf, "findNodesForPropertyInternal");
function $R(t, e) {
  return t ? Yf(t, e, t == null ? void 0 : t.astNode) : [];
}
s($R, "findNodesForKeyword");
function my(t, e, r) {
  if (!t)
    return;
  const n = Yf(t, e, t == null ? void 0 : t.astNode);
  if (n.length !== 0)
    return r !== void 0 ? r = Math.max(0, Math.min(r, n.length - 1)) : r = 0, n[r];
}
s(my, "findNodeForKeyword");
function Yf(t, e, r) {
  if (t.astNode !== r)
    return [];
  if (wr(t.grammarSource) && t.grammarSource.value === e)
    return [t];
  const n = Jo(t).iterator();
  let a;
  const i = [];
  do
    if (a = n.next(), !a.done) {
...
s(Yf, "findNodesForKeywordInternal");
function hy(t) {
  var r;
  const e = t.astNode;
  for (; e === ((r = t.container) == null ? void 0 : r.astNode); ) {
    const n = Vn(t.grammarSource, Sr);
    if (n)
      return n;
    t = t.container;
  }
...
function Xf(t) {
  let e = t;
  return Gu(e) && (Yr(e.$container) ? e = e.$container.$container : Hn(e.$container) ? e = e.$container : tn(e.$container)), yy(t, e, /* @__PURE__ */ new Map());
}
s(Xf, "findNameAssignment");
function yy(t, e, r) {
  var a;
  function n(i, o) {
    let u;
    return Vn(i, Sr) || (u = yy(o, o, r)), r.set(t, u), u;
  }
  if (s(n, "go"), r.has(t))
    return r.get(t);
  r.set(t, void 0);
  for (const i of xr(e)) {
    if (Sr(i) && i.feature.toLowerCase() === "name")
      return r.set(t, i), i;
    if (Ir(i) && pt(i.rule.ref))
      return n(i, i.rule.ref);
    if (Gf(i) && ((a = i.typeRef) != null && a.ref))
      return n(i, i.typeRef.ref);
  }
}
s(yy, "findNameAssignmentInternal");
function gy(t) {
  const e = t.$container;
  if (Xn(e)) {
...
s(gy, "getActionAtElement");
function RR(t, e) {
  return t === "?" || t === "*" || Xn(e) && !!e.guardCondition;
}
s(RR, "isOptionalCardinality");
function AR(t) {
  return t === "*" || t === "+";
}
s(AR, "isArrayCardinality");
function ER(t) {
  return t === "+=";
}
s(ER, "isArrayOperator");
function Fu(t) {
  return vy(t, /* @__PURE__ */ new Set());
}
s(Fu, "isDataTypeRule");
function vy(t, e) {
  if (e.has(t))
  ...
  for (const r of xr(t))
    if (Ir(r)) {
      if (!r.rule.ref || pt(r.rule.ref) && !vy(r.rule.ref, e) || Xo(r.rule.ref))
        return !1;
    } else {
      if (Sr(r))
        return !1;
...
s(vy, "isDataTypeRuleInternal");
function CR(t) {
  return cf(t.type, /* @__PURE__ */ new Set());
}
s(CR, "isDataType");
function cf(t, e) {
  if (e.has(t))
  ...
  if (Gf(t)) {
    ...
    if (t.typeRef !== void 0) {
      ...
      return zf(r) ? cf(r.type, e) : !1;
    } else
      return !1;
  } else
    return !1;
}
s(cf, "isDataTypeInternal");
function zu(t) {
  if (!zt(t)) {
    if (t.inferredType)
...
s(zu, "getExplicitRuleType");
function jn(t) {
  if (Hn(t))
    return pt(t) && Fu(t) ? t.name : zu(t) ?? t.name;
  if (Dh(t) || zf(t) || jh(t))
    return t.name;
  if (Yr(t)) {
    const e = Ty(t);
...
function Ty(t) {
  ...
  if ((e = t.type) != null && e.ref)
    return jn(t.type.ref);
}
s(Ty, "getActionType");
function bR(t) {
  var e;
  return zt(t) ? ((e = t.type) == null ? void 0 : e.name) ?? "string" : pt(t) && Fu(t) ? t.name : zu(t) ?? t.name;
}
s(bR, "getRuleTypeName");
function $y(t) {
  var e;
  return zt(t) ? ((e = t.type) == null ? void 0 : e.name) ?? "string" : zu(t) ?? t.name;
}
s($y, "getRuleType");
function ju(t) {
  const e = {
    ...
    i: !1,
    u: !1
  }, r = Jn(t.definition, e), n = Object.entries(e).filter(([, a]) => a).map(([a]) => a).join("");
...
function Jn(t, e) {
  ...
  if (Ff(t)) {
    ...
    if (Wh(t))
      return wR(t);
    if (zh(t)) {
      const n = t.regex.lastIndexOf("/"), a = t.regex.substring(1, n), i = t.regex.substring(n + 1);
      return e && (e.i = i.includes("i"), e.s = i.includes("s"), e.u = i.includes("u")), fr(a, {
        cardinality: t.cardinality,
        lookahead: t.lookahead,
        parenthesized: t.parenthesized,
        wrap: !1
...
s(Jn, "abstractElementToRegex");
function _R(t) {
  return fr(t.elements.map((e) => Jn(e)).join("|"), {
    cardinality: t.cardinality,
    lookahead: t.lookahead,
    parenthesized: t.parenthesized,
    wrap: !1
...
s(_R, "terminalAlternativesToRegex");
function SR(t) {
  return fr(t.elements.map((e) => Jn(e)).join(""), {
    cardinality: t.cardinality,
    lookahead: t.lookahead,
...
s(SR, "terminalGroupToRegex");
function wR(t) {
  return fr(`${Ry}*?${Jn(t.terminal)}`, {
    cardinality: t.cardinality,
    lookahead: t.lookahead,
    parenthesized: t.parenthesized
  });
}
s(wR, "untilTokenToRegex");
function IR(t) {
  return fr(`(?!${Jn(t.terminal)})${Ry}*?`, {
    cardinality: t.cardinality,
    lookahead: t.lookahead,
    parenthesized: t.parenthesized
  });
}
s(IR, "negateTokenToRegex");
function NR(t) {
  return t.right ? fr(`[${Ic(t.left)}-${Ic(t.right)}]`, {
    cardinality: t.cardinality,
    lookahead: t.lookahead,
    parenthesized: t.parenthesized,
    wrap: !1
...
function Ay(t) {
  ...
  for (const n of r.rules)
    zt(n) && dy(n) && iy(ju(n)) && e.push(n.name);
  return {
    multilineCommentRules: e,
    nameRegexp: Jh
  };
}
s(Ay, "createGrammarConfig");
var eO = typeof global == "object" && global && global.Object === Object && global, PR = eO, tO = typeof self == "object" && self && self.Object === Object && self, rO = PR || tO || Function("return this")(), pr = rO, nO = pr.Symbol, Gt = nO, kR = Object.prototype, aO = kR.hasOwnProperty, iO = kR.toString, kl = Gt ? Gt.toStringTag : void 0;
function OR(t) {
  var e = aO.call(t, kl), r = t[kl];
  try {
    t[kl] = void 0;
    var n = !0;
  } catch {
...
s(OR, "getRawTag");
var sO = OR, oO = Object.prototype, lO = oO.toString;
function LR(t) {
  return lO.call(t);
}
s(LR, "objectToString");
var uO = LR, cO = "[object Null]", fO = "[object Undefined]", ov = Gt ? Gt.toStringTag : void 0;
function DR(t) {
  return t == null ? t === void 0 ? fO : cO : ov && ov in Object(t) ? sO(t) : uO(t);
}
s(DR, "baseGetTag");
var rn = DR;
function xR(t) {
...
s(xR, "isObjectLike");
var Yt = xR, dO = "[object Symbol]";
function MR(t) {
  return typeof t == "symbol" || Yt(t) && rn(t) == dO;
}
s(MR, "isSymbol");
var Jf = MR;
function GR(t, e) {
...
s(GR, "arrayMap");
var Bu = GR, pO = Array.isArray, se = pO, lv = Gt ? Gt.prototype : void 0, uv = lv ? lv.toString : void 0;
function Ey(t) {
  if (typeof t == "string")
    return t;
  if (se(t))
...
s(FR, "trimmedEndIndex");
var yO = FR, gO = /^\s+/;
function zR(t) {
  return t && t.slice(0, yO(t) + 1).replace(gO, "");
}
s(zR, "baseTrim");
var vO = zR;
function jR(t) {
...
s(jR, "isObject");
var Ft = jR, cv = NaN, TO = /^[-+]0x[0-9a-f]+$/i, $O = /^0b[01]+$/i, RO = /^0o[0-7]+$/i, AO = parseInt;
function BR(t) {
  if (typeof t == "number")
    return t;
  if (Jf(t))
  ...
  t = vO(t);
  var r = $O.test(t);
  return r || RO.test(t) ? AO(t.slice(2), r ? 2 : 8) : TO.test(t) ? cv : +t;
}
s(BR, "toNumber");
var EO = BR, fv = 1 / 0, CO = 17976931348623157e292;
function UR(t) {
  if (!t)
    return t === 0 ? t : 0;
  if (t = EO(t), t === fv || t === -fv) {
...
s(WR, "identity");
var Ku = WR, _O = "[object AsyncFunction]", SO = "[object Function]", wO = "[object GeneratorFunction]", IO = "[object Proxy]";
function qR(t) {
  if (!Ft(t))
    return !1;
  var e = rn(t);
  return e == SO || e == wO || e == _O || e == IO;
}
s(qR, "isFunction");
var Mr = qR, NO = pr["__core-js_shared__"], Ud = NO, dv = function() {
...
s(VR, "isMasked");
var PO = VR, kO = Function.prototype, OO = kO.toString;
function HR(t) {
  if (t != null) {
    try {
      return OO.call(t);
...
s(HR, "toSource");
var Zn = HR, LO = /[\\^$.*+?()[\]{}|]/g, DO = /^\[object .+?Constructor\]$/, xO = Function.prototype, MO = Object.prototype, GO = xO.toString, FO = MO.hasOwnProperty, zO = RegExp(
  "^" + GO.call(FO).replace(LO, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function YR(t) {
  if (!Ft(t) || PO(t))
    return !1;
...
s(JR, "getNative");
var Qn = JR, UO = Qn(pr, "WeakMap"), Am = UO, pv = Object.create, KO = /* @__PURE__ */ function() {
  function t() {
  }
...
s(eA, "copyArray");
var VO = eA, HO = 800, YO = 16, XO = Date.now;
function tA(t) {
  var e = 0, r = 0;
  return function() {
    var n = XO(), a = YO - (n - r);
...
s(rA, "constant");
var ZO = rA, QO = function() {
  try {
    var t = Qn(Object, "defineProperty");
    return t({}, "", {}), t;
  } catch {
  }
}(), ff = QO, e0 = ff ? function(t, e) {
...
s(cA, "arrayIncludes");
var fA = cA, s0 = 9007199254740991, o0 = /^(?:0|[1-9]\d*)$/;
function dA(t, e) {
  var r = typeof t;
  return e = e ?? s0, !!e && (r == "number" || r != "symbol" && o0.test(t)) && t > -1 && t % 1 == 0 && t < e;
}
s(dA, "isIndex");
var Zf = dA;
function pA(t, e, r) {
  e == "__proto__" && ff ? ff(t, e, {
    configurable: !0,
    enumerable: !0,
    value: r,
    writable: !0
...
s(pA, "baseAssignValue");
var by = pA;
function mA(t, e) {
  return t === e || t !== t && e !== e;
}
s(mA, "eq");
var Wu = mA, l0 = Object.prototype, u0 = l0.hasOwnProperty;
function hA(t, e, r) {
  var n = t[e];
  (!(u0.call(t, e) && Wu(n, r)) || r === void 0 && !(e in t)) && by(t, e, r);
}
s(hA, "assignValue");
var Qf = hA;
function yA(t, e, r, n) {
  ...
  for (var i = -1, o = e.length; ++i < o; ) {
    ...
    l === void 0 && (l = t[u]), a ? by(r, u, l) : Qf(r, u, l);
  }
  return r;
}
s(yA, "copyObject");
var qu = yA, mv = Math.max;
function gA(t, e, r) {
  return e = mv(e === void 0 ? t.length - 1 : e, 0), function() {
    for (var n = arguments, a = -1, i = mv(n.length - e, 0), o = Array(i); ++a < i; )
      o[a] = n[e + a];
    a = -1;
...
var c0 = gA;
function vA(t, e) {
  return n0(c0(t, e, Ku), t + "");
}
s(vA, "baseRest");
var _y = vA, f0 = 9007199254740991;
function TA(t) {
  return typeof t == "number" && t > -1 && t % 1 == 0 && t <= f0;
}
s(TA, "isLength");
var Sy = TA;
function $A(t) {
  return t != null && Sy(t.length) && !Mr(t);
}
s($A, "isArrayLike");
var mr = $A;
function RA(t, e, r) {
  if (!Ft(r))
    return !1;
  var n = typeof e;
  return (n == "number" ? mr(r) && Zf(e, r.length) : n == "string" && e in r) ? Wu(r[e], t) : !1;
}
s(RA, "isIterateeCall");
var ed = RA;
function AA(t) {
  return _y(function(e, r) {
    var n = -1, a = r.length, i = a > 1 ? r[a - 1] : void 0, o = a > 2 ? r[2] : void 0;
    for (i = t.length > 3 && typeof i == "function" ? (a--, i) : void 0, o && ed(r[0], r[1], o) && (i = a < 3 ? void 0 : i, a = 1), e = Object(e); ++n < a; ) {
      var u = r[n];
      u && t(e, u, n, i);
    }
    return e;
...
s(AA, "createAssigner");
var d0 = AA, p0 = Object.prototype;
function EA(t) {
  var e = t && t.constructor, r = typeof e == "function" && e.prototype || p0;
  return t === r;
}
s(EA, "isPrototype");
var Vu = EA;
...
s(CA, "baseTimes");
var m0 = CA, h0 = "[object Arguments]";
function bA(t) {
  return Yt(t) && rn(t) == h0;
}
s(bA, "baseIsArguments");
var hv = bA, _A = Object.prototype, y0 = _A.hasOwnProperty, g0 = _A.propertyIsEnumerable, v0 = hv(/* @__PURE__ */ function() {
  return arguments;
}()) ? hv : function(t) {
  return Yt(t) && y0.call(t, "callee") && !g0.call(t, "callee");
}, td = v0;
function SA() {
  return !1;
}
s(SA, "stubFalse");
var T0 = SA, wA = typeof exports == "object" && exports && !exports.nodeType && exports, yv = wA && typeof module == "object" && module && !module.nodeType && module, $0 = yv && yv.exports === wA, gv = $0 ? pr.Buffer : void 0, R0 = gv ? gv.isBuffer : void 0, A0 = R0 || T0, $u = A0, E0 = "[object Arguments]", C0 = "[object Array]", b0 = "[object Boolean]", _0 = "[object Date]", S0 = "[object Error]", w0 = "[object Function]", I0 = "[object Map]", N0 = "[object Number]", P0 = "[object Object]", k0 = "[object RegExp]", O0 = "[object Set]", L0 = "[object String]", D0 = "[object WeakMap]", x0 = "[object ArrayBuffer]", M0 = "[object DataView]", G0 = "[object Float32Array]", F0 = "[object Float64Array]", z0 = "[object Int8Array]", j0 = "[object Int16Array]", B0 = "[object Int32Array]", U0 = "[object Uint8Array]", K0 = "[object Uint8ClampedArray]", W0 = "[object Uint16Array]", q0 = "[object Uint32Array]", _e = {};
_e[G0] = _e[F0] = _e[z0] = _e[j0] = _e[B0] = _e[U0] = _e[K0] = _e[W0] = _e[q0] = !0;
_e[E0] = _e[C0] = _e[x0] = _e[b0] = _e[M0] = _e[_0] = _e[S0] = _e[w0] = _e[I0] = _e[N0] = _e[P0] = _e[k0] = _e[O0] = _e[L0] = _e[D0] = !1;
function IA(t) {
  return Yt(t) && Sy(t.length) && !!_e[rn(t)];
}
s(IA, "baseIsTypedArray");
var V0 = IA;
function NA(t) {
  return function(e) {
    return t(e);
...
s(NA, "baseUnary");
var Hu = NA, PA = typeof exports == "object" && exports && !exports.nodeType && exports, cu = PA && typeof module == "object" && module && !module.nodeType && module, H0 = cu && cu.exports === PA, Kd = H0 && PR.process, Y0 = function() {
  try {
    var t = cu && cu.require && cu.require("util").types;
    return t || Kd && Kd.binding && Kd.binding("util");
  } catch {
  }
}(), Xr = Y0, vv = Xr && Xr.isTypedArray, X0 = vv ? Hu(vv) : V0, wy = X0, J0 = Object.prototype, Z0 = J0.hasOwnProperty;
function kA(t, e) {
  var r = se(t), n = !r && td(t), a = !r && !n && $u(t), i = !r && !n && !a && wy(t), o = r || n || a || i, u = o ? m0(t.length, String) : [], l = u.length;
  for (var c in t)
    (e || Z0.call(t, c)) && !(o && // Safari 9 has enumerable `arguments.length` in strict mode.
...
s(LA, "overArg");
var DA = LA, Q0 = DA(Object.keys, Object), eL = Q0, tL = Object.prototype, rL = tL.hasOwnProperty;
function xA(t) {
  if (!Vu(t))
    return eL(t);
  var e = [];
  for (var r in Object(t))
    rL.call(t, r) && r != "constructor" && e.push(r);
  return e;
}
s(xA, "baseKeys");
var MA = xA;
function GA(t) {
  return mr(t) ? OA(t) : MA(t);
}
s(GA, "keys");
var It = GA, nL = Object.prototype, aL = nL.hasOwnProperty, iL = d0(function(t, e) {
  if (Vu(e) || mr(e)) {
    qu(e, It(e), t);
    return;
  }
  for (var r in e)
    aL.call(e, r) && Qf(t, r, e[r]);
}), Nt = iL;
function FA(t) {
  var e = [];
  if (t != null)
...
s(FA, "nativeKeysIn");
var sL = FA, oL = Object.prototype, lL = oL.hasOwnProperty;
function zA(t) {
  if (!Ft(t))
    return sL(t);
  var e = Vu(t), r = [];
  for (var n in t)
    n == "constructor" && (e || !lL.call(t, n)) || r.push(n);
  return r;
}
s(zA, "baseKeysIn");
var uL = zA;
function jA(t) {
  return mr(t) ? OA(t, !0) : uL(t);
}
s(jA, "keysIn");
var rd = jA, cL = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, fL = /^\w*$/;
function BA(t, e) {
  if (se(t))
    return !1;
  var r = typeof t;
  return r == "number" || r == "symbol" || r == "boolean" || t == null || Jf(t) ? !0 : fL.test(t) || !cL.test(t) || e != null && t in Object(e);
}
s(BA, "isKey");
var Iy = BA, dL = Qn(Object, "create"), Ru = dL;
function UA() {
...
s(KA, "hashDelete");
var mL = KA, hL = "__lodash_hash_undefined__", yL = Object.prototype, gL = yL.hasOwnProperty;
function WA(t) {
  var e = this.__data__;
  if (Ru) {
    var r = e[t];
...
s(WA, "hashGet");
var vL = WA, TL = Object.prototype, $L = TL.hasOwnProperty;
function qA(t) {
  var e = this.__data__;
  return Ru ? e[t] !== void 0 : $L.call(e, t);
}
s(qA, "hashHas");
var RL = qA, AL = "__lodash_hash_undefined__";
function VA(t, e) {
  var r = this.__data__;
  return this.size += this.has(t) ? 0 : 1, r[t] = Ru && e === void 0 ? AL : e, this;
}
s(VA, "hashSet");
var EL = VA;
function ea(t) {
...
s(ea, "Hash");
ea.prototype.clear = pL;
ea.prototype.delete = mL;
ea.prototype.get = vL;
ea.prototype.has = RL;
ea.prototype.set = EL;
var Tv = ea;
...
s(YA, "assocIndexOf");
var nd = YA, bL = Array.prototype, _L = bL.splice;
function XA(t) {
  var e = this.__data__, r = nd(e, t);
  if (r < 0)
    return !1;
  var n = e.length - 1;
  return r == n ? e.pop() : _L.call(e, r, 1), --this.size, !0;
}
s(XA, "listCacheDelete");
var SL = XA;
function JA(t) {
  var e = this.__data__, r = nd(e, t);
...
s(ta, "ListCache");
ta.prototype.clear = CL;
ta.prototype.delete = SL;
ta.prototype.get = wL;
ta.prototype.has = IL;
ta.prototype.set = NL;
var ad = ta, PL = Qn(pr, "Map"), Au = PL;
function eE() {
...
function rE(t, e) {
  var r = t.__data__;
  return OL(e) ? r[typeof e == "string" ? "string" : "hash"] : r.map;
}
s(rE, "getMapData");
var id = rE;
function nE(t) {
  var e = id(this, t).delete(t);
  return this.size -= e ? 1 : 0, e;
}
s(nE, "mapCacheDelete");
var LL = nE;
function aE(t) {
  return id(this, t).get(t);
}
s(aE, "mapCacheGet");
var DL = aE;
function iE(t) {
...
s(ra, "MapCache");
ra.prototype.clear = kL;
ra.prototype.delete = LL;
ra.prototype.get = DL;
ra.prototype.has = xL;
ra.prototype.set = ML;
var sd = ra, GL = "Expected a function";
function od(t, e) {
  ...
  return r.cache = new (od.Cache || sd)(), r;
}
s(od, "memoize");
od.Cache = sd;
var FL = od, zL = 500;
...
s(oE, "memoizeCapped");
var jL = oE, BL = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, UL = /\\(\\)?/g, KL = jL(function(t) {
  var e = [];
  return t.charCodeAt(0) === 46 && e.push(""), t.replace(BL, function(r, n, a, i) {
    e.push(a ? i.replace(UL, "$1") : n || r);
  }), e;
}), WL = KL;
function lE(t) {
  return t == null ? "" : mO(t);
...
var qL = lE;
function uE(t, e) {
  return se(t) ? t : Iy(t, e) ? [t] : WL(qL(t));
}
s(uE, "castPath");
var ld = uE;
function cE(t) {
  if (typeof t == "string" || Jf(t))
    return t;
  var e = t + "";
  return e == "0" && 1 / t == -1 / 0 ? "-0" : e;
}
...
s(pE, "arrayPush");
var Py = pE, $v = Gt ? Gt.isConcatSpreadable : void 0;
function mE(t) {
  return se(t) || td(t) || !!($v && t && t[$v]);
}
s(mE, "isFlattenable");
var HL = mE;
function ky(t, e, r, n, a) {
  var i = -1, o = t.length;
  for (r || (r = HL), a || (a = []); ++i < o; ) {
    var u = t[i];
    e > 0 && r(u) ? e > 1 ? ky(u, e - 1, r, n, a) : Py(a, u) : n || (a[a.length] = u);
  }
  return a;
}
s(ky, "baseFlatten");
...
s(hE, "flatten");
var Vt = hE, YL = DA(Object.getPrototypeOf, Object), yE = YL;
function gE(t, e, r) {
  var n = -1, a = t.length;
...
var rD = CE;
function na(t) {
  var e = this.__data__ = new ad(t);
  this.size = e.size;
}
s(na, "Stack");
na.prototype.clear = JL;
na.prototype.delete = ZL;
na.prototype.get = QL;
na.prototype.has = eD;
na.prototype.set = rD;
var fu = na;
function bE(t, e) {
  return t && qu(e, It(e), t);
}
s(bE, "baseAssign");
var nD = bE;
function _E(t, e) {
  return t && qu(e, rd(e), t);
}
s(_E, "baseAssignIn");
var aD = _E, SE = typeof exports == "object" && exports && !exports.nodeType && exports, Rv = SE && typeof module == "object" && module && !module.nodeType && module, iD = Rv && Rv.exports === SE, Av = iD ? pr.Buffer : void 0, Ev = Av ? Av.allocUnsafe : void 0;
function wE(t, e) {
  if (e)
    return t.slice();
...
s(NE, "stubArray");
var PE = NE, oD = Object.prototype, lD = oD.propertyIsEnumerable, Cv = Object.getOwnPropertySymbols, uD = Cv ? function(t) {
  return t == null ? [] : (t = Object(t), Ly(Cv(t), function(e) {
    return lD.call(t, e);
  }));
} : PE, Dy = uD;
function kE(t, e) {
...
s(kE, "copySymbols");
var cD = kE, fD = Object.getOwnPropertySymbols, dD = fD ? function(t) {
  for (var e = []; t; )
    Py(e, Dy(t)), t = yE(t);
  return e;
} : PE, OE = dD;
...
s(GE, "getAllKeysIn");
var FE = GE, mD = Qn(pr, "DataView"), Cm = mD, hD = Qn(pr, "Promise"), bm = hD, yD = Qn(pr, "Set"), Ya = yD, bv = "[object Map]", gD = "[object Object]", _v = "[object Promise]", Sv = "[object Set]", wv = "[object WeakMap]", Iv = "[object DataView]", vD = Zn(Cm), TD = Zn(Au), $D = Zn(bm), RD = Zn(Ya), AD = Zn(Am), hn = rn;
(Cm && hn(new Cm(new ArrayBuffer(1))) != Iv || Au && hn(new Au()) != bv || bm && hn(bm.resolve()) != _v || Ya && hn(new Ya()) != Sv || Am && hn(new Am()) != wv) && (hn = /* @__PURE__ */ s(function(t) {
  var e = rn(t), r = e == gD ? t.constructor : void 0, n = r ? Zn(r) : "";
  if (n)
    switch (n) {
      case vD:
        return Iv;
...
var Qo = hn, ED = Object.prototype, CD = ED.hasOwnProperty;
function zE(t) {
  var e = t.length, r = new t.constructor(e);
  return e && typeof t[0] == "string" && CD.call(t, "index") && (r.index = t.index, r.input = t.input), r;
}
s(zE, "initCloneArray");
var bD = zE, _D = pr.Uint8Array, df = _D;
function jE(t) {
  var e = new t.constructor(t.byteLength);
  return new df(e).set(new df(t)), e;
}
s(jE, "cloneArrayBuffer");
var xy = jE;
function BE(t, e) {
  var r = e ? xy(t.buffer) : t.buffer;
...
s(UE, "cloneRegExp");
var ID = UE, Nv = Gt ? Gt.prototype : void 0, Pv = Nv ? Nv.valueOf : void 0;
function KE(t) {
  return Pv ? Object(Pv.call(t)) : {};
}
s(KE, "cloneSymbol");
var ND = KE;
function WE(t, e) {
...
s(WE, "cloneTypedArray");
var PD = WE, kD = "[object Boolean]", OD = "[object Date]", LD = "[object Map]", DD = "[object Number]", xD = "[object RegExp]", MD = "[object Set]", GD = "[object String]", FD = "[object Symbol]", zD = "[object ArrayBuffer]", jD = "[object DataView]", BD = "[object Float32Array]", UD = "[object Float64Array]", KD = "[object Int8Array]", WD = "[object Int16Array]", qD = "[object Int32Array]", VD = "[object Uint8Array]", HD = "[object Uint8ClampedArray]", YD = "[object Uint16Array]", XD = "[object Uint32Array]";
function qE(t, e, r) {
  var n = t.constructor;
  switch (e) {
    case zD:
...
var JD = qE;
function VE(t) {
  return typeof t.constructor == "function" && !Vu(t) ? WO(yE(t)) : {};
}
s(VE, "initCloneObject");
var ZD = VE, QD = "[object Map]";
function HE(t) {
  return Yt(t) && Qo(t) == QD;
}
s(HE, "baseIsMap");
var ex = HE, kv = Xr && Xr.isMap, tx = kv ? Hu(kv) : ex, rx = tx, nx = "[object Set]";
function YE(t) {
  return Yt(t) && Qo(t) == nx;
}
s(YE, "baseIsSet");
var ax = YE, Ov = Xr && Xr.isSet, ix = Ov ? Hu(Ov) : ax, sx = ix, ox = 1, lx = 2, ux = 4, XE = "[object Arguments]", cx = "[object Array]", fx = "[object Boolean]", dx = "[object Date]", px = "[object Error]", JE = "[object Function]", mx = "[object GeneratorFunction]", hx = "[object Map]", yx = "[object Number]", ZE = "[object Object]", gx = "[object RegExp]", vx = "[object Set]", Tx = "[object String]", $x = "[object Symbol]", Rx = "[object WeakMap]", Ax = "[object ArrayBuffer]", Ex = "[object DataView]", Cx = "[object Float32Array]", bx = "[object Float64Array]", _x = "[object Int8Array]", Sx = "[object Int16Array]", wx = "[object Int32Array]", Ix = "[object Uint8Array]", Nx = "[object Uint8ClampedArray]", Px = "[object Uint16Array]", kx = "[object Uint32Array]", $e = {};
$e[XE] = $e[cx] = $e[Ax] = $e[Ex] = $e[fx] = $e[dx] = $e[Cx] = $e[bx] = $e[_x] = $e[Sx] = $e[wx] = $e[hx] = $e[yx] = $e[ZE] = $e[gx] = $e[vx] = $e[Tx] = $e[$x] = $e[Ix] = $e[Nx] = $e[Px] = $e[kx] = !0;
$e[px] = $e[JE] = $e[Rx] = !1;
function du(t, e, r, n, a, i) {
  var o, u = e & ox, l = e & lx, c = e & ux;
  ...
  if (f) {
    ...
    var d = Qo(t), p = d == JE || d == mx;
    if ($u(t))
      return sD(t, u);
    if (d == ZE || d == XE || p && !a) {
      if (o = l || p ? {} : ZD(t), !u)
        return l ? pD(t, aD(o, t)) : cD(t, nD(o, t));
    } else {
      if (!$e[d])
        return a ? t : {};
      o = JD(t, d, u);
  ...
  if (h)
    return h;
  i.set(t, o), sx(t) ? t.forEach(function(E) {
    o.add(du(E, e, r, E, t, i));
  }) : rx(t) && t.forEach(function(E, T) {
    o.set(T, du(E, e, r, T, t, i));
  });
  var y = c ? l ? FE : Em : l ? rd : It, v = f ? void 0 : y(t);
  return aA(v || t, function(E, T) {
    v && (T = E, E = t[T]), Qf(o, T, du(E, e, r, T, t, i));
  }), o;
}
s(du, "baseClone");
var Ox = du, Lx = 4;
...
s(eC, "compact");
var Xu = eC, Dx = "__lodash_hash_undefined__";
function tC(t) {
...
function Eu(t) {
  var e = -1, r = t == null ? 0 : t.length;
  for (this.__data__ = new sd(); ++e < r; )
    this.add(t[e]);
}
s(Eu, "SetCache");
Eu.prototype.add = Eu.prototype.push = xx;
Eu.prototype.has = Mx;
var My = Eu;
function nC(t, e) {
...
s(iC, "cacheHas");
var Gy = iC, Gx = 1, Fx = 2;
function sC(t, e, r, n, a, i) {
  var o = r & Gx, u = t.length, l = e.length;
  if (u != l && !(o && l > u))
    return !1;
  var c = i.get(t), f = i.get(e);
  if (c && f)
    return c == e && f == t;
  var d = -1, p = !0, h = r & Fx ? new My() : void 0;
  for (i.set(t, e), i.set(e, t); ++d < u; ) {
    var y = t[d], v = e[d];
    if (n)
      var E = o ? n(v, y, d, e, t, i) : n(y, v, d, t, e, i);
    if (E !== void 0) {
      if (E)
        continue;
      p = !1;
    ...
    if (h) {
      if (!aC(e, function(T, w) {
        if (!Gy(h, w) && (y === T || a(y, T, r, n, i)))
          return h.push(w);
      })) {
        p = !1;
        break;
...
s(uC, "setToArray");
var Fy = uC, jx = 1, Bx = 2, Ux = "[object Boolean]", Kx = "[object Date]", Wx = "[object Error]", qx = "[object Map]", Vx = "[object Number]", Hx = "[object RegExp]", Yx = "[object Set]", Xx = "[object String]", Jx = "[object Symbol]", Zx = "[object ArrayBuffer]", Qx = "[object DataView]", Lv = Gt ? Gt.prototype : void 0, Wd = Lv ? Lv.valueOf : void 0;
function cC(t, e, r, n, a, i, o) {
  switch (r) {
    case Qx:
    ...
    case Zx:
      return !(t.byteLength != e.byteLength || !i(new df(t), new df(e)));
    case Ux:
    case Kx:
    case Vx:
      return Wu(+t, +e);
    ...
    case Yx:
      var l = n & jx;
      if (u || (u = Fy), t.size != e.size && !l)
        return !1;
      var c = o.get(t);
      if (c)
        return c == e;
      n |= Bx, o.set(t, e);
      var f = oC(u(t), u(e), n, a, i, o);
      return o.delete(t), f;
    case Jx:
      if (Wd)
        return Wd.call(t) == Wd.call(e);
  }
  return !1;
}
s(cC, "equalByTag");
var eM = cC, tM = 1, rM = Object.prototype, nM = rM.hasOwnProperty;
function fC(t, e, r, n, a, i) {
  var o = r & tM, u = Em(t), l = u.length, c = Em(e), f = c.length;
  if (l != f && !o)
    return !1;
  for (var d = l; d--; ) {
    var p = u[d];
    if (!(o ? p in e : nM.call(e, p)))
      return !1;
  }
  var h = i.get(t), y = i.get(e);
  if (h && y)
    return h == e && y == t;
  var v = !0;
  i.set(t, e), i.set(e, t);
  for (var E = o; ++d < l; ) {
    ...
    var T = t[p], w = e[p];
    if (n)
      var b = o ? n(w, T, p, e, t, i) : n(T, w, p, t, e, i);
    if (!(b === void 0 ? T === w || a(T, w, r, n, i) : b)) {
      v = !1;
      break;
    }
    E || (E = p == "constructor");
  ...
  if (v && !E) {
    ...
    N != B && "constructor" in t && "constructor" in e && !(typeof N == "function" && N instanceof N && typeof B == "function" && B instanceof B) && (v = !1);
  }
  return i.delete(t), i.delete(e), v;
}
s(fC, "equalObjects");
var aM = fC, iM = 1, Dv = "[object Arguments]", xv = "[object Array]", ac = "[object Object]", sM = Object.prototype, Mv = sM.hasOwnProperty;
function dC(t, e, r, n, a, i) {
  var o = se(t), u = se(e), l = o ? xv : Qo(t), c = u ? xv : Qo(e);
  l = l == Dv ? ac : l, c = c == Dv ? ac : c;
  var f = l == ac, d = c == ac, p = l == c;
  if (p && $u(t)) {
    if (!$u(e))
      return !1;
    o = !0, f = !1;
  ...
  if (p && !f)
    return i || (i = new fu()), o || wy(t) ? oC(t, e, r, n, a, i) : eM(t, e, l, r, n, a, i);
  if (!(r & iM)) {
    var h = f && Mv.call(t, "__wrapped__"), y = d && Mv.call(e, "__wrapped__");
    if (h || y) {
      var v = h ? t.value() : t, E = y ? e.value() : e;
      return i || (i = new fu()), a(v, E, r, n, i);
    }
  }
  return p ? (i || (i = new fu()), aM(t, e, r, n, a, i)) : !1;
}
s(dC, "baseIsEqualDeep");
var oM = dC;
function zy(t, e, r, n, a) {
  return t === e ? !0 : t == null || e == null || !Yt(t) && !Yt(e) ? t !== t && e !== e : oM(t, e, r, n, zy, a);
}
s(zy, "baseIsEqual");
var pC = zy, lM = 1, uM = 2;
function mC(t, e, r, n) {
  ...
  for (; ++a < i; ) {
    ...
    if (o && u[2]) {
      ...
      if (n)
        var p = n(c, f, l, t, e, d);
      if (!(p === void 0 ? pC(f, c, lM | uM, n, d) : p))
        return !1;
    }
  }
  return !0;
...
s(vC, "matchesStrictComparable");
var TC = vC;
function $C(t) {
  var e = fM(t);
  return e.length == 1 && e[0][2] ? TC(e[0][0], e[0][1]) : function(r) {
    return r === t || cM(r, t, e);
  };
}
s($C, "baseMatches");
...
function AC(t, e, r) {
  ...
  return i || ++n != a ? i : (a = t == null ? 0 : t.length, !!a && Sy(a) && Zf(o, a) && (se(t) || td(t)));
}
s(AC, "hasPath");
var EC = AC;
function CC(t, e) {
  return t != null && EC(t, e, pM);
}
s(CC, "hasIn");
var mM = CC, hM = 1, yM = 2;
function bC(t, e) {
  return Iy(t) && yC(e) ? TC(Yu(t), e) : function(r) {
    var n = VL(r, t);
    return n === void 0 && n === e ? mM(r, t) : pC(e, n, hM | yM);
  };
}
s(bC, "baseMatchesProperty");
var gM = bC;
function _C(t) {
  return function(e) {
...
s(SC, "basePropertyDeep");
var TM = SC;
function wC(t) {
  return Iy(t) ? vM(Yu(t)) : TM(t);
}
s(wC, "property");
var $M = wC;
function IC(t) {
  return typeof t == "function" ? t : t == null ? Ku : typeof t == "object" ? se(t) ? gM(t[0], t[1]) : dM(t) : $M(t);
}
s(IC, "baseIteratee");
var hr = IC;
function NC(t, e, r, n) {
...
s(OC, "createBaseEach");
var _M = OC, SM = _M(bM), aa = SM;
function LC(t, e, r, n) {
  return aa(t, function(a, i, o) {
    e(n, a, r(a), o);
  }), n;
}
s(LC, "baseAggregator");
...
function DC(t, e) {
  return function(r, n) {
    var a = se(r) ? RM : wM, i = e ? e() : {};
    return a(r, t, hr(n), i);
  };
}
s(DC, "createAggregator");
var IM = DC, xC = Object.prototype, NM = xC.hasOwnProperty, PM = _y(function(t, e) {
  t = Object(t);
  var r = -1, n = e.length, a = n > 2 ? e[2] : void 0;
  for (a && ed(e[0], e[1], a) && (n = 1); ++r < n; )
    for (var i = e[r], o = rd(i), u = -1, l = o.length; ++u < l; ) {
      var c = o[u], f = t[c];
      (f === void 0 || Wu(f, xC[c]) && !NM.call(t, c)) && (t[c] = i[c]);
    }
  return t;
}), jy = PM;
function MC(t) {
...
var FC = GC, kM = 200;
function zC(t, e, r, n) {
  var a = -1, i = fA, o = !0, u = t.length, l = [], c = e.length;
  if (!u)
    return l;
  r && (e = Bu(e, Hu(r))), n ? (i = FC, o = !1) : e.length >= kM && (i = Gy, o = !1, e = new My(e));
  e:
    for (; ++a < u; ) {
...
s(zC, "baseDifference");
var OM = zC, LM = _y(function(t, e) {
  return Gv(t) ? OM(t, Oy(e, 1, Gv, !0)) : [];
}), ud = LM;
function jC(t) {
  var e = t == null ? 0 : t.length;
...
function BC(t, e, r) {
  ...
  return n ? (e = r || e === void 0 ? 1 : Uu(e), vE(t, e < 0 ? 0 : e, n)) : [];
}
s(BC, "drop");
var nt = BC;
function UC(t, e, r) {
  var n = t == null ? 0 : t.length;
  return n ? (e = r || e === void 0 ? 1 : Uu(e), e = n - e, vE(t, 0, e < 0 ? 0 : e)) : [];
}
s(UC, "dropRight");
var Cu = UC;
function KC(t) {
  return typeof t == "function" ? t : Ku;
}
s(KC, "castFunction");
var DM = KC;
function WC(t, e) {
...
function HC(t, e, r) {
  var n = se(t) ? xM : MM;
  return r && ed(t, e, r) && (e = void 0), n(t, hr(e));
}
s(HC, "every");
var Ht = HC;
function YC(t, e) {
...
s(ZC, "createFind");
var GM = ZC, FM = Math.max;
function QC(t, e, r) {
  var n = t == null ? 0 : t.length;
  if (!n)
    return -1;
  var a = r == null ? 0 : Uu(r);
  return a < 0 && (a = FM(n + a, 0)), sA(t, hr(e), a);
}
s(QC, "findIndex");
var zM = QC, jM = GM(zM), el = jM;
function eb(t) {
...
s(nb, "flatMap");
var Mt = nb, UM = Object.prototype, KM = UM.hasOwnProperty, WM = IM(function(t, e, r) {
  KM.call(t, r) ? t[r].push(e) : by(t, r, [e]);
}), qM = WM, VM = Object.prototype, HM = VM.hasOwnProperty;
function ab(t, e) {
...
var YM = ab;
function ib(t, e) {
  return t != null && EC(t, e, YM);
}
s(ib, "has");
var K = ib, XM = "[object String]";
function sb(t) {
  return typeof t == "string" || !se(t) && Yt(t) && rn(t) == XM;
}
s(sb, "isString");
var Et = sb;
function ob(t, e) {
  return Bu(e, function(r) {
    return t[r];
  });
}
s(ob, "baseValues");
var JM = ob;
function lb(t) {
  return t == null ? [] : JM(t, It(t));
}
s(lb, "values");
var Ke = lb, ZM = Math.max;
function ub(t, e, r, n) {
  t = mr(t) ? t : Ke(t), r = r && !n ? Uu(r) : 0;
  var a = t.length;
  return r < 0 && (r = ZM(a + r, 0)), Et(t) ? r <= a && t.indexOf(e, r) > -1 : !!a && Cy(t, e, r) > -1;
}
s(ub, "includes");
var gt = ub, QM = Math.max;
function cb(t, e, r) {
  var n = t == null ? 0 : t.length;
  if (!n)
    return -1;
  var a = r == null ? 0 : Uu(r);
  return a < 0 && (a = QM(n + a, 0)), Cy(t, e, a);
}
s(cb, "indexOf");
var Fv = cb, e1 = "[object Map]", t1 = "[object Set]", r1 = Object.prototype, n1 = r1.hasOwnProperty;
function fb(t) {
  if (t == null)
    return !0;
  if (mr(t) && (se(t) || typeof t == "string" || typeof t.splice == "function" || $u(t) || wy(t) || td(t)))
    return !t.length;
  var e = Qo(t);
  if (e == e1 || e == t1)
    return !t.size;
...
s(fb, "isEmpty");
var Ae = fb, a1 = "[object RegExp]";
function db(t) {
  return Yt(t) && rn(t) == a1;
}
s(db, "baseIsRegExp");
var i1 = db, zv = Xr && Xr.isRegExp, s1 = zv ? Hu(zv) : i1, Nr = s1;
function pb(t) {
  return t === void 0;
}
s(pb, "isUndefined");
var Pr = pb, o1 = "Expected a function";
function mb(t) {
...
function hb(t, e, r, n) {
  ...
  for (var a = -1, i = e.length, o = i - 1, u = t; u != null && ++a < i; ) {
    ...
    if (a != o) {
      var f = u[l];
      c = n ? n(f, l, u) : void 0, c === void 0 && (c = Ft(f) ? f : Zf(e[a + 1]) ? [] : {});
    }
    Qf(u, l, c), u = u[l];
  }
  return t;
...
function gb(t, e) {
  if (t == null)
    return {};
  var r = Bu(FE(t), function(n) {
    return [n];
  });
  return e = hr(e), c1(t, r, function(n, a) {
    return e(n, a[0]);
  });
}
s(gb, "pickBy");
...
var f1 = vb;
function Tb(t, e, r) {
  var n = se(t) ? XL : f1, a = arguments.length < 3;
  return n(t, hr(e), r, a, aa);
}
s(Tb, "reduce");
var Pt = Tb;
function $b(t, e) {
...
s(Ab, "some");
var Eb = Ab, p1 = 1 / 0, m1 = Ya && 1 / Fy(new Ya([, -0]))[1] == p1 ? function(t) {
  return new Ya(t);
} : He, h1 = m1, y1 = 200;
function Cb(t, e, r) {
  var n = -1, a = fA, i = t.length, o = !0, u = [], l = u;
  if (r)
    o = !1, a = FC;
  else if (i >= y1) {
    var c = e ? null : h1(t);
...
s(Wy, "toFastProperties");
function _b(t) {
  return Sb(t) ? t.LABEL : t.name;
}
s(_b, "tokenLabel");
function Sb(t) {
...
}, s(ii, "AbstractProduction"), ii), si, mt = (si = class extends yr {
  constructor(e) {
...
}, s(si, "NonTerminal"), si), oi, sl = (oi = class extends yr {
  constructor(e) {
    super(e.definition), this.orgText = "", Nt(this, Jt(e, (r) => r !== void 0));
  }
}, s(oi, "Rule"), oi), li, Ct = (li = class extends yr {
  constructor(e) {
    super(e.definition), this.ignoreAmbiguities = !1, Nt(this, Jt(e, (r) => r !== void 0));
  }
}, s(li, "Alternative"), li), ui, at = (ui = class extends yr {
  constructor(e) {
    super(e.definition), this.idx = 1, Nt(this, Jt(e, (r) => r !== void 0));
  }
}, s(ui, "Option"), ui), ci, kt = (ci = class extends yr {
  constructor(e) {
    super(e.definition), this.idx = 1, Nt(this, Jt(e, (r) => r !== void 0));
  }
}, s(ci, "RepetitionMandatory"), ci), fi, Ot = (fi = class extends yr {
  constructor(e) {
    super(e.definition), this.idx = 1, Nt(this, Jt(e, (r) => r !== void 0));
  }
}, s(fi, "RepetitionMandatoryWithSeparator"), fi), di, xe = (di = class extends yr {
  constructor(e) {
    super(e.definition), this.idx = 1, Nt(this, Jt(e, (r) => r !== void 0));
  }
}, s(di, "Repetition"), di), pi, bt = (pi = class extends yr {
  constructor(e) {
    super(e.definition), this.idx = 1, Nt(this, Jt(e, (r) => r !== void 0));
  }
}, s(pi, "RepetitionWithSeparator"), pi), mi, _t = (mi = class extends yr {
  get definition() {
    return this._definition;
  }
  set definition(e) {
...
}, s(mi, "Alternation"), mi), hi, we = (hi = class {
  constructor(e) {
  ...
  if (s(e, "convertDefinition"), t instanceof mt) {
    ...
    if (t instanceof Ot)
      return {
        ...
        idx: t.idx,
        separator: pu(new we({ terminalType: t.separator })),
        definition: e(t.definition)
      };
    if (t instanceof bt)
      return {
...
function Ib(t) {
  return t instanceof Ct || t instanceof at || t instanceof xe || t instanceof kt || t instanceof Ot || t instanceof bt || t instanceof we || t instanceof sl;
}
s(Ib, "isSequenceProd");
function bu(t, e = []) {
  return t instanceof at || t instanceof xe || t instanceof bt ? !0 : t instanceof _t ? Eb(t.definition, (n) => bu(n, e)) : t instanceof mt && gt(e, t) ? !1 : t instanceof yr ? (t instanceof mt && e.push(t), Ht(t.definition, (n) => bu(n, e))) : !1;
}
s(bu, "isOptionalProd");
function Nb(t) {
  return t instanceof _t;
}
s(Nb, "isBranchingProd");
function Ut(t) {
  if (t instanceof mt)
    return "SUBRULE";
  if (t instanceof at)
...
function _m(t, e, r) {
  return [
    new at({
      definition: [
        new we({ terminalType: t.separator })
      ].concat(t.definition)
    })
  ].concat(e, r);
}
s(_m, "restForRepetitionWithSeparator");
function ll(t) {
  if (t instanceof mt)
    return ll(t.referencedRule);
  if (t instanceof we)
    return Ob(t);
  if (Ib(t))
    return Pb(t);
...
function Pb(t) {
  ...
  for (; a && o; )
    i = r[n], o = bu(i), e = e.concat(ll(i)), n = n + 1, a = r.length > n;
  return By(e);
}
s(Pb, "firstForSequence");
function kb(t) {
  const e = j(t.definition, (r) => ll(r));
  return By(Vt(e));
}
s(kb, "firstForBranching");
function Ob(t) {
  return [t.terminalType];
}
s(Ob, "firstForTerminal");
var Lb = "_~IN~_", vi, v1 = (vi = class extends fd {
  constructor(e) {
  ...
  walkProdRef(e, r, n) {
    const a = xb(e.referencedRule, e.idx) + this.topProd.name, i = r.concat(n), o = new Ct({ definition: i }), u = ll(o);
    this.follows[a] = u;
  }
}, s(vi, "ResyncFollowsWalker"), vi);
function Db(t) {
  const e = {};
  return q(t, (r) => {
    const n = new v1(r).startWalking();
    Nt(e, n);
  }), e;
}
s(Db, "computeAllProdsFollows");
function xb(t, e) {
  return t.name + e + Lb;
}
...
s(Mb, "clearRegExpParserCache");
var Gb = "Complement Sets are not supported for first char optimization", mf = `Unable to use "first char" lexer optimizations:
`;
function Fb(t, e = !1) {
  try {
    const r = Ju(t);
    return hf(r.value, {}, r.flags.ignoreCase);
  } catch (r) {
    if (r.message === Gb)
      e && Uy(`${mf}	Unable to optimize: < ${t.toString()} >
	...
	See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#COMPLEMENT for details.`);
      ...
      e && (n = `
	This will disable the lexer's first char optimizations.
	See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#REGEXP_PARSING for details.`), pf(`${mf}
...
s(Fb, "getOptimizedStartCodesIndices");
function hf(t, e, r) {
  switch (t.type) {
    case "Disjunction":
    ...
    case "Alternative":
      ...
      for (let a = 0; a < n.length; a++) {
            ...
            q(o.value, (l) => {
              if (typeof l == "number")
                ...
                if (r === !0)
                  ...
                  for (let f = c.from; f <= c.to && f < Zl; f++)
                    Xl(f, e, r);
                  if (c.to >= Zl) {
                    const f = c.from >= Zl ? c.from : Zl, d = c.to, p = kr(f), h = kr(d);
                    for (let y = p; y <= h; y++)
                      e[y] = y;
                  }
                }
        ...
        if (
          ...
          o.type === "Group" && yf(o) === !1 || // If this term is not a group it may only be optional if it has an optional quantifier
          o.type !== "Group" && u === !1
        )
          break;
      }
...
s(hf, "firstCharOptimizedIndices");
function Xl(t, e, r) {
  const n = kr(t);
  e[n] = n, r === !0 && zb(t, e);
}
s(Xl, "addOptimizedIdxToResult");
function zb(t, e) {
...
function Sm(t, e) {
  return el(t.value, (r) => {
    ...
    {
      const n = r;
      return el(e, (a) => n.from <= a && a <= n.to) !== void 0;
    }
  });
}
s(Sm, "findCode");
function yf(t) {
  ...
  return e && e.atLeast === 0 ? !0 : t.value ? se(t.value) ? Ht(t.value, yf) : yf(t.value) : !1;
}
s(yf, "isWholeOptional");
var Ti, $1 = (Ti = class extends Kf {
  constructor(e) {
  ...
  visitSet(e) {
    e.complement ? Sm(e, this.targetCharCodes) === void 0 && (this.found = !0) : Sm(e, this.targetCharCodes) !== void 0 && (this.found = !0);
  }
}, s(Ti, "CharCodeFinder"), Ti);
function dd(t, e) {
  if (e instanceof RegExp) {
    const r = Ju(e), n = new $1(t);
    return n.visit(r), n.found;
  } else
    return el(e, (r) => gt(t, r.charCodeAt(0))) !== void 0;
}
s(dd, "canMatchCharCode");
var Un = "PATTERN", Jl = "defaultMode", ic = "modes";
function jb(t, e) {
  e = jy(e, {
    debug: !1,
    safeMode: !1,
...
`],
  ...
  r("misc mapping", () => {
    o = j(n, (w) => w.tokenTypeIdx), u = j(n, (w) => {
      ...
      if (b)
        return se(b) ? j(b, (B) => Fv(n, B)) : [Fv(n, b)];
    }), c = j(n, (w) => w.PUSH_MODE), f = j(n, (w) => K(w, "POP_MODE"));
  });
  let d;
  r("Line Terminator Handling", () => {
    const w = Hy(e.lineTerminatorCharacters);
    d = j(n, (b) => !1), e.positionTracking !== "onlyOffset" && (d = j(n, (b) => K(b, "LINE_BREAKS") ? !!b.LINE_BREAKS : Vy(b, w) === !1 && dd(w, b.PATTERN)));
  });
  let p, h, y, v;
  r("Misc Mapping #2", () => {
    p = j(n, qy), h = j(i, s_), y = Pt(n, (w, b) => {
      const N = b.GROUP;
    ...
    T = Pt(n, (w, b, N) => {
      if (typeof b.PATTERN == "string") {
        ...
        q(b.START_CHARS_HINT, (ne) => {
          ...
          B !== he && (B = he, Pc(w, he, v[N]));
        });
      } else if (Nr(b.PATTERN))
        if (b.PATTERN.unicode)
          E = !1, e.ensureOptimizations && pf(`${mf}	Unable to analyze < ${b.PATTERN.toString()} > pattern.
	The regexp unicode flag is not currently supported by the regexp-to-ast library.
	This will disable the lexer's first char optimizations.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNICODE_OPTIMIZE`);
        else {
          const B = Fb(b.PATTERN, e.ensureOptimizations);
          Ae(B) && (E = !1), q(B, (ne) => {
            Pc(w, ne, v[N]);
          });
        }
      else
        e.ensureOptimizations && pf(`${mf}	TokenType: <${b.name}> is using a custom token pattern without providing <start_chars_hint> parameter.
	This will disable the lexer's first char optimizations.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#CUSTOM_OPTIMIZE`), E = !1;
      return w;
    }, []);
  }), {
    emptyGroups: y,
...
s(jb, "analyzeTokenTypes");
function Bb(t, e) {
  let r = [];
  const n = Kb(t);
  r = r.concat(n.errors);
  const a = Wb(n.valid), i = a.valid;
  return r = r.concat(a.errors), r = r.concat(Ub(i)), r = r.concat(Jb(i)), r = r.concat(Zb(i, e)), r = r.concat(Qb(i)), r;
}
s(Bb, "validatePatterns");
function Ub(t) {
  let e = [];
  const r = jt(t, (n) => Nr(n[Un]));
  return e = e.concat(qb(r)), e = e.concat(Hb(r)), e = e.concat(Yb(r)), e = e.concat(Xb(r)), e = e.concat(Vb(r)), e;
}
s(Ub, "validateRegExpPattern");
function Kb(t) {
  const e = jt(t, (a) => !K(a, Un)), r = j(e, (a) => ({
...
s(Wb, "findInvalidPatterns");
var R1 = /[^\\][$]/;
function qb(t) {
  const a = class a extends Kf {
    constructor() {
  ...
  const r = jt(t, (i) => {
    const o = i.PATTERN;
    try {
      const u = Ju(o), l = new e();
      return l.visit(u), l.found;
    } catch {
      return R1.test(o.source);
    }
  });
  return j(r, (i) => ({
...
s(Zb, "findModesThatDoNotExist");
function Qb(t) {
  const e = [], r = Pt(t, (n, a, i) => {
    const o = a.PATTERN;
    return o === dt.NA || (Et(o) ? n.push({ str: o, idx: i, tokenType: a }) : Nr(o) && t_(o) && n.push({ str: o.source, idx: i, tokenType: a })), n;
  }, []);
  return q(t, (n, a) => {
    q(r, ({ str: i, idx: o, tokenType: u }) => {
      if (a < o && e_(i, n.PATTERN)) {
...
function n_(t, e, r) {
  const n = [];
  return K(t, Jl) || n.push({
    message: "A MultiMode Lexer cannot be initialized without a <" + Jl + `> property in its definition
`,
    type: Me.MULTI_MODE_LEXER_WITHOUT_DEFAULT_MODE
  }), K(t, ic) || n.push({
    message: "A MultiMode Lexer cannot be initialized without a <" + ic + `> property in its definition
`,
    type: Me.MULTI_MODE_LEXER_WITHOUT_MODES_PROPERTY
  }), K(t, ic) && K(t, Jl) && !K(t.modes, t.defaultMode) && n.push({
    message: `A MultiMode Lexer cannot be initialized with a ${Jl}: <${t.defaultMode}>which does not exist
`,
    type: Me.MULTI_MODE_LEXER_DEFAULT_MODE_VALUE_DOES_NOT_EXIST
  }), K(t, ic) && q(t.modes, (a, i) => {
    q(a, (o, u) => {
      if (Pr(o))
        n.push({
...
s(n_, "performRuntimeChecks");
function a_(t, e, r) {
  const n = [];
  let a = !1;
  const i = Xu(Vt(Ke(t.modes))), o = cd(i, (l) => l[Un] === dt.NA), u = Hy(r);
  return e && q(o, (l) => {
    const c = Vy(l, u);
    if (c !== !1) {
      const d = {
      ...
      K(l, "LINE_BREAKS") ? l.LINE_BREAKS === !0 && (a = !0) : dd(u, l.PATTERN) && (a = !0);
  }), e && !a && n.push({
...
s(a_, "performWarningRuntimeChecks");
function i_(t) {
  const e = {}, r = It(t);
  return q(r, (n) => {
    const a = t[n];
...
s(o_, "buildLineBreakIssueMessage");
function Hy(t) {
...
function l_() {
  if (Ae(kc)) {
    ...
    for (let t = 0; t < 65536; t++)
      kc[t] = t > 255 ? 255 + ~~(t / 255) : t;
  }
}
s(l_, "initCharCodeToOptimizedIndexMap");
function ul(t, e) {
  const r = t.tokenTypeIdx;
  return r === e.tokenTypeIdx ? !0 : e.isParent === !0 && e.categoryMatchesMap[r] === !0;
}
s(ul, "tokenStructuredMatcher");
function _u(t, e) {
  return t.tokenTypeIdx === e.tokenTypeIdx;
}
s(_u, "tokenStructuredMatcherNoCategories");
var jv = 1, u_ = {};
function cl(t) {
  const e = c_(t);
  f_(e), p_(e), d_(e), q(e, (r) => {
    r.isParent = r.categoryMatches.length > 0;
  });
}
s(cl, "augmentTokenTypes");
function c_(t) {
  let e = it(t), r = t, n = !0;
  for (; n; ) {
    r = Xu(Vt(j(r, (i) => i.CATEGORIES)));
    const a = ud(r, e);
    e = e.concat(a), Ae(a) ? n = !1 : r = a;
  }
  return e;
}
s(c_, "expandCategories");
function f_(t) {
  q(t, (e) => {
    Xy(e) || (u_[jv] = e, e.tokenTypeIdx = jv++), Im(e) && !se(e.CATEGORIES) && (e.CATEGORIES = [e.CATEGORIES]), Im(e) || (e.CATEGORIES = []), m_(e) || (e.categoryMatches = []), h_(e) || (e.categoryMatchesMap = {});
  });
}
s(f_, "assignTokenDefaultProps");
function d_(t) {
  q(t, (e) => {
...
s(d_, "assignCategoriesTokensProp");
function p_(t) {
  q(t, (e) => {
    Yy([], e);
  });
}
s(p_, "assignCategoriesMapProp");
function Yy(t, e) {
  q(t, (r) => {
...
s(Yy, "singleAssignCategoriesToksMap");
function Xy(t) {
  return K(t, "tokenTypeIdx");
}
s(Xy, "hasShortKeyProperty");
function Im(t) {
  return K(t, "CATEGORIES");
}
s(Im, "hasCategoriesProperty");
function m_(t) {
  return K(t, "categoryMatches");
}
s(m_, "hasExtendingTokensTypesProperty");
function h_(t) {
  ...
  constructor(e, r = Ql) {
    if (this.lexerDefinition = e, this.lexerDefinitionErrors = [], this.lexerDefinitionWarning = [], this.patternIdxToConfig = {}, this.charCodeToPatternIdxToConfig = {}, this.modes = [], this.emptyGroups = {}, this.trackStartLines = !0, this.trackEndLines = !0, this.hasCustom = !1, this.canModeBeOptimized = {}, this.TRACE_INIT = (a, i) => {
      if (this.traceInitPerf === !0) {
        ...
        const { time: u, value: l } = Ky(i), c = u > 10 ? console.warn : console.log;
...
a boolean 2nd argument is no longer supported`);
    ...
    n === !0 ? (this.traceInitMaxIdent = 1 / 0, this.traceInitPerf = !0) : typeof n == "number" && (this.traceInitMaxIdent = n, this.traceInitPerf = !0), this.traceInitIndent = -1, this.TRACE_INIT("Lexer Constructor", () => {
      ...
      this.TRACE_INIT("Lexer Config handling", () => {
        if (this.config.lineTerminatorsPattern === Ql.lineTerminatorsPattern)
          this.config.lineTerminatorsPattern = E1;
        else if (this.config.lineTerminatorCharacters === Ql.lineTerminatorCharacters)
	...
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
        ...
        this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(n_(a, this.trackStartLines, this.config.lineTerminatorCharacters));
      }), this.TRACE_INIT("performWarningRuntimeChecks", () => {
        this.lexerDefinitionWarning = this.lexerDefinitionWarning.concat(a_(a, this.trackStartLines, this.config.lineTerminatorCharacters));
      })), a.modes = a.modes ? a.modes : {}, q(a.modes, (u, l) => {
        a.modes[l] = cd(u, (c) => Pr(c));
      });
      const o = It(a.modes);
      if (q(a.modes, (u, l) => {
        this.TRACE_INIT(`Mode: <${l}> processing`, () => {
          if (this.modes.push(l), this.config.skipValidations === !1 && this.TRACE_INIT("validatePatterns", () => {
            this.lexerDefinitionErrors = this.lexerDefinitionErrors.concat(Bb(u, o));
...
` + l);
      ...
      q(this.lexerDefinitionWarning, (u) => {
        ...
        if (i && (this.handleModes = He), this.trackStartLines === !1 && (this.computeNewColumn = Ku), this.trackEndLines === !1 && (this.updateTokenEndLineColumnLocation = He), /full/i.test(this.config.positionTracking))
...
` + a);
  ...
  tokenizeInternal(e, r) {
    let n, a, i, o, u, l, c, f, d, p, h, y, v, E, T;
    const w = e, b = w.length;
    let N = 0, B = 0;
    const ne = this.hasCustom ? 0 : Math.floor(e.length / 10), J = new Array(ne), he = [];
    let Ee = this.trackStartLines ? 1 : void 0, ye = this.trackStartLines ? 1 : void 0;
    const ue = i_(this.emptyGroups), ot = this.trackStartLines, k = this.config.lineTerminatorsPattern;
    let _ = 0, $ = [], I = [];
    const R = [], A = [];
    Object.freeze(A);
    let S = !1;
    ...
    for (; N < b; ) {
      ...
      for (n = 0; n < V; n++) {
        ...
        c = null;
        const ae = O.short;
        if (ae !== !1 ? M === ae && (d = 1, l = Z) : O.isCustom === !0 ? (T = Z.exec(w, N, J, ue), T !== null ? (l = T[0], d = l.length, T.payload !== void 0 && (c = T.payload)) : l = null) : (Z.lastIndex = N, d = this.matchLength(Z, e, N)), d !== -1) {
          if (u = O.longerAlt, u !== void 0) {
            l = e.substring(N, N + d);
            const Le = u.length;
            for (i = 0; i < Le; i++) {
              const pe = $[u[i]], Ce = pe.pattern;
              if (f = null, pe.isCustom === !0 ? (T = Ce.exec(w, N, J, ue), T !== null ? (o = T[0], T.payload !== void 0 && (f = T.payload)) : o = null) : (Ce.lastIndex = N, o = this.match(Ce, e, N)), o && o.length > l.length) {
      ...
      if (d !== -1) {
        if (p = O.group, p !== void 0 && (l = l !== null ? l : e.substring(N, N + d), h = O.tokenTypeIdx, y = this.createTokenInstance(l, N, h, O.tokenType, Ee, ye, d), this.handlePayload(y, c), p === !1 ? B = this.addToken(J, B, y) : ue[p].push(y)), ot === !0 && O.canLineTerminator === !0) {
          let Z = 0, ae, Le;
          k.lastIndex = 0;
          do
            l = l !== null ? l : e.substring(N, N + d), ae = k.test(l), ae === !0 && (Le = k.lastIndex - 1, Z++);
          while (ae === !0);
          Z !== 0 ? (Ee = Ee + Z, ye = d - Le, this.updateTokenEndLineColumnLocation(y, p, Le, Z, Ee, ye, d)) : ye = this.computeNewColumn(ye, d);
        } else
          ye = this.computeNewColumn(ye, d);
        N = N + d, this.handleModes(O, L, x, y);
      } else {
        const Z = N, ae = Ee, Le = ye;
        let pe = z === !1;
        for (; pe === !1 && N < b; )
          for (N++, a = 0; a < _; a++) {
            const Ce = $[a], qe = Ce.pattern, De = Ce.short;
            if (De !== !1 ? w.charCodeAt(N) === De && (pe = !0) : Ce.isCustom === !0 ? pe = qe.exec(w, N, J, ue) !== null : (qe.lastIndex = N, pe = qe.exec(e) !== null), pe === !0)
              break;
          }
        if (v = N - Z, ye = this.computeNewColumn(ye, v), E = this.config.errorMessageProvider.buildUnexpectedCharactersMessage(w, Z, v, ae, Le, Bn(R)), he.push({
          offset: Z,
          line: ae,
          column: Le,
          length: v,
...
s(Jy, "hasTokenLabel");
var C1 = "parent", Bv = "categories", Uv = "label", Kv = "group", Wv = "push_mode", qv = "pop_mode", Vv = "longer_alt", Hv = "line_breaks", Yv = "start_chars_hint";
function Xa(t) {
  return g_(t);
}
s(Xa, "createToken");
function g_(t) {
  const e = t.pattern, r = {};
  if (r.name = t.name, Pr(e) || (r.PATTERN = e), K(t, C1))
    throw `The parent property is no longer supported.
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;
  return K(t, Bv) && (r.CATEGORIES = t[Bv]), cl([r]), K(t, Uv) && (r.LABEL = t[Uv]), K(t, Kv) && (r.GROUP = t[Kv]), K(t, qv) && (r.POP_MODE = t[qv]), K(t, Wv) && (r.PUSH_MODE = t[Wv]), K(t, Vv) && (r.LONGER_ALT = t[Vv]), K(t, Hv) && (r.LINE_BREAKS = t[Hv]), K(t, Yv) && (r.START_CHARS_HINT = t[Yv]), r;
}
s(g_, "createTokenInternal");
var Jr = Xa({ name: "EOF", pattern: dt.NA });
cl([Jr]);
function Zu(t, e, r, n, a, i, o, u) {
  return {
    image: e,
    startOffset: r,
    endOffset: n,
...
var Va = {
  buildMismatchTokenMessage({ expected: t, actual: e, previous: r, ruleName: n }) {
    return `Expecting ${Jy(t) ? `--> ${Mn(t)} <--` : `token of type --> ${t.name} <--`} but found --> '${e.image}' <--`;
  },
...
but found: '` + Xt(e).image + "'";
    if (n)
      return i + n + u;
    {
      const l = Pt(t, (p, h) => p.concat(h), []), c = j(l, (p) => `[${j(p, (h) => Mn(h)).join(", ")}]`), d = `one of these possible Token sequences:
${j(c, (p, h) => `  ${h + 1}. ${p}`).join(`
`)}`;
      return i + d + u;
    }
...
inside top level rule: ->` + t.name + "<-";
  ...
  buildDuplicateFoundError(t, e) {
    function r(f) {
      return f instanceof we ? f.terminalType.name : f instanceof mt ? f.nonTerminalName : "";
    }
...
and Non-Terminal names start with a lower case letter.`;
  ...
  buildAlternationPrefixAmbiguityError(t) {
    const e = j(t.prefixPath, (a) => Mn(a)).join(", "), r = t.alternation.idx === 0 ? "" : t.alternation.idx;
...
`;
      ...
      const a = j(t.prefixPath, (i) => Mn(i)).join(", ");
...
see: https://en.wikipedia.org/wiki/LL_parser#Left_factoring.`;
  ...
  buildDuplicateRuleNameError(t) {
    let e;
    return t.topLevelRule instanceof sl ? e = t.topLevelRule.name : e = t.topLevelRule, `Duplicate definition, rule: ->${e}<- is already defined in the grammar: ->${t.grammarName}<-`;
  }
};
function v_(t, e) {
  const r = new _1(t, e);
...
var Ri, _1 = (Ri = class extends ol {
...
}, s(Ri, "GastRefResolverVisitor"), Ri), Ai, S1 = (Ai = class extends fd {
  constructor(e, r) {
...
}, s(Ai, "AbstractNextPossibleTokensWalker"), Ai), Ei, w1 = (Ei = class extends S1 {
  constructor(e, r) {
  ...
  walkTerminal(e, r, n) {
    if (this.isAtEndOfPath && e.terminalType.name === this.nextTerminalName && e.idx === this.nextTerminalOccurrence && !this.found) {
      ...
      this.possibleTokTypes = ll(i), this.found = !0;
    }
  }
}, s(Ei, "NextAfterTokenWalker"), Ei), Ci, pd = (Ci = class extends fd {
  constructor(e, r) {
...
}, s(Ci, "AbstractNextTerminalAfterProductionWalker"), Ci), bi, I1 = (bi = class extends pd {
  walkMany(e, r, n) {
    if (e.idx === this.occurrence) {
      const a = Xt(r.concat(n));
      this.result.isEndOfRule = a === void 0, a instanceof we && (this.result.token = a.terminalType, this.result.occurrence = a.idx);
    } else
      super.walkMany(e, r, n);
  }
}, s(bi, "NextTerminalAfterManyWalker"), bi), _i, Xv = (_i = class extends pd {
  walkManySep(e, r, n) {
    if (e.idx === this.occurrence) {
      const a = Xt(r.concat(n));
      this.result.isEndOfRule = a === void 0, a instanceof we && (this.result.token = a.terminalType, this.result.occurrence = a.idx);
...
}, s(_i, "NextTerminalAfterManySepWalker"), _i), Si, N1 = (Si = class extends pd {
  walkAtLeastOne(e, r, n) {
    if (e.idx === this.occurrence) {
      const a = Xt(r.concat(n));
      this.result.isEndOfRule = a === void 0, a instanceof we && (this.result.token = a.terminalType, this.result.occurrence = a.idx);
...
}, s(Si, "NextTerminalAfterAtLeastOneWalker"), Si), wi, Jv = (wi = class extends pd {
  walkAtLeastOneSep(e, r, n) {
    if (e.idx === this.occurrence) {
      const a = Xt(r.concat(n));
      this.result.isEndOfRule = a === void 0, a instanceof we && (this.result.token = a.terminalType, this.result.occurrence = a.idx);
...
}, s(wi, "NextTerminalAfterAtLeastOneSepWalker"), wi);
function gf(t, e, r = []) {
  r = it(r);
  let n = [], a = 0;
  function i(u) {
  ...
  for (s(o, "getAlternativesForProd"); r.length < e && a < t.length; ) {
    ...
    if (u instanceof at)
      ...
      const l = [
        ...
        new xe({
          definition: [new we({ terminalType: u.separator })].concat(u.definition)
        })
      ];
      return o(l);
...
function Qy(t, e, r, n) {
  ...
  for (d.push({
    ...
    const h = p.def, y = p.idx, v = p.ruleStack, E = p.occurrenceStack;
    if (Ae(h))
      continue;
    const T = h[0];
    if (T === a) {
      ...
      const w = it(v);
      w.push(T.nonTerminalName);
      const b = it(E);
      b.push(T.idx);
      const N = {
        idx: y,
        def: T.definition.concat(i, nt(h)),
        ruleStack: w,
        occurrenceStack: b
      };
      d.push(N);
      ...
      const w = new xe({
        ...
        idx: T.idx
      }), b = T.definition.concat([w], nt(h)), N = {
        idx: y,
        def: b,
        ruleStack: v,
        occurrenceStack: E
      ...
      const w = new we({
        ...
        definition: [w].concat(T.definition),
        idx: T.idx
      }), N = T.definition.concat([b], nt(h)), B = {
        idx: y,
        def: N,
        ruleStack: v,
        occurrenceStack: E
      ...
      const b = new we({
        ...
        idx: T.idx
      }), B = T.definition.concat([N], nt(h)), ne = {
        idx: y,
        def: B,
        ruleStack: v,
        occurrenceStack: E
      ...
      for (let w = T.definition.length - 1; w >= 0; w--) {
        const b = T.definition[w], N = {
          idx: y,
          def: b.definition.concat(nt(h)),
          ruleStack: v,
          occurrenceStack: E
        };
        d.push(N), d.push(o);
...
function md(t) {
  ...
  if (t instanceof xe || t === "Repetition")
    return ke.REPETITION;
  if (t instanceof kt || t === "RepetitionMandatory")
    return ke.REPETITION_MANDATORY;
  if (t instanceof Ot || t === "RepetitionMandatoryWithSeparator")
    return ke.REPETITION_MANDATORY_WITH_SEPARATOR;
  if (t instanceof bt || t === "RepetitionWithSeparator")
    return ke.REPETITION_WITH_SEPARATOR;
  if (t instanceof _t || t === "Alternation")
    return ke.ALTERNATION;
  throw Error("non exhaustive match");
}
s(md, "getProdType");
function Pm(t) {
  const { occurrence: e, rule: r, prodType: n, maxLookahead: a } = t, i = md(n);
  return i === ke.ALTERNATION ? Qu(e, r, a) : ec(e, r, i, a);
}
s(Pm, "getLookaheadPaths");
function $_(t, e, r, n, a, i) {
  const o = Qu(t, e, r), u = tg(o) ? _u : ul;
  return i(o, n, u, a);
}
s($_, "buildLookaheadFuncForOr");
function R_(t, e, r, n, a, i) {
  const o = ec(t, e, a, r), u = tg(o) ? _u : ul;
  return i(o[0], u, n);
}
s(R_, "buildLookaheadFuncForOptionalProd");
function A_(t, e, r, n) {
...
s(A_, "buildAlternativesLookAheadFunc");
function E_(t, e, r) {
...
s(E_, "buildSingleAlternativeLookaheadFunction");
var Ii, P1 = (Ii = class extends fd {
  constructor(e, r, n) {
  ...
  walkOption(e, r, n) {
    this.checkIsTarget(e, ke.OPTION, r, n) || super.walkOption(e, r, n);
  }
  walkAtLeastOne(e, r, n) {
    this.checkIsTarget(e, ke.REPETITION_MANDATORY, r, n) || super.walkOption(e, r, n);
  }
  walkAtLeastOneSep(e, r, n) {
    this.checkIsTarget(e, ke.REPETITION_MANDATORY_WITH_SEPARATOR, r, n) || super.walkOption(e, r, n);
  }
  walkMany(e, r, n) {
    this.checkIsTarget(e, ke.REPETITION, r, n) || super.walkOption(e, r, n);
  }
  walkManySep(e, r, n) {
    this.checkIsTarget(e, ke.REPETITION_WITH_SEPARATOR, r, n) || super.walkOption(e, r, n);
  }
}, s(Ii, "RestDefinitionFinderWalker"), Ii), Ni, C_ = (Ni = class extends ol {
  constructor(e, r, n) {
  ...
  visitOption(e) {
    this.checkIsTarget(e, ke.OPTION);
  }
  visitRepetition(e) {
    this.checkIsTarget(e, ke.REPETITION);
  }
  visitRepetitionMandatory(e) {
    this.checkIsTarget(e, ke.REPETITION_MANDATORY);
  }
  visitRepetitionMandatoryWithSeparator(e) {
    this.checkIsTarget(e, ke.REPETITION_MANDATORY_WITH_SEPARATOR);
  }
  visitRepetitionWithSeparator(e) {
    this.checkIsTarget(e, ke.REPETITION_WITH_SEPARATOR);
  }
  visitAlternation(e) {
    this.checkIsTarget(e, ke.ALTERNATION);
  }
}, s(Ni, "InsideDefinitionFinderVisitor"), Ni);
function km(t) {
  const e = new Array(t);
  for (let r = 0; r < t; r++)
    e[r] = [];
...
s(b_, "isUniquePrefixHash");
function eg(t, e) {
  const r = j(t, (o) => gf([o], 1)), n = km(r.length), a = j(r, (o) => {
    const u = {};
    return q(o, (l) => {
      const c = Oc(l.partialPath);
      q(c, (f) => {
        u[f] = !0;
      });
    }), u;
  ...
  for (let o = 1; o <= e; o++) {
    ...
    for (let l = 0; l < u.length; l++) {
      ...
      for (let f = 0; f < c.length; f++) {
        const d = c[f].partialPath, p = c[f].suffixDef, h = Oc(d);
        if (b_(a, h, l) || Ae(p) || d.length === e) {
          const v = n[l];
          if (vf(v, d) === !1) {
            v.push(d);
          ...
          const v = gf(p, o + 1, d);
          i[l] = i[l].concat(v), q(v, (E) => {
            const T = Oc(E.partialPath);
            q(T, (w) => {
              a[l][w] = !0;
            });
          });
...
s(eg, "lookAheadSequenceFromAlternatives");
function Qu(t, e, r, n) {
  const a = new C_(t, ke.ALTERNATION, n);
  return e.accept(a), eg(a.result, r);
}
s(Qu, "getLookaheadPathsForOr");
function ec(t, e, r, n) {
  const a = new C_(t, r);
  e.accept(a);
  const i = a.result, u = new P1(e, t, r).startWalking(), l = new Ct({ definition: i }), c = new Ct({ definition: u });
  return eg([l, c], n);
}
s(ec, "getLookaheadPathsForOptionalProd");
function vf(t, e) {
...
s(__, "isStrictPrefixOfPath");
function tg(t) {
  return Ht(t, (e) => Ht(e, (r) => Ht(r, (n) => Ae(n.categoryMatches))));
}
...
s(S_, "validateLookahead");
function w_(t, e, r, n) {
  const a = Mt(t, (l) => I_(l, r)), i = F_(t, e, r), o = Mt(t, (l) => D_(l, r)), u = Mt(t, (l) => P_(l, t, n, r));
  return a.concat(i, o, u);
}
s(w_, "validateGrammar");
function I_(t, e) {
  const r = new k1();
  t.accept(r);
  const n = r.allProductions, a = qM(n, N_), i = Jt(a, (u) => u.length > 1);
  return j(Ke(i), (u) => {
...
s(I_, "validateDuplicateProductions");
function N_(t) {
  return `${Ut(t)}_#_${t.idx}_#_${rg(t)}`;
}
s(N_, "identifyProductionForDuplicates");
function rg(t) {
  return t instanceof we ? t.terminalType.name : t instanceof mt ? t.nonTerminalName : "";
}
s(rg, "getExtraProductionArgument");
var Pi, k1 = (Pi = class extends ol {
  constructor() {
...
}, s(Pi, "OccurrenceValidationCollector"), Pi);
function P_(t, e, r, n) {
  const a = [];
...
s(P_, "validateRuleDoesNotAlreadyExist");
function k_(t, e, r) {
  const n = [];
  let a;
...
s(k_, "validateRuleIsOverridden");
function ng(t, e, r, n = []) {
  const a = [], i = mu(e.definition);
  if (Ae(i))
    return [];
  {
    const o = t.name;
    ...
    const l = ud(i, n.concat([t])), c = Mt(l, (f) => {
      const d = it(n);
      return d.push(f), ng(t, f, r, d);
    });
    return a.concat(c);
  }
}
s(ng, "validateNoLeftRecursion");
function mu(t) {
  let e = [];
  if (Ae(t))
    return e;
  ...
  if (r instanceof mt)
    ...
    e = e.concat(mu(r.definition));
  else if (r instanceof _t)
    e = Vt(j(r.definition, (i) => mu(i.definition)));
  else if (!(r instanceof we)) throw Error("non exhaustive match");
  const n = bu(r), a = t.length > 1;
  if (n && a) {
    const i = nt(t);
    return e.concat(mu(i));
  } else
    return e;
}
s(mu, "getFirstNoneTerminal");
var ki, ag = (ki = class extends ol {
  constructor() {
...
s(O_, "validateEmptyOrAlternative");
function L_(t, e, r) {
  const n = new ag();
  t.accept(n);
  let a = n.alternations;
  return a = cd(a, (o) => o.ignoreAmbiguities === !0), Mt(a, (o) => {
    const u = o.idx, l = o.maxLookahead || e, c = Qu(u, t, l, o), f = M_(c, o, t, r), d = G_(c, o, t, r);
    return f.concat(d);
  });
}
s(L_, "validateAmbiguousAlternationAlternatives");
var Oi, O1 = (Oi = class extends ol {
  constructor() {
    super(...arguments), this.allProductions = [];
  }
  visitRepetitionWithSeparator(e) {
...
function x_(t, e, r) {
  ...
  return q(t, (a) => {
    ...
    q(o, (u) => {
      const l = md(u), c = u.maxLookahead || e, f = u.idx, p = ec(f, a, l, c)[0];
      if (Ae(Vt(p))) {
        const h = r.buildEmptyRepetitionError({
          topLevelRule: a,
          repetition: u
        });
        n.push({
...
function M_(t, e, r, n) {
  const a = [], i = Pt(t, (u, l, c) => (e.definition[c].ignoreAmbiguities === !0 || q(l, (f) => {
    const d = [c];
    q(t, (p, h) => {
      c !== h && vf(p, f) && // ignore (skip) ambiguities with this "other" alternative
      e.definition[h].ignoreAmbiguities !== !0 && d.push(h);
    }), d.length > 1 && !vf(a, f) && (a.push(f), u.push({
      alts: d,
      path: f
    }));
  }), u), []);
...
s(M_, "checkAlternativesAmbiguities");
function G_(t, e, r, n) {
  const a = Pt(t, (o, u, l) => {
  ...
  return Xu(Mt(a, (o) => {
    ...
    return j(f, (p) => {
      const h = [p.idx + 1, l + 1], y = e.idx === 0 ? "" : e.idx;
      return {
...
s(F_, "checkTerminalAndNoneTerminalsNameSpace");
function z_(t) {
  const e = jy(t, {
    errMsgProvider: b1
  }), r = {};
  return q(t.rules, (n) => {
    r[n.name] = n;
  }), v_(r, e.errMsgProvider);
}
s(z_, "resolveGrammar");
function j_(t) {
  return t = jy(t, {
    errMsgProvider: Ln
  }), w_(t.rules, t.tokenTypes, t.errMsgProvider, t.grammarName);
}
s(j_, "validateGrammar");
var B_ = "MismatchedTokenException", U_ = "NoViableAltException", K_ = "EarlyExitException", W_ = "NotAllInputParsedException", q_ = [
  B_,
  U_,
  K_,
  W_
...
s(Su, "isRecognitionException");
var Li, hd = (Li = class extends Error {
  constructor(e, r) {
...
}, s(Li, "RecognitionException"), Li), Di, V_ = (Di = class extends hd {
  constructor(e, r, n) {
    super(e, r), this.previousToken = n, this.name = B_;
  }
}, s(Di, "MismatchedTokenException"), Di), xi, L1 = (xi = class extends hd {
  constructor(e, r, n) {
    super(e, r), this.previousToken = n, this.name = U_;
  }
}, s(xi, "NoViableAltException"), xi), Mi, D1 = (Mi = class extends hd {
  constructor(e, r) {
    super(e, r), this.name = W_;
  }
}, s(Mi, "NotAllInputParsedException"), Mi), Gi, x1 = (Gi = class extends hd {
  constructor(e, r, n) {
    super(e, r), this.previousToken = n, this.name = K_;
  }
}, s(Gi, "EarlyExitException"), Gi), qd = {}, H_ = "InRuleRecoveryException", Fi, M1 = (Fi = class extends Error {
  constructor(e) {
    super(e), this.name = H_;
  }
}, s(Fi, "InRuleRecoveryException"), Fi), zi, G1 = (zi = class {
  initRecoverable(e) {
    this.firstAfterRepMap = {}, this.resyncFollows = {}, this.recoveryEnabled = K(e, "recoveryEnabled") ? e.recoveryEnabled : Or.recoveryEnabled, this.recoveryEnabled && (this.attemptInRepetitionRecovery = Y_);
  }
  getTokenToInsert(e) {
    const r = Zu(e, "", NaN, NaN, NaN, NaN, NaN, NaN);
  ...
  tryInRepetitionRecovery(e, r, n, a) {
    ...
    let f = this.LA(1);
    const d = /* @__PURE__ */ s(() => {
      const p = this.LA(0), h = this.errorMessageProvider.buildMismatchTokenMessage({
        expected: a,
        actual: c,
        previous: p,
        ruleName: this.getCurrRuleFullName()
      }), y = new V_(h, c, this.LA(0));
      y.resyncedTokens = Cu(u), this.SAVE_ERROR(y);
  ...
  canRecoverWithSingleTokenInsertion(e, r) {
    if (!this.canTokenTypeBeInsertedInRecovery(e) || Ae(r))
      return !1;
    const n = this.LA(1);
    return el(r, (i) => this.tokenMatcher(n, i)) !== void 0;
  }
  ...
  getFollowSetFromFollowKey(e) {
    if (e === qd)
      return [Jr];
    const r = e.ruleName + e.idxInCallingRule + Lb + e.inRule;
    return this.resyncFollows[r];
  }
  // It does not make any sense to include a virtual EOF token in the list of resynced tokens
  // as EOF does not really exist and thus does not contain any useful information (line/column numbers)
  addToResyncTokens(e, r) {
    return this.tokenMatcher(e, Jr) || r.push(e), r;
  }
  reSyncTo(e) {
    const r = [];
    let n = this.LA(1);
...
function Y_(t, e, r, n, a, i, o) {
  const u = this.getKeyForAutomaticLookahead(n, a);
  let l = this.firstAfterRepMap[u];
  if (l === void 0) {
    const p = this.getCurrRuleFullName(), h = this.getGAstProductions()[p];
    l = new i(h, a).startWalking(), this.firstAfterRepMap[u] = l;
  }
  let c = l.token, f = l.occurrence;
  const d = l.isEndOfRule;
  this.RULE_STACK.length === 1 && d && c === void 0 && (c = Jr, f = 1), !(c === void 0 || f === void 0) && this.shouldInRepetitionRecoveryBeTried(c, f, o) && this.tryInRepetitionRecovery(t, e, r, c);
}
s(Y_, "attemptInRepetitionRecovery");
var F1 = 4, nn = 8, X_ = 1 << nn, J_ = 2 << nn, Om = 3 << nn, Lm = 4 << nn, Dm = 5 << nn, Lc = 6 << nn;
function Dc(t, e, r) {
  return r | e | t;
}
s(Dc, "getKeyForAutomaticLookahead");
var ji, ig = (ji = class {
  constructor(e) {
    var r;
    this.maxLookahead = (r = e == null ? void 0 : e.maxLookahead) !== null && r !== void 0 ? r : Or.maxLookahead;
  }
  validate(e) {
  ...
  validateNoLeftRecursion(e) {
    return Mt(e, (r) => ng(r, r, Ln));
  }
  validateEmptyOrAlternatives(e) {
    return Mt(e, (r) => O_(r, Ln));
  }
  validateAmbiguousAlternationAlternatives(e, r) {
    return Mt(e, (n) => L_(n, r, Ln));
  }
  validateSomeNonEmptyLookaheadPath(e, r) {
    return x_(e, r, Ln);
  }
  buildLookaheadForAlternation(e) {
    return $_(e.prodOccurrence, e.rule, e.maxLookahead, e.hasPredicates, e.dynamicTokensEnabled, A_);
  }
  buildLookaheadForOptional(e) {
    return R_(e.prodOccurrence, e.rule, e.maxLookahead, e.dynamicTokensEnabled, md(e.prodType), E_);
  }
}, s(ji, "LLkLookaheadStrategy"), ji), Bi, z1 = (Bi = class {
  initLooksAhead(e) {
    this.dynamicTokensEnabled = K(e, "dynamicTokensEnabled") ? e.dynamicTokensEnabled : Or.dynamicTokensEnabled, this.maxLookahead = K(e, "maxLookahead") ? e.maxLookahead : Or.maxLookahead, this.lookaheadStrategy = K(e, "lookaheadStrategy") ? e.lookaheadStrategy : new ig({ maxLookahead: this.maxLookahead }), this.lookAheadFuncsCache = /* @__PURE__ */ new Map();
  }
  preComputeLookaheadFunctions(e) {
    q(e, (r) => {
      this.TRACE_INIT(`${r.name} Rule Lookahead`, () => {
        const { alternation: n, repetition: a, option: i, repetitionMandatory: o, repetitionMandatoryWithSeparator: u, repetitionWithSeparator: l } = Z_(r);
        q(n, (c) => {
          ...
          this.TRACE_INIT(`${Ut(c)}${f}`, () => {
            ...
            }), p = Dc(this.fullRuleNameToShort[r.name], X_, c.idx);
            this.setLaFuncCache(p, d);
          });
        }), q(a, (c) => {
          this.computeLookaheadFunc(r, c.idx, Om, "Repetition", c.maxLookahead, Ut(c));
        }), q(i, (c) => {
          this.computeLookaheadFunc(r, c.idx, J_, "Option", c.maxLookahead, Ut(c));
        }), q(o, (c) => {
          this.computeLookaheadFunc(r, c.idx, Lm, "RepetitionMandatory", c.maxLookahead, Ut(c));
        }), q(u, (c) => {
          this.computeLookaheadFunc(r, c.idx, Lc, "RepetitionMandatoryWithSeparator", c.maxLookahead, Ut(c));
        }), q(l, (c) => {
          this.computeLookaheadFunc(r, c.idx, Dm, "RepetitionWithSeparator", c.maxLookahead, Ut(c));
        });
      });
    });
  }
  computeLookaheadFunc(e, r, n, a, i, o) {
    this.TRACE_INIT(`${o}${r === 0 ? "" : r}`, () => {
      const u = this.lookaheadStrategy.buildLookaheadForOptional({
        ...
        dynamicTokensEnabled: this.dynamicTokensEnabled,
        prodType: a
      }), l = Dc(this.fullRuleNameToShort[e.name], n, r);
...
}, s(Bi, "LooksAhead"), Bi), Ui, j1 = (Ui = class extends ol {
  constructor() {
...
}, s(Ui, "DslMethodsCollectorVisitor"), Ui), sc = new j1();
function Z_(t) {
  sc.reset(), t.accept(sc);
  const e = sc.dslMethods;
  return sc.reset(), e;
}
s(Z_, "collectMethods");
function xm(t, e) {
...
s(xm, "setNodeLocationOnlyOffset");
function Mm(t, e) {
...
s(rS, "createBaseSemanticVisitorConstructor");
function nS(t, e, r) {
  const n = /* @__PURE__ */ s(function() {
  }, "derivedConstructor");
  sg(n, t + "BaseSemanticsWithDefaults");
  const a = Object.create(r.prototype);
  return q(e, (i) => {
    a[i] = tS;
  }), n.prototype = a, n.prototype.constructor = n, n;
}
s(nS, "createBaseVisitorConstructorWithDefaults");
var Gm;
(function(t) {
...
var Ki, U1 = (Ki = class {
  ...
  cstPostTerminal(e, r) {
    ...
    Q_(n, r, e), this.setNodeLocationFromToken(n.location, r);
  }
  cstPostNonTerminal(e, r) {
    const n = this.CST_STACK[this.CST_STACK.length - 1];
    eS(n, r, e), this.setNodeLocationFromNode(n.location, e.location);
  }
  getBaseCstVisitorConstructor() {
    if (Pr(this.baseCstVisitorConstructor)) {
      const e = rS(this.className, It(this.gastProductionsCache));
  ...
  getBaseCstVisitorConstructorWithDefaults() {
    if (Pr(this.baseCstVisitorWithDefaultsConstructor)) {
      const e = nS(this.className, It(this.gastProductionsCache), this.getBaseCstVisitorConstructor());
...
}, s(Ki, "TreeBuilder"), Ki), Wi, K1 = (Wi = class {
  initLexerAdapter() {
  ...
  SKIP_TOKEN() {
    return this.currIdx <= this.tokVector.length - 2 ? (this.consumeToken(), this.LA(1)) : Tf;
  }
  // Lexer (accessing Token vector) related methods which can be overridden to implement lazy lexers
  // or lexers dependent on parser context.
  LA(e) {
    const r = this.currIdx + e;
    return r < 0 || this.tokVectorLength <= r ? Tf : this.tokVector[r];
  }
  consumeToken() {
    this.currIdx++;
  }
...
}, s(Wi, "LexerAdapter"), Wi), qi, W1 = (qi = class {
  ACTION(e) {
    return e.call(this);
  }
  consume(e, r, n) {
  ...
  RULE(e, r, n = $f) {
    if (gt(this.definedRulesNames, e)) {
      const o = {
        message: Ln.buildDuplicateRuleNameError({
          topLevelRule: e,
  ...
  OVERRIDE_RULE(e, r, n = $f) {
    const a = k_(e, this.definedRulesNames, this.className);
  ...
  getSerializedGastProductions() {
    return wb(Ke(this.gastProductionsCache));
  }
}, s(qi, "RecognizerApi"), qi), Vi, q1 = (Vi = class {
  initRecognizerEngine(e, r) {
    ...
    else if (K(e, "modes") && Ht(Vt(Ke(e.modes)), y_)) {
      const i = Vt(Ke(e.modes)), o = By(i);
    ...
    const n = K(e, "modes") ? Vt(Ke(e.modes)) : Ke(e), a = Ht(n, (i) => Ae(i.categoryMatches));
    this.tokenMatcher = a ? _u : ul, cl(Ke(this.tokensMap));
  }
  defineRule(e, r, n) {
    if (this.selfAnalysisDone)
      throw Error(`Grammar rule <${e}> may not be defined after the 'performSelfAnalysis' method has been called'
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
    const a = K(n, "resyncEnabled") ? n.resyncEnabled : $f.resyncEnabled, i = K(n, "recoveryValueFunc") ? n.recoveryValueFunc : $f.recoveryValueFunc, o = this.ruleShortNameIdx << F1 + nn;
  ...
  atLeastOneInternalLogic(e, r, n) {
    ...
    if (a.call(this) === !0) {
      ...
      throw this.raiseEarlyExitException(e, ke.REPETITION_MANDATORY, r.ERR_MSG);
    this.attemptInRepetitionRecovery(this.atLeastOneInternal, [e, r], a, Lm, e, N1);
  }
  ...
  atLeastOneSepFirstInternalLogic(e, r, n) {
    ...
    if (this.getLaFuncFromCache(n).call(this) === !0) {
      ...
      throw this.raiseEarlyExitException(e, ke.REPETITION_MANDATORY_WITH_SEPARATOR, r.ERR_MSG);
  }
  manyInternal(e, r) {
  ...
  manySepFirstInternal(e, r) {
    const n = this.getKeyForAutomaticLookahead(Dm, e);
  ...
  orInternal(e, r) {
    const n = this.getKeyForAutomaticLookahead(X_, r), a = se(e) ? e : e.DEF, o = this.getLaFuncFromCache(n).call(this, a);
    if (o !== void 0)
  ...
  subruleInternalError(e, r, n) {
    throw Su(e) && e.partialCstResult !== void 0 && (this.cstPostNonTerminal(e.partialCstResult, r !== void 0 && r.LABEL !== void 0 ? r.LABEL : n), delete e.partialCstResult), e;
  }
...
}, s(Vi, "RecognizerEngine"), Vi), Hi, V1 = (Hi = class {
  initErrorHandler(e) {
  ...
  raiseEarlyExitException(e, r, n) {
    const a = this.getCurrRuleFullName(), i = this.getGAstProductions()[a], u = ec(e, i, r, this.maxLookahead)[0], l = [];
  ...
  raiseNoAltException(e, r) {
    const n = this.getCurrRuleFullName(), a = this.getGAstProductions()[n], i = Qu(e, a, this.maxLookahead), o = [];
    ...
    throw this.SAVE_ERROR(new L1(l, this.LA(1), u));
  }
}, s(Hi, "ErrorHandler"), Hi), Yi, H1 = (Yi = class {
  initContentAssist() {
  }
  computeContentAssist(e, r) {
    ...
    return Qy([n], r, this.tokenMatcher, this.maxLookahead);
  }
  // TODO: should this be a member method or a utility? it does not have any state or usage of 'this'...
  // TODO: should this be more explicitly part of the public API?
  getNextPossibleTokenTypes(e) {
    const r = Xt(e.ruleStack), a = this.getGAstProductions()[r];
    return new w1(a, e).startWalking();
  }
}, s(Yi, "ContentAssist"), Yi), yd = {
  description: "This Object indicates the Parser is during Recording Phase"
};
Object.freeze(yd);
var Zv = !0, Qv = Math.pow(2, nn) - 1, sS = Xa({ name: "RECORDING_PHASE_TOKEN", pattern: dt.NA });
cl([sS]);
var oS = Zu(
  sS,
...
var Y1 = {
  ...
  topLevelRuleRecord(e, r) {
    try {
      const n = new sl({ definition: [], name: e });
  ...
  optionInternalRecord(e, r) {
    return Na.call(this, at, e, r);
  }
  atLeastOneInternalRecord(e, r) {
    Na.call(this, kt, r, e);
  }
  atLeastOneSepFirstInternalRecord(e, r) {
    Na.call(this, Ot, r, e, Zv);
  }
  manyInternalRecord(e, r) {
    Na.call(this, xe, r, e);
  }
  manySepFirstInternalRecord(e, r) {
    Na.call(this, bt, r, e, Zv);
  }
  orInternalRecord(e, r) {
    return lS.call(this, e, r);
  }
  subruleInternalRecord(e, r, n) {
    if (wu(r), !e || K(e, "ruleName") === !1) {
      const u = new Error(`<SUBRULE${Fm(r)}> argument is invalid expecting a Parser method reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      throw u.KNOWN_RECORDER_ERROR = !0, u;
    }
    const a = Bn(this.recordingProdStack), i = e.ruleName, o = new mt({
      idx: r,
      nonTerminalName: i,
    ...
    return a.definition.push(o), this.outputCst ? Y1 : yd;
  }
  consumeInternalRecord(e, r, n) {
    if (wu(r), !Xy(e)) {
      const o = new Error(`<CONSUME${Fm(r)}> argument is invalid expecting a TokenType reference but got: <${JSON.stringify(e)}>
 inside top level rule: <${this.recordingProdStack[0].name}>`);
      throw o.KNOWN_RECORDER_ERROR = !0, o;
    }
    const a = Bn(this.recordingProdStack), i = new we({
      idx: r,
      terminalType: e,
      label: n == null ? void 0 : n.LABEL
    });
    return a.definition.push(i), oS;
  }
}, s(Xi, "GastRecorder"), Xi);
function Na(t, e, r, n = !1) {
  wu(r);
  const a = Bn(this.recordingProdStack), i = Mr(e) ? e : e.DEF, o = new t({ definition: [], idx: r });
  return n && (o.separator = e.SEP), K(e, "MAX_LOOKAHEAD") && (o.maxLookahead = e.MAX_LOOKAHEAD), this.recordingProdStack.push(o), i.call(this), a.definition.push(o), this.recordingProdStack.pop(), yd;
}
s(Na, "recordProd");
function lS(t, e) {
  wu(e);
  const r = Bn(this.recordingProdStack), n = se(t) === !1, a = n === !1 ? t : t.DEF, i = new _t({
    definition: [],
    idx: e,
    ignoreAmbiguities: n && t.IGNORE_AMBIGUITIES === !0
  });
  K(t, "MAX_LOOKAHEAD") && (i.maxLookahead = t.MAX_LOOKAHEAD);
  const o = Eb(a, (u) => Mr(u.GATE));
...
function wu(t) {
  if (t < 0 || t > Qv) {
	...
	Idx value must be a none negative value smaller than ${Qv + 1}`
    );
    throw e.KNOWN_RECORDER_ERROR = !0, e;
  }
}
s(wu, "assertMethodIdxIsValid");
var Ji, J1 = (Ji = class {
  ...
  TRACE_INIT(e, r) {
    if (this.traceInitPerf === !0) {
      ...
      const { time: a, value: i } = Ky(r), o = a > 10 ? console.warn : console.log;
...
s(uS, "applyMixins");
var Tf = Zu(Jr, "", NaN, NaN, NaN, NaN, NaN, NaN);
Object.freeze(Tf);
  ...
  performSelfAnalysis() {
    this.TRACE_INIT("performSelfAnalysis", () => {
      ...
      if (this.TRACE_INIT("Grammar Resolving", () => {
        ...
        const a = Db(Ke(this.gastProductionsCache));
      ...
      })), !Fn.DEFER_DEFINITION_ERRORS_HANDLING && !Ae(this.definitionErrors))
...
og.DEFER_DEFINITION_ERRORS_HANDLING = !1;
uS(og, [
  G1,
  z1,
  U1,
...
var Zi, Z1 = (Zi = class extends og {
  constructor(e, r = Or) {
    const n = it(r);
    n.outputCst = !1, super(e, n);
  }
}, s(Zi, "EmbeddedActionsParser"), Zi);
function cS(t, e) {
  for (var r = -1, n = t == null ? 0 : t.length, a = Array(n); ++r < n; )
    a[r] = e(t[r], r, t);
  return a;
...
s(hS, "assocIndexOf");
var gd = hS, eG = Array.prototype, tG = eG.splice;
function yS(t) {
  var e = this.__data__, r = gd(e, t);
  if (r < 0)
    return !1;
  var n = e.length - 1;
  return r == n ? e.pop() : tG.call(e, r, 1), --this.size, !0;
}
s(yS, "listCacheDelete");
var rG = yS;
function gS(t) {
  var e = this.__data__, r = gd(e, t);
  return r < 0 ? void 0 : e[r][1];
...
var nG = gS;
function vS(t) {
  return gd(this.__data__, t) > -1;
}
s(vS, "listCacheHas");
var aG = vS;
function TS(t, e) {
  var r = this.__data__, n = gd(r, t);
  return n < 0 ? (++this.size, r.push([t, e])) : r[n][1] = e, this;
}
s(TS, "listCacheSet");
var iG = TS;
...
s(ia, "ListCache");
ia.prototype.clear = Q1;
ia.prototype.delete = rG;
ia.prototype.get = nG;
ia.prototype.has = aG;
ia.prototype.set = iG;
var vd = ia;
...
s(ES, "stackHas");
var uG = ES, cG = typeof global == "object" && global && global.Object === Object && global, CS = cG, fG = typeof self == "object" && self && self.Object === Object && self, dG = CS || fG || Function("return this")(), Gr = dG, pG = Gr.Symbol, dr = pG, bS = Object.prototype, mG = bS.hasOwnProperty, hG = bS.toString, Ol = dr ? dr.toStringTag : void 0;
function _S(t) {
  var e = mG.call(t, Ol), r = t[Ol];
  try {
    t[Ol] = void 0;
    var n = !0;
  } catch {
...
s(_S, "getRawTag");
var yG = _S, gG = Object.prototype, vG = gG.toString;
function SS(t) {
  return vG.call(t);
}
s(SS, "objectToString");
var TG = SS, $G = "[object Null]", RG = "[object Undefined]", eT = dr ? dr.toStringTag : void 0;
function wS(t) {
  return t == null ? t === void 0 ? RG : $G : eT && eT in Object(t) ? yG(t) : TG(t);
}
s(wS, "baseGetTag");
var fl = wS;
function IS(t) {
...
s(IS, "isObject");
var lg = IS, AG = "[object AsyncFunction]", EG = "[object Function]", CG = "[object GeneratorFunction]", bG = "[object Proxy]";
function NS(t) {
  if (!lg(t))
    return !1;
  var e = fl(t);
  return e == EG || e == CG || e == AG || e == bG;
}
s(NS, "isFunction");
var PS = NS, _G = Gr["__core-js_shared__"], Vd = _G, tT = function() {
...
s(kS, "isMasked");
var SG = kS, wG = Function.prototype, IG = wG.toString;
function OS(t) {
  if (t != null) {
    try {
      return IG.call(t);
...
s(OS, "toSource");
var sa = OS, NG = /[\\^$.*+?()[\]{}|]/g, PG = /^\[object .+?Constructor\]$/, kG = Function.prototype, OG = Object.prototype, LG = kG.toString, DG = OG.hasOwnProperty, xG = RegExp(
  "^" + LG.call(DG).replace(NG, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function LS(t) {
  if (!lg(t) || SG(t))
    return !1;
...
function xS(t, e) {
  var r = GG(t, e);
  return MG(r) ? r : void 0;
}
s(xS, "getNative");
var dl = xS, FG = dl(Gr, "Map"), Iu = FG, zG = dl(Object, "create"), Nu = zG;
function MS() {
...
s(GS, "hashDelete");
var BG = GS, UG = "__lodash_hash_undefined__", KG = Object.prototype, WG = KG.hasOwnProperty;
function FS(t) {
  var e = this.__data__;
  if (Nu) {
    var r = e[t];
  ...
  return WG.call(e, t) ? e[t] : void 0;
}
s(FS, "hashGet");
var qG = FS, VG = Object.prototype, HG = VG.hasOwnProperty;
function zS(t) {
  var e = this.__data__;
  return Nu ? e[t] !== void 0 : HG.call(e, t);
}
s(zS, "hashHas");
var YG = zS, XG = "__lodash_hash_undefined__";
function jS(t, e) {
  var r = this.__data__;
  return this.size += this.has(t) ? 0 : 1, r[t] = Nu && e === void 0 ? XG : e, this;
}
s(jS, "hashSet");
var JG = jS;
function oa(t) {
...
s(oa, "Hash");
oa.prototype.clear = jG;
oa.prototype.delete = BG;
oa.prototype.get = qG;
oa.prototype.has = YG;
oa.prototype.set = JG;
var rT = oa;
...
function KS(t, e) {
  var r = t.__data__;
  return QG(e) ? r[typeof e == "string" ? "string" : "hash"] : r.map;
}
s(KS, "getMapData");
var Td = KS;
function WS(t) {
...
s(la, "MapCache");
la.prototype.clear = ZG;
la.prototype.delete = eF;
la.prototype.get = tF;
la.prototype.has = rF;
la.prototype.set = nF;
var $d = la, aF = 200;
...
s(ua, "Stack");
ua.prototype.clear = sG;
ua.prototype.delete = oG;
ua.prototype.get = lG;
ua.prototype.has = uG;
ua.prototype.set = iF;
var xc = ua, sF = "__lodash_hash_undefined__";
function XS(t) {
...
function Pu(t) {
  var e = -1, r = t == null ? 0 : t.length;
  for (this.__data__ = new $d(); ++e < r; )
    this.add(t[e]);
}
s(Pu, "SetCache");
Pu.prototype.add = Pu.prototype.push = oF;
Pu.prototype.has = lF;
var ZS = Pu;
function QS(t, e) {
  for (var r = -1, n = t == null ? 0 : t.length; ++r < n; )
...
s(ew, "cacheHas");
var tw = ew, cF = 1, fF = 2;
function rw(t, e, r, n, a, i) {
  var o = r & cF, u = t.length, l = e.length;
  if (u != l && !(o && l > u))
    return !1;
  var c = i.get(t), f = i.get(e);
  if (c && f)
    return c == e && f == t;
  var d = -1, p = !0, h = r & fF ? new ZS() : void 0;
  for (i.set(t, e), i.set(e, t); ++d < u; ) {
    var y = t[d], v = e[d];
    if (n)
      var E = o ? n(v, y, d, e, t, i) : n(y, v, d, t, e, i);
    ...
    if (h) {
      if (!uF(e, function(T, w) {
        if (!tw(h, w) && (y === T || a(y, T, r, n, i)))
          return h.push(w);
      })) {
        p = !1;
        break;
...
s(rw, "equalArrays");
var nw = rw, dF = Gr.Uint8Array, nT = dF;
function aw(t) {
  var e = -1, r = Array(t.size);
  return t.forEach(function(n, a) {
    r[++e] = [a, n];
...
s(iw, "setToArray");
var ug = iw, mF = 1, hF = 2, yF = "[object Boolean]", gF = "[object Date]", vF = "[object Error]", TF = "[object Map]", $F = "[object Number]", RF = "[object RegExp]", AF = "[object Set]", EF = "[object String]", CF = "[object Symbol]", bF = "[object ArrayBuffer]", _F = "[object DataView]", aT = dr ? dr.prototype : void 0, Hd = aT ? aT.valueOf : void 0;
function sw(t, e, r, n, a, i, o) {
  switch (r) {
    case _F:
      if (t.byteLength != e.byteLength || t.byteOffset != e.byteOffset)
        return !1;
    ...
    case AF:
      var l = n & mF;
      if (u || (u = ug), t.size != e.size && !l)
        return !1;
      var c = o.get(t);
      if (c)
        return c == e;
      n |= hF, o.set(t, e);
      var f = nw(u(t), u(e), n, a, i, o);
      return o.delete(t), f;
    case CF:
      if (Hd)
...
s(ow, "arrayPush");
var lw = ow, wF = Array.isArray, yt = wF;
function uw(t, e, r) {
  var n = e(t);
  return yt(t) ? n : lw(n, r(t));
}
s(uw, "baseGetAllKeys");
var IF = uw;
function cw(t, e) {
...
s(dw, "stubArray");
var NF = dw, PF = Object.prototype, kF = PF.propertyIsEnumerable, iT = Object.getOwnPropertySymbols, OF = iT ? function(t) {
  return t == null ? [] : (t = Object(t), fw(iT(t), function(e) {
    return kF.call(t, e);
  }));
} : NF, LF = OF;
function pw(t, e) {
...
s(mw, "isObjectLike");
var tl = mw, xF = "[object Arguments]";
function hw(t) {
  return tl(t) && fl(t) == xF;
}
s(hw, "baseIsArguments");
var sT = hw, yw = Object.prototype, MF = yw.hasOwnProperty, GF = yw.propertyIsEnumerable, FF = sT(/* @__PURE__ */ function() {
  return arguments;
}()) ? sT : function(t) {
  return tl(t) && MF.call(t, "callee") && !GF.call(t, "callee");
}, Rd = FF;
function gw() {
  return !1;
}
s(gw, "stubFalse");
var zF = gw, vw = typeof exports == "object" && exports && !exports.nodeType && exports, oT = vw && typeof module == "object" && module && !module.nodeType && module, jF = oT && oT.exports === vw, lT = jF ? Gr.Buffer : void 0, BF = lT ? lT.isBuffer : void 0, UF = BF || zF, Rf = UF, KF = 9007199254740991, WF = /^(?:0|[1-9]\d*)$/;
function Tw(t, e) {
  var r = typeof t;
  return e = e ?? KF, !!e && (r == "number" || r != "symbol" && WF.test(t)) && t > -1 && t % 1 == 0 && t < e;
}
s(Tw, "isIndex");
var $w = Tw, qF = 9007199254740991;
function Rw(t) {
  return typeof t == "number" && t > -1 && t % 1 == 0 && t <= qF;
}
s(Rw, "isLength");
var cg = Rw, VF = "[object Arguments]", HF = "[object Array]", YF = "[object Boolean]", XF = "[object Date]", JF = "[object Error]", ZF = "[object Function]", QF = "[object Map]", ez = "[object Number]", tz = "[object Object]", rz = "[object RegExp]", nz = "[object Set]", az = "[object String]", iz = "[object WeakMap]", sz = "[object ArrayBuffer]", oz = "[object DataView]", lz = "[object Float32Array]", uz = "[object Float64Array]", cz = "[object Int8Array]", fz = "[object Int16Array]", dz = "[object Int32Array]", pz = "[object Uint8Array]", mz = "[object Uint8ClampedArray]", hz = "[object Uint16Array]", yz = "[object Uint32Array]", Se = {};
Se[lz] = Se[uz] = Se[cz] = Se[fz] = Se[dz] = Se[pz] = Se[mz] = Se[hz] = Se[yz] = !0;
Se[VF] = Se[HF] = Se[sz] = Se[YF] = Se[oz] = Se[XF] = Se[JF] = Se[ZF] = Se[QF] = Se[ez] = Se[tz] = Se[rz] = Se[nz] = Se[az] = Se[iz] = !1;
function Aw(t) {
  return tl(t) && cg(t.length) && !!Se[fl(t)];
}
s(Aw, "baseIsTypedArray");
var gz = Aw;
function Ew(t) {
  return function(e) {
    return t(e);
...
s(Ew, "baseUnary");
var vz = Ew, Cw = typeof exports == "object" && exports && !exports.nodeType && exports, hu = Cw && typeof module == "object" && module && !module.nodeType && module, Tz = hu && hu.exports === Cw, Yd = Tz && CS.process, $z = function() {
  try {
    var t = hu && hu.require && hu.require("util").types;
    return t || Yd && Yd.binding && Yd.binding("util");
  } catch {
  }
}(), uT = $z, cT = uT && uT.isTypedArray, Rz = cT ? vz(cT) : gz, fg = Rz, Az = Object.prototype, Ez = Az.hasOwnProperty;
function bw(t, e) {
  var r = yt(t), n = !r && Rd(t), a = !r && !n && Rf(t), i = !r && !n && !a && fg(t), o = r || n || a || i, u = o ? DF(t.length, String) : [], l = u.length;
  for (var c in t)
    (e || Ez.call(t, c)) && !(o && // Safari 9 has enumerable `arguments.length` in strict mode.
    (c == "length" || // Node.js 0.10 has enumerable non-index properties on buffers.
    a && (c == "offset" || c == "parent") || // PhantomJS 2 has enumerable non-index properties on typed arrays.
    i && (c == "buffer" || c == "byteLength" || c == "byteOffset") || // Skip index properties.
    $w(c, l))) && u.push(c);
...
s(bw, "arrayLikeKeys");
var Cz = bw, bz = Object.prototype;
function _w(t) {
  var e = t && t.constructor, r = typeof e == "function" && e.prototype || bz;
  return t === r;
}
s(_w, "isPrototype");
var Sw = _w;
...
s(ww, "overArg");
var _z = ww, Sz = _z(Object.keys, Object), wz = Sz, Iz = Object.prototype, Nz = Iz.hasOwnProperty;
function Iw(t) {
  if (!Sw(t))
    return wz(t);
  var e = [];
  for (var r in Object(t))
    Nz.call(t, r) && r != "constructor" && e.push(r);
  return e;
}
s(Iw, "baseKeys");
var Nw = Iw;
function Pw(t) {
  return t != null && cg(t.length) && !PS(t);
}
s(Pw, "isArrayLike");
var Ad = Pw;
function kw(t) {
  return Ad(t) ? Cz(t) : Nw(t);
}
s(kw, "keys");
var dg = kw;
function Ow(t) {
...
s(Ow, "getAllKeys");
var fT = Ow, Pz = 1, kz = Object.prototype, Oz = kz.hasOwnProperty;
function Lw(t, e, r, n, a, i) {
  var o = r & Pz, u = fT(t), l = u.length, c = fT(e), f = c.length;
  if (l != f && !o)
    return !1;
  for (var d = l; d--; ) {
    var p = u[d];
    if (!(o ? p in e : Oz.call(e, p)))
      return !1;
  }
  var h = i.get(t), y = i.get(e);
  if (h && y)
...
s(Lw, "equalObjects");
var Lz = Lw, Dz = dl(Gr, "DataView"), jm = Dz, xz = dl(Gr, "Promise"), Bm = xz, Mz = dl(Gr, "Set"), Ja = Mz, Gz = dl(Gr, "WeakMap"), Um = Gz, dT = "[object Map]", Fz = "[object Object]", pT = "[object Promise]", mT = "[object Set]", hT = "[object WeakMap]", yT = "[object DataView]", zz = sa(jm), jz = sa(Iu), Bz = sa(Bm), Uz = sa(Ja), Kz = sa(Um), yn = fl;
(jm && yn(new jm(new ArrayBuffer(1))) != yT || Iu && yn(new Iu()) != dT || Bm && yn(Bm.resolve()) != pT || Ja && yn(new Ja()) != mT || Um && yn(new Um()) != hT) && (yn = /* @__PURE__ */ s(function(t) {
  var e = fl(t), r = e == Fz ? t.constructor : void 0, n = r ? sa(r) : "";
  if (n)
    switch (n) {
      case zz:
        return yT;
...
var Km = yn, Wz = 1, gT = "[object Arguments]", vT = "[object Array]", oc = "[object Object]", qz = Object.prototype, TT = qz.hasOwnProperty;
function Dw(t, e, r, n, a, i) {
  var o = yt(t), u = yt(e), l = o ? vT : Km(t), c = u ? vT : Km(e);
  l = l == gT ? oc : l, c = c == gT ? oc : c;
  var f = l == oc, d = c == oc, p = l == c;
  if (p && Rf(t)) {
    if (!Rf(e))
      return !1;
    o = !0, f = !1;
  ...
  if (p && !f)
    return i || (i = new xc()), o || fg(t) ? nw(t, e, r, n, a, i) : SF(t, e, l, r, n, a, i);
  if (!(r & Wz)) {
    var h = f && TT.call(t, "__wrapped__"), y = d && TT.call(e, "__wrapped__");
    if (h || y) {
      var v = h ? t.value() : t, E = y ? e.value() : e;
      return i || (i = new xc()), a(v, E, r, n, i);
    }
  }
  return p ? (i || (i = new xc()), Lz(t, e, r, n, a, i)) : !1;
}
s(Dw, "baseIsEqualDeep");
var Vz = Dw;
function pg(t, e, r, n, a) {
  return t === e ? !0 : t == null || e == null || !tl(t) && !tl(e) ? t !== t && e !== e : Vz(t, e, r, n, pg, a);
}
s(pg, "baseIsEqual");
var xw = pg, Hz = 1, Yz = 2;
function Mw(t, e, r, n) {
  ...
  for (; ++a < i; ) {
    ...
    if (o && u[2]) {
      ...
      if (n)
        var p = n(c, f, l, t, e, d);
      if (!(p === void 0 ? xw(f, c, Hz | Yz, n, d) : p))
        return !1;
    }
  }
  return !0;
...
s(jw, "matchesStrictComparable");
var Bw = jw;
function Uw(t) {
  var e = Jz(t);
  return e.length == 1 && e[0][2] ? Bw(e[0][0], e[0][1]) : function(r) {
    return r === t || Xz(r, t, e);
  };
}
s(Uw, "baseMatches");
var Zz = Uw, Qz = "[object Symbol]";
function Kw(t) {
  return typeof t == "symbol" || tl(t) && fl(t) == Qz;
}
s(Kw, "isSymbol");
var Ed = Kw, ej = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, tj = /^\w*$/;
function Ww(t, e) {
  if (yt(t))
    return !1;
  var r = typeof t;
  return r == "number" || r == "symbol" || r == "boolean" || t == null || Ed(t) ? !0 : tj.test(t) || !ej.test(t) || e != null && t in Object(e);
}
s(Ww, "isKey");
var mg = Ww, rj = "Expected a function";
function Cd(t, e) {
  if (typeof t != "function" || e != null && typeof e != "function")
    throw new TypeError(rj);
  var r = /* @__PURE__ */ s(function() {
    var n = arguments, a = e ? e.apply(this, n) : n[0], i = r.cache;
    if (i.has(a))
      return i.get(a);
  ...
  return r.cache = new (Cd.Cache || $d)(), r;
}
s(Cd, "memoize");
Cd.Cache = $d;
var nj = Cd, aj = 500;
function qw(t) {
  var e = nj(t, function(n) {
    return r.size === aj && r.clear(), n;
  }), r = e.cache;
  return e;
}
s(qw, "memoizeCapped");
var ij = qw, sj = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, oj = /\\(\\)?/g, lj = ij(function(t) {
  var e = [];
  return t.charCodeAt(0) === 46 && e.push(""), t.replace(sj, function(r, n, a, i) {
    e.push(a ? i.replace(oj, "$1") : n || r);
  }), e;
}), uj = lj, $T = dr ? dr.prototype : void 0, RT = $T ? $T.toString : void 0;
function hg(t) {
  if (typeof t == "string")
    return t;
  if (yt(t))
...
var fj = Vw;
function Hw(t, e) {
  return yt(t) ? t : mg(t, e) ? [t] : uj(fj(t));
}
s(Hw, "castPath");
var Yw = Hw;
function Xw(t) {
...
function tI(t, e, r) {
  ...
  return i || ++n != a ? i : (a = t == null ? 0 : t.length, !!a && cg(a) && $w(o, a) && (yt(t) || Rd(t)));
}
s(tI, "hasPath");
var mj = tI;
function rI(t, e) {
  return t != null && mj(t, e, pj);
}
s(rI, "hasIn");
var hj = rI, yj = 1, gj = 2;
function nI(t, e) {
  return mg(t) && Fw(e) ? Bw(bd(t), e) : function(r) {
    var n = dj(r, t);
    return n === void 0 && n === e ? hj(r, t) : xw(e, n, yj | gj);
  };
}
s(nI, "baseMatchesProperty");
var vj = nI;
function aI(t) {
  return t;
}
...
s(sI, "basePropertyDeep");
var $j = sI;
function oI(t) {
  return mg(t) ? Tj(bd(t)) : $j(t);
}
s(oI, "property");
var Rj = oI;
function lI(t) {
  return typeof t == "function" ? t : t == null ? yg : typeof t == "object" ? yt(t) ? vj(t[0], t[1]) : Zz(t) : Rj(t);
}
s(lI, "baseIteratee");
var _d = lI;
function uI(t) {
...
s(fI, "createBaseEach");
var _j = fI, Sj = _j(bj), Sd = Sj;
function dI(t, e) {
  var r = -1, n = Ad(t) ? Array(t.length) : [];
  return Sd(t, function(a, i, o) {
    n[++r] = e(a, i, o);
  }), n;
}
s(dI, "baseMap");
...
s(Kn, "buildATNKey");
var Zr = 1, Pj = 2, yI = 4, gI = 5, tc = 7, kj = 8, Oj = 9, Lj = 10, Dj = 11, vI = 12, Qi, gg = (Qi = class {
  constructor(e) {
    this.target = e;
  }
  isEpsilon() {
...
}, s(Qi, "AbstractTransition"), Qi), es, vg = (es = class extends gg {
  constructor(e, r) {
    super(e), this.tokenType = r;
  }
}, s(es, "AtomTransition"), es), ts, TI = (ts = class extends gg {
  constructor(e) {
    super(e);
  }
  isEpsilon() {
...
}, s(ts, "EpsilonTransition"), ts), rs, Tg = (rs = class extends gg {
  constructor(e, r, n) {
...
s(RI, "createRuleStartAndStopATNStates");
function $g(t, e, r) {
  return r instanceof we ? wd(t, e, r.terminalType, r) : r instanceof mt ? PI(t, e, r) : r instanceof _t ? _I(t, e, r) : r instanceof at ? SI(t, e, r) : r instanceof xe ? AI(t, e, r) : r instanceof bt ? EI(t, e, r) : r instanceof kt ? CI(t, e, r) : r instanceof Ot ? bI(t, e, r) : an(t, e, r);
}
s($g, "atom");
function AI(t, e, r) {
  const n = We(t, e, r, {
...
function EI(t, e, r) {
  ...
  Fr(t, n);
  const a = ca(t, e, n, r, an(t, e, r)), i = wd(t, e, r.separator, r);
  return Ag(t, e, r, a, i);
}
s(EI, "repetitionSep");
function CI(t, e, r) {
...
s(bI, "repetitionMandatorySep");
function _I(t, e, r) {
  const n = We(t, e, r, {
    type: Zr
  });
  Fr(t, n);
  const a = br(r.definition, (o) => $g(t, e, o));
  return ca(t, e, n, r, ...a);
}
s(_I, "alternation");
function SI(t, e, r) {
...
s(SI, "option");
function an(t, e, r) {
  const n = Nj(br(r.definition, (a) => $g(t, e, a)), (a) => a !== void 0);
  return n.length === 1 ? n[0] : n.length === 0 ? void 0 : NI(t, n);
}
s(an, "block");
function Rg(t, e, r, n, a) {
  ...
  return i.loopback = u, l.loopback = u, t.decisionMap[Kn(e, a ? "RepetitionMandatoryWithSeparator" : "RepetitionMandatory", r.idx)] = u, Fe(o, u), a === void 0 ? (Fe(u, i), Fe(u, l)) : (Fe(u, l), Fe(u, a.left), Fe(a.right, i)), {
    left: i,
    right: l
  };
}
...
function Ag(t, e, r, n, a) {
  ...
  return u.loopback = c, l.loopback = c, Fe(u, i), Fe(u, l), Fe(o, c), a !== void 0 ? (Fe(c, l), Fe(c, a.left), Fe(a.right, i)) : Fe(c, u), t.decisionMap[Kn(e, a ? "RepetitionWithSeparator" : "Repetition", r.idx)] = u, {
    left: u,
    right: l
  };
}
...
function wI(t, e, r, n) {
  ...
  return Fe(a, i), t.decisionMap[Kn(e, "Option", r.idx)] = a, n;
}
s(wI, "optional");
function Fr(t, e) {
...
function ca(t, e, r, n, ...a) {
  ...
  return t.decisionMap[Kn(e, II(n), n.idx)] = r, o;
}
s(ca, "makeAlts");
function II(t) {
  if (t instanceof _t)
...
function NI(t, e) {
  ...
  for (let i = 0; i < r - 1; i++) {
    ...
    const l = u instanceof Tg, c = u, f = e[i + 1].left;
    o.left.type === Zr && o.right.type === Zr && u !== void 0 && (l && c.followState === o.right || u.target === o.right) ? (l ? c.followState = f : u.target = f, OI(t, o.right)) : Fe(o.right, f);
  }
  const n = e[0], a = e[r - 1];
  return {
    left: n.left,
...
var Mj = DI;
function xI(t) {
  return t && t.length ? xj(t, yg, Mj) : void 0;
}
s(xI, "min");
var Gj = xI, AT = dr ? dr.isConcatSpreadable : void 0;
function MI(t) {
  return yt(t) || Rd(t) || !!(AT && t && t[AT]);
}
s(MI, "isFlattenable");
var Fj = MI;
function Cg(t, e, r, n, a) {
  ...
  for (r || (r = Fj), a || (a = []); ++i < o; ) {
    var u = t[i];
    e > 0 && r(u) ? e > 1 ? Cg(u, e - 1, r, n, a) : lw(a, u) : n || (a[a.length] = u);
  }
  return a;
}
s(Cg, "baseFlatten");
...
s(WI, "arrayIncludesWith");
var qj = WI;
function qI() {
}
s(qI, "noop");
var Vj = qI, Hj = 1 / 0, Yj = Ja && 1 / ug(new Ja([, -0]))[1] == Hj ? function(t) {
  return new Ja(t);
} : Vj, Xj = Yj, Jj = 200;
function VI(t, e, r) {
  var n = -1, a = Wj, i = t.length, o = !0, u = [], l = u;
  if (r)
    o = !1, a = qj;
  else if (i >= Jj) {
    var c = e ? null : Xj(t);
...
s(ZI, "forEach");
var Xd = ZI, nB = "[object Map]", aB = "[object Set]", iB = Object.prototype, sB = iB.hasOwnProperty;
function QI(t) {
  if (t == null)
    return !0;
  if (Ad(t) && (yt(t) || typeof t == "string" || typeof t.splice == "function" || Rf(t) || fg(t) || Rd(t)))
    return !t.length;
  var e = Km(t);
  if (e == nB || e == aB)
    return !t.size;
...
var uB = tN;
function rN(t, e, r) {
  var n = yt(t) ? lB : uB, a = arguments.length < 3;
  return n(t, _d(e), r, a, Sd);
}
s(rN, "reduce");
var ET = rN;
function nN(t, e) {
...
var as, aN = (as = class {
...
}, s(as, "PredicateSet"), as), CT = new aN(), is, cB = (is = class extends ig {
  constructor(e) {
    var r;
    super(), this.logging = (r = e == null ? void 0 : e.logging) !== null && r !== void 0 ? r : (n) => console.log(n);
  }
  initialize(e) {
    this.atn = $I(e.rules), this.dfas = iN(this.atn);
  }
  ...
  buildLookaheadForAlternation(e) {
    const { prodOccurrence: r, rule: n, hasPredicates: a, dynamicTokensEnabled: i } = e, o = this.dfas, u = this.logging, l = Kn(n, "Alternation", r), f = this.atn.decisionMap[l].decision, d = br(Pm({
      maxLookahead: 1,
      occurrence: r,
    ...
    if (qm(d, !1) && !i) {
      const p = ET(d, (h, y, v) => (Xd(y, (E) => {
        E && (h[E.tokenTypeIdx] = v, Xd(E.categoryMatches, (T) => {
          h[T] = v;
        }));
      }), h), {});
      return a ? function(h) {
        var y;
        const v = this.LA(1), E = p[v.tokenTypeIdx];
        if (h !== void 0 && E !== void 0) {
          const T = (y = h[E]) === null || y === void 0 ? void 0 : y.GATE;
      ...
      const h = new aN(), y = p === void 0 ? 0 : p.length;
      for (let E = 0; E < y; E++) {
        const T = p == null ? void 0 : p[E].GATE;
        h.set(E, T === void 0 || T.call(this));
      }
      const v = Mc.call(this, o, f, h, u);
      return typeof v == "number" ? v : void 0;
    } : function() {
      const p = Mc.call(this, o, f, CT, u);
      return typeof p == "number" ? p : void 0;
    };
  }
  buildLookaheadForOptional(e) {
    const { prodOccurrence: r, rule: n, prodType: a, dynamicTokensEnabled: i } = e, o = this.dfas, u = this.logging, l = Kn(n, a, r), f = this.atn.decisionMap[l].decision, d = br(Pm({
      maxLookahead: 1,
      occurrence: r,
      prodType: a,
      rule: n
    ...
    if (qm(d) && d[0][0] && !i) {
      const p = d[0], h = eB(p);
      if (h.length === 1 && oB(h[0].categoryMatches)) {
        const v = h[0].tokenTypeIdx;
        return function() {
          return this.LA(1).tokenTypeIdx === v;
        };
      } else {
        const y = ET(h, (v, E) => (E !== void 0 && (v[E.tokenTypeIdx] = !0, Xd(E.categoryMatches, (T) => {
          v[T] = !0;
        })), v), {});
        return function() {
          const v = this.LA(1);
...
}, s(is, "LLStarLookaheadStrategy"), is);
function qm(t, e = !0) {
...
function iN(t) {
  ...
  for (let n = 0; n < e; n++)
    r[n] = nN(t.decisionStates[n], n);
  return r;
}
s(iN, "initATNSimulator");
function Mc(t, e, r, n) {
  const a = t[e](r);
  let i = a.start;
  if (i === void 0) {
    const u = yN(a.atnStartState);
    i = _g(a, bg(u)), a.start = i;
  }
  return sN.apply(this, [a, i, r, n]);
}
s(Mc, "adaptivePredict");
function sN(t, e, r, n) {
  let a = e, i = 1;
  const o = [];
  let u = this.LA(i++);
  for (; ; ) {
    let l = dN(a, u);
    if (l === void 0 && (l = oN.apply(this, [t, a, u, i, r, n])), l === Af)
      return fN(o, a, u);
...
s(sN, "performLookahead");
function oN(t, e, r, n, a, i) {
  const o = pN(e.configs, r, a);
  if (o.size === 0)
    return Vm(t, e, r, Af), Af;
  let u = bg(o);
  const l = hN(o, a);
  if (l !== void 0)
    ...
    const c = Gj(o.alts);
    u.isAcceptState = !0, u.prediction = c, u.configs.uniqueAlt = c, lN.apply(this, [t, n, o.alts, i]);
  }
  return u = Vm(t, e, r, u), u;
}
s(oN, "computeLookaheadTarget");
function lN(t, e, r, n) {
  const a = [];
  for (let c = 1; c <= e; c++)
    a.push(this.LA(c).tokenType);
  const i = t.atnStartState, o = i.rule, u = i.production, l = uN({
    topLevelRule: o,
    ambiguityIndices: r,
    production: u,
    prefixPath: a
...
s(lN, "reportLookaheadAmbiguity");
function uN(t) {
  const e = br(t.prefixPath, (a) => Mn(a)).join(", "), r = t.production.idx === 0 ? "" : t.production.idx;
  let n = `Ambiguous Alternatives Detected: <${t.ambiguityIndices.join(", ")}> in <${cN(t.production)}${r}> inside <${t.topLevelRule.name}> Rule,
<${e}> may appears as a prefix path in all these alternatives.
`;
  return n = n + `See: https://chevrotain.io/docs/guide/resolving_grammar_errors.html#AMBIGUOUS_ALTERNATIVES
For Further details.`, n;
}
s(uN, "buildAmbiguityError");
function cN(t) {
  if (t instanceof mt)
    return "SUBRULE";
  if (t instanceof at)
...
s(cN, "getProductionDslName");
function fN(t, e, r) {
  const n = zj(e.configs.elements, (i) => i.state.transitions), a = Qj(n.filter((i) => i instanceof vg).map((i) => i.tokenType), (i) => i.tokenTypeIdx);
  return {
    actualToken: r,
...
s(fN, "buildAdaptivePredictError");
function dN(t, e) {
  return t.edges[e.tokenTypeIdx];
}
s(dN, "getExistingTargetState");
function pN(t, e, r) {
  const n = new Wm(), a = [];
  for (const o of t.elements) {
    ...
    for (let l = 0; l < u; l++) {
      const c = o.state.transitions[l], f = mN(c, e);
      f !== void 0 && n.add({
        state: f,
        alt: o.alt,
        stack: o.stack
...
s(pN, "computeReachSet");
function mN(t, e) {
  if (t instanceof vg && Zy(e, t.tokenType))
    return t.target;
}
s(mN, "getReachableTarget");
function hN(t, e) {
  let r;
...
s(bg, "newDFAState");
function Vm(t, e, r, n) {
  return n = _g(t, n), e.edges[r.tokenTypeIdx] = n, n;
}
s(Vm, "addDFAEdge");
function _g(t, e) {
  if (e === Af)
...
s(_g, "addDFAState");
function yN(t) {
  const e = new Wm(), r = t.transitions.length;
  for (let n = 0; n < r; n++) {
    const i = {
...
function ku(t, e) {
  ...
  for (let a = 0; a < n; a++) {
    const i = r.transitions[a], o = gN(t, i);
    o !== void 0 && ku(o, e);
  }
}
s(ku, "closure");
...
s(TN, "allConfigsInRuleStopStates");
function $N(t) {
  if (TN(t))
    return !0;
  const e = RN(t.elements);
  return AN(e) && !EN(e);
}
s($N, "hasConflictTerminatingPrediction");
function RN(t) {
  const e = /* @__PURE__ */ new Map();
  for (const r of t) {
    const n = Eg(r, !1);
...
s(EN, "hasStateAssociatedWithOneAlt");
Du();
var ss, CN = (ss = class {
  constructor() {
    this.nodeStack = [];
  ...
  buildLeafNode(e, r) {
    const n = new Ef(e.startOffset, e.image.length, Tu(e), e.tokenType, !r);
  ...
  addHiddenNodes(e) {
    const r = [];
    for (const i of e) {
      const o = new Ef(i.startOffset, i.image.length, Tu(i), i.tokenType, !0);
...
}, s(ss, "CstNodeBuilder"), ss), os, Sg = (os = class {
  get hidden() {
    return !1;
  }
  get astNode() {
...
}, s(os, "AbstractCstNode"), os), ls, Ef = (ls = class extends Sg {
  get offset() {
    return this._offset;
  }
  get length() {
...
}, s(ls, "LeafCstNodeImpl"), ls), us, Nd = (us = class extends Sg {
  constructor() {
    super(...arguments), this.content = new fB(this);
  }
  get offset() {
    var e;
...
}, s(us, "CompositeCstNodeImpl"), us), zn, fB = (zn = class extends Array {
  constructor(e) {
    super(), this.parent = e, Object.setPrototypeOf(this, zn.prototype);
  }
  push(...e) {
...
}, s(zn, "CstNodeContainer"), zn), cs, wg = (cs = class extends Nd {
  get text() {
...
}, s(cs, "RootCstNodeImpl"), cs), Cf = Symbol("Datatype");
function Gc(t) {
  return t.$type === Cf;
}
s(Gc, "isDataTypeNode");
var bT = "​", bN = /* @__PURE__ */ s((t) => t.endsWith(bT) ? t : t + bT, "withRuleSuffix"), fs, Ig = (fs = class {
  constructor(e) {
    var a;
    ...
    (a = e.shared.profilers.LangiumProfiler) != null && a.isActive("parsing") ? this.wrapper = new pB(r, {
      ...e.parser.ParserConfig,
      skipValidations: n,
      errorMessageProvider: e.parser.ParserErrorMessageProvider
    }, e.shared.profilers.LangiumProfiler.createTask("parsing", e.LanguageMetaData.languageId)) : this.wrapper = new IN(r, {
      ...e.parser.ParserConfig,
      skipValidations: n,
      errorMessageProvider: e.parser.ParserErrorMessageProvider
    });
...
}, s(fs, "AbstractLangiumParser"), fs), ds, _N = (ds = class extends Ig {
  get current() {
  ...
  rule(e, r) {
    ...
    let a;
    Xo(e) && (a = e.name, this.registerPrecedenceMap(e));
    const i = this.wrapper.DEFINE_RULE(bN(e.name), this.startImplementation(n, a, r).bind(this));
  ...
  computeRuleType(e) {
    return Xo(e) ? jn(e) : e.fragment ? void 0 : Fu(e) ? Cf : jn(e);
  }
  parse(e, r = {}) {
    ...
    return this.nodeBuilder.addHiddenNodes(n.hidden), this.unorderedGroups.clear(), this.lexerResult = void 0, Ho(i, { deep: !0 }), {
      value: i,
  ...
  startImplementation(e, r, n) {
    return (a) => {
      ...
      if (i) {
        const o = { $type: e };
        this.stack.push(o), e === Cf ? o.value = "" : r !== void 0 && (o.$infixName = r);
      }
  ...
  construct() {
    ...
    return this.nodeBuilder.construct(e), "$infixName" in e ? this.constructInfix(e, this.operatorPrecedence.get(e.$infixName)) : Gc(e) ? this.converter.convert(e.value, e.$cstNode) : (Sh(this.astReflection, e), e);
  }
  constructInfix(e, r) {
    const n = e.parts;
    ...
    for (let v = 0; v < a.length; v++) {
      const E = a[v], T = r.get(E) ?? {
        precedence: 1 / 0,
        rightAssoc: !1
      };
      T.precedence > o ? (o = T.precedence, i = v) : T.precedence === o && (T.rightAssoc || (i = v));
    }
    const u = a.slice(0, i), l = a.slice(i + 1), c = n.slice(0, i + 1), f = n.slice(i + 1), d = {
      ...
      parts: f,
      operators: l
    }, h = this.constructInfix(d, r), y = this.constructInfix(p, r);
    return {
      $type: e.$type,
      $cstNode: e.$cstNode,
      left: h,
  ...
  getAssignment(e) {
    if (!this.assignmentMap.has(e)) {
      ...
      this.assignmentMap.set(e, {
        assignment: r,
        crossRef: r && Yn(r.terminal) ? r.terminal.isMulti ? "multi" : "single" : void 0
      });
    }
...
}, s(ds, "LangiumParser"), ds), ps, SN = (ps = class {
  buildMismatchTokenMessage(e) {
    return Va.buildMismatchTokenMessage(e);
  }
  buildNotAllInputParsedMessage(e) {
    return Va.buildNotAllInputParsedMessage(e);
  }
  buildNoViableAltMessage(e) {
    return Va.buildNoViableAltMessage(e);
  }
  buildEarlyExitMessage(e) {
    return Va.buildEarlyExitMessage(e);
  }
}, s(ps, "AbstractParserErrorMessageProvider"), ps), ms, Ng = (ms = class extends SN {
...
}, s(ms, "LangiumParserErrorMessageProvider"), ms), hs, wN = (hs = class extends Ig {
  constructor() {
  ...
  rule(e, r) {
    const n = this.wrapper.DEFINE_RULE(bN(e.name), this.startImplementation(r).bind(this));
...
}, s(hs, "LangiumCompletionParser"), hs), dB = {
  recoveryEnabled: !0,
  nodeLocationTracking: "full",
  skipValidations: !0,
  errorMessageProvider: new Ng()
}, ys, IN = (ys = class extends Z1 {
  constructor(e, r) {
    const n = r && "maxLookahead" in r;
    super(e, {
      ...dB,
      lookaheadStrategy: n ? new ig({ maxLookahead: r.maxLookahead }) : new cB({
...
}, s(ys, "ChevrotainWrapper"), ys), gs, pB = (gs = class extends IN {
  constructor(e, r, n) {
...
s(Pd, "createParser");
function NN(t, e) {
  const r = qf(e, !1), n = de(e.rules).filter(pt).filter((i) => r.has(i));
  for (const i of n) {
    const o = {
      ...t,
      consume: 1,
  ...
  const a = de(e.rules).filter(Xo).filter((i) => r.has(i));
  for (const i of a)
    t.parser.rule(i, PN(t, i));
}
s(NN, "buildRules");
function PN(t, e) {
  ...
  const n = e.operators.precedences.flatMap((h) => h.operators), a = {
    $type: "Group",
    elements: []
  }, i = {
    $container: a,
  ...
  o.elements.push(l, c);
  const d = n.map((h) => t.tokens[h.value]).map((h, y) => ({
    ALT: /* @__PURE__ */ s(() => t.parser.consume(y, h, l), "ALT")
  }));
  let p;
  return (h) => {
    p ?? (p = kd(t, r)), t.parser.subrule(0, p, !1, i, h), t.parser.many(0, {
      DEF: /* @__PURE__ */ s(() => {
        t.parser.alternatives(0, d), t.parser.subrule(1, p, !1, c, h);
      }, "DEF")
    });
  };
}
...
function Qr(t, e, r = !1) {
  ...
  if (wr(e))
    ...
    const a = t.consume++;
    n = /* @__PURE__ */ s(() => t.parser.consume(a, Jr, e), "method");
  } else
    throw new Uf(e.$cstNode, `Unexpected element type: ${e.$type}`);
  return kg(t, r ? void 0 : Ou(e), n, e.cardinality);
}
s(Qr, "buildElement");
function kN(t, e) {
  const r = jn(e);
...
function ON(t, e) {
  const r = e.rule.ref;
  if (Hn(r)) {
    const n = t.subrule++, a = pt(r) && r.fragment, i = e.arguments.length > 0 ? LN(r, e.arguments) : () => ({});
    let o;
    return (u) => {
      o ?? (o = kd(t, r)), t.parser.subrule(n, o, a, e, i(u));
    };
  } else if (zt(r)) {
    const n = t.consume++, a = bf(t, r.name);
    return () => t.parser.consume(n, a, e);
  } else if (r)
    tn();
  else
    throw new Uf(e.$cstNode, `Undefined rule: ${e.rule.$refText}`);
}
s(ON, "buildRuleCall");
function LN(t, e) {
  ...
  const n = t.or++, a = /* @__PURE__ */ s((u, l) => {
    ...
    f.ALT = () => {
      if (l.ALT(u), !d.isRecording()) {
        ...
        const y = d.unorderedGroups.get(h);
        typeof (y == null ? void 0 : y[c]) > "u" && (y[c] = !0);
      }
    };
    const p = l.GATE;
    return p ? f.GATE = () => p(u) : f.GATE = () => {
      const h = d.unorderedGroups.get(a(n, d));
      return !(h != null && h[c]);
    }, f;
  })), "alternatives"), o = kg(t, Ou(e), i, "*");
  return (u) => {
...
function MN(t, e) {
  const r = e.elements.map((n) => Qr(t, n));
...
function Pg(t, e, r = e.terminal) {
  if (r)
    if (Ir(r) && pt(r.rule.ref)) {
      ...
      let i;
      return (o) => {
        i ?? (i = kd(t, n)), t.parser.subrule(a, i, !1, e, o);
      };
    } else if (Ir(r) && zt(r.rule.ref)) {
      const n = t.consume++, a = bf(t, r.rule.ref.name);
      return () => t.parser.consume(n, a, e);
    } else if (wr(r)) {
      const n = t.consume++, a = bf(t, r.value);
      return () => t.parser.consume(n, a, e);
    } else
    ...
    const n = Xf(e.type.ref), a = n == null ? void 0 : n.terminal;
    if (!a)
      throw new Error("Could not find name assignment for type: " + jn(e.type.ref));
    return Pg(t, e, a);
  }
}
s(Pg, "buildCrossReference");
function GN(t, e) {
...
s(kg, "wrap");
function kd(t, e) {
  const r = FN(t, e), n = t.parser.getRule(r);
  if (!n)
...
function FN(t, e) {
    ...
    return t.ruleNames.get(e);
  {
    ...
    for (; !pt(n); )
      (Xn(n) || Mf(n) || jf(n)) && (a = n.elements.indexOf(r).toString() + ":" + a), r = n, n = n.$container;
...
s(bf, "getToken");
function Og(t) {
  const e = t.Grammar, r = t.parser.Lexer, n = new wN(t);
  return Pd(e, n, r.definition), n.finalize(), n;
}
s(Og, "createCompletionParser");
function Lg(t) {
  const e = Dg(t);
  return e.finalize(), e;
}
s(Lg, "createLangiumParser");
function Dg(t) {
  const e = t.Grammar, r = t.parser.Lexer, n = new _N(t);
  return Pd(e, n, r.definition);
}
s(Dg, "prepareLangiumParser");
var vs, Od = (vs = class {
  constructor() {
    this.diagnostics = [];
  }
  buildTokens(e, r) {
    const n = de(qf(e, !1)), a = this.buildTerminalTokens(n), i = this.buildKeywordTokens(n, a, r);
    return i.push(...a), i;
  }
  ...
  buildTerminalToken(e) {
    const r = ju(e), n = this.requiresCustomPattern(r) ? this.regexPatternFunction(r) : r, a = {
      name: e.name,
      PATTERN: n
    };
    return typeof n == "function" && (a.LINE_BREAKS = !0), e.hidden && (a.GROUP = Wf(r) ? dt.SKIPPED : "hidden"), a;
  }
  ...
  buildKeywordTokens(e, r, n) {
    return e.filter(Hn).flatMap((a) => xr(a).filter(wr)).distinct((a) => a.value).toArray().sort((a, i) => i.value.length - a.value.length).map((a) => this.buildKeywordToken(a, r, !!(n != null && n.caseInsensitive)));
  }
  ...
  buildKeywordPattern(e, r) {
    return r ? new RegExp(il(e.value), "i") : e.value;
  }
  findLongerAlt(e, r) {
    return r.reduce((n, a) => {
      const i = a == null ? void 0 : a.PATTERN;
      return i != null && i.source && sy("^" + i.source + "$", e.value) && n.push(a), n;
    }, []);
  }
}, s(vs, "DefaultTokenBuilder"), vs), Ts, xg = (Ts = class {
  convert(e, r) {
  ...
  runConverter(e, r, n) {
    ...
    switch ((a = $y(e)) == null ? void 0 : a.toLowerCase()) {
      case "number":
...
}, s(Ts, "DefaultValueConverter"), Ts), sr;
(function(t) {
  function e(c) {
    let f = "";
...
var Fc = 0, zN = 10;
function Dd() {
  return Fc = performance.now(), new Re.CancellationTokenSource();
}
s(Dd, "startCancelableOperation");
function Mg(t) {
  zN = t;
}
s(Mg, "setInterruptionPeriod");
var ur = Symbol("OperationCancelled");
function fa(t) {
  return t === ur;
}
s(fa, "isOperationCancelled");
async function Ye(t) {
  if (t === Re.CancellationToken.None)
    return;
  const e = performance.now();
  if (e - Fc >= zN && (Fc = e, await Ld(), Fc = performance.now()), t.isCancellationRequested)
    throw ur;
}
...
var $s, Lr = ($s = class {
  ...
  update(e, r) {
    for (const n of e)
      if (Hr.isIncremental(n)) {
        const a = Fg(n.range), i = this.offsetAt(a.start), o = this.offsetAt(a.end);
        ...
        if (d !== 0)
          for (let p = u + 1 + f.length, h = c.length; p < h; p++)
            c[p] = c[p] + d;
      } else if (Hr.isFull(n))
  ...
  ensureBeforeEOL(e, r) {
    for (; e > r && Gg(this._content.charCodeAt(e - 1)); )
      e--;
    return e;
  }
  get lineCount() {
...
}, s(Hr, "FullTextDocument"), Hr), _f;
(function(t) {
  function e(a, i, o, u) {
    return new _T(a, i, o, u);
  }
  ...
  function n(a, i) {
    const o = a.getText(), u = Sf(i.map(jN), (f, d) => {
...
function Hm(t, e, r = 0) {
  ...
  for (let a = 0; a < t.length; a++) {
    ...
    Gg(i) && (i === 13 && a + 1 < t.length && t.charCodeAt(a + 1) === 10 && a++, n.push(r + a + 1));
  }
  return n;
}
...
s(Fg, "getWellformedRange");
function jN(t) {
  const e = Fg(t.range);
  return e !== t.range ? { newText: t.newText, range: e } : t;
}
s(jN, "getWellformedEdit");
var BN;
(() => {
  var t = { 975: (k) => {
    function _(R) {
  ...
  const c = "", f = "/", d = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/, ue = class ue {
    ...
    with(_) {
      ...
      return $ === void 0 ? $ = this.scheme : $ === null && ($ = c), I === void 0 ? I = this.authority : I === null && (I = c), R === void 0 ? R = this.path : R === null && (R = c), A === void 0 ? A = this.query : A === null && (A = c), S === void 0 ? S = this.fragment : S === null && (S = c), $ === this.scheme && I === this.authority && R === this.path && A === this.query && S === this.fragment ? this : new y($, I, R, A, S);
    }
    static parse(_, $ = !1) {
      const I = d.exec(_);
      return I ? new y(I[2] || c, ne(I[4] || c), ne(I[5] || c), ne(I[7] || c), ne(I[9] || c), $) : new y(c, c, c, c, c);
    }
    static file(_) {
      let $ = c;
      ...
      return new y("file", $, _, c, c);
    }
    static from(_) {
      const $ = new y(_.scheme, _.authority, _.path, _.query, _.fragment);
      return l($, !0), $;
    }
    toString(_ = !1) {
      return b(this, _);
    ...
    static revive(_) {
      if (_) {
        ...
        {
          const $ = new y(_);
          return $._formatted = _.external, $._fsPath = _._sep === h ? _.fsPath : null, $;
        }
      }
      return _;
    }
  ...
  s(ue, "l");
  let p = ue;
  const h = a ? 1 : void 0, ot = class ot extends p {
    constructor() {
      super(...arguments);
      jr(this, "_formatted", null);
      jr(this, "_fsPath", null);
    }
    get fsPath() {
  ...
  s(ot, "d");
  let y = ot;
  const v = { 58: "%3A", 47: "%2F", 63: "%3F", 35: "%23", 91: "%5B", 93: "%5D", 64: "%40", 33: "%21", 36: "%24", 38: "%26", 39: "%27", 40: "%28", 41: "%29", 42: "%2A", 43: "%2B", 44: "%2C", 59: "%3B", 61: "%3D", 32: "%20" };
  function E(k, _, $) {
    let I, R = -1;
  ...
  function T(k) {
    ...
    for (let $ = 0; $ < k.length; $++) {
      ...
      I === 35 || I === 63 ? (_ === void 0 && (_ = k.substr(0, $)), _ += v[I]) : _ !== void 0 && (_ += k[$]);
    }
    return _ !== void 0 ? _ : k;
  }
  s(T, "y");
  ...
  function b(k, _) {
    ...
    return L && (I += "?", I += $(L, !1, !1)), x && (I += "#", I += _ ? x : E(x, !1, !1)), I;
  }
  s(b, "b");
  function N(k) {
    try {
  ...
  (function(k) {
    k.joinPath = function(_, ...$) {
      ...
      I[0] !== Ee && (I = Ee + I, R = !0);
      let A = he.resolve(I, ...$);
      return R && A[0] === Ee && !_.authority && (A = A.substring(1)), _.with({ path: A });
    }, k.dirname = function(_) {
      if (_.path.length === 0 || _.path === Ee) return _;
...
var { URI: wt, Utils: Ll } = BN, ft;
(function(t) {
  t.basename = Ll.basename, t.dirname = Ll.dirname, t.extname = Ll.extname, t.joinPath = Ll.joinPath, t.resolvePath = Ll.resolvePath;
  ...
  function n(o, u) {
    const l = typeof o == "string" ? wt.parse(o).path : o.path, c = typeof u == "string" ? wt.parse(u).path : u.path, f = l.split("/").filter((v) => v.length > 0), d = c.split("/").filter((v) => v.length > 0);
    if (e) {
      const v = /^[A-Z]:$/;
      if (f[0] && v.test(f[0]) && (f[0] = f[0].toLowerCase()), d[0] && v.test(d[0]) && (d[0] = d[0].toLowerCase()), f[0] !== d[0])
        return c.substring(1);
    }
    let p = 0;
    for (; p < f.length && f[p] === d[p]; p++)
      ;
    const h = "../".repeat(f.length - p), y = d.slice(p).join("/");
    return h + y;
  }
...
var As, UN = (As = class {
  ...
  fromTextDocument(e, r, n) {
    return r = r ?? wt.parse(e.uri), Re.CancellationToken.is(n) ? this.createAsync(r, e, n) : this.create(r, e, n);
  }
  fromString(e, r, n) {
  ...
  async update(e, r) {
    var o, u;
    const n = (o = e.parseResult.value.$cstNode) == null ? void 0 : o.root.fullText, a = (u = this.textDocuments) == null ? void 0 : u.get(e.uri.toString()), i = a ? a.getText() : await this.fileSystemProvider.readFile(e.uri);
    if (a)
  ...
  createTextDocumentGetter(e, r) {
    ...
    let a;
    return () => a ?? (a = _f.create(e.toString(), n.getServices(e).LanguageMetaData.languageId, 0, r ?? ""));
  }
}, s(As, "DefaultLangiumDocumentFactory"), As), Es, KN = (Es = class {
  constructor(e) {
    this.documentTrie = new zg(), this.services = e, this.langiumDocumentFactory = e.workspace.LangiumDocumentFactory, this.documentBuilder = () => e.workspace.DocumentBuilder;
  }
  get all() {
...
}, s(Es, "DefaultLangiumDocuments"), Es), gn = Symbol("RefResolving"), Cs, WN = (Cs = class {
  constructor(e) {
  ...
  async link(e, r = Re.CancellationToken.None) {
    ...
    if ((n = this.profiler) != null && n.isActive("linking")) {
      ...
      a.start();
      try {
        for (const i of qt(e.parseResult.value))
          await Ye(r), Yo(i).forEach((o) => {
      ...
      for (const a of qt(e.parseResult.value))
        await Ye(r), Yo(a).forEach((i) => this.doLink(i, e));
  }
  doLink(e, r) {
    const n = e.reference;
    ...
    const i = this, o = {
      ...
      get ref() {
        ...
        if (Ch(this._nodeDescription)) {
          ...
          this._ref = gn;
          const u = Ha(e).$document, l = i.getLinkedNode({ reference: o, container: e, property: r });
          if (l.error && u && u.state < Q.ComputedScopes)
            return this._ref = void 0;
          this._ref = l.node ?? l.error, this._nodeDescription = l.descr, u == null || u.references.push(this);
        } else this._ref === gn && i.throwCyclicReferenceError(e, r, a);
      ...
      get error() {
        return Rn(this._ref) ? this._ref : void 0;
      }
    };
    return o;
  }
    ...
    const i = this, o = {
      ...
      get items() {
        ...
        if (this._items === void 0) {
          this._items = gn;
          const u = Ha(e).$document, l = i.getCandidates({
            reference: o,
            container: e,
            property: r
          }), c = [];
        ...
        } else this._items === gn && i.throwCyclicReferenceError(e, r, a);
  ...
  createLinkingError(e, r) {
    const n = Ha(e.container).$document;
...
var bs, qN = (bs = class {
  ...
  getNameNode(e) {
    return Vf(e.$cstNode, "name");
  }
}, s(bs, "DefaultNameProvider"), bs), _s, VN = (_s = class {
  constructor(e) {
    this.nameProvider = e.references.NameProvider, this.index = e.shared.workspace.IndexManager, this.nodeLocator = e.workspace.AstNodeLocator, this.documents = e.shared.workspace.LangiumDocuments, this.hasMultiReference = qt(e.Grammar).some((r) => Yn(r) && r.isMulti);
  }
  findDeclarations(e) {
    if (e) {
      const r = hy(e), n = e.astNode;
      if (r && n) {
        const a = n[r.feature];
        if (ct(a) || cr(a))
          return Kc(a);
...
}, s(_s, "DefaultReferences"), _s), Ss, Dr = (Ss = class {
  constructor(e) {
   ...
   */
  get size() {
    return vu.sum(de(this.map.values()).map((e) => e.length));
  }
  /**
...
}, s(Ss, "MultiMap"), Ss), ws, wf = (ws = class {
  get size() {
   ...
   */
  async collectExportedSymbolsForNode(e, r, n = Mu, a = Re.CancellationToken.None) {
    const i = [];
...
}, s(Is, "DefaultScopeComputation"), Is), Ns, Ym = (Ns = class {
  constructor(e, r, n) {
...
}, s(Ns, "StreamScope"), Ns), Ps, mB = (Ps = class {
  constructor(e, r, n) {
    this.elements = /* @__PURE__ */ new Map(), this.caseInsensitive = (n == null ? void 0 : n.caseInsensitive) ?? !1, this.concatOuterScope = (n == null ? void 0 : n.concatOuterScope) ?? !0;
    for (const a of e) {
...
}, s(Ps, "MapScope"), Ps), ks, YN = (ks = class {
  constructor(e, r, n) {
    this.elements = new Dr(), this.caseInsensitive = (n == null ? void 0 : n.caseInsensitive) ?? !1, this.concatOuterScope = (n == null ? void 0 : n.concatOuterScope) ?? !0;
    for (const a of e) {
      const i = this.caseInsensitive ? a.name.toLowerCase() : a.name;
...
}, s(Os, "DisposableCache"), Os), Ls, Bg = (Ls = class extends xd {
  constructor() {
...
}, s(Ls, "SimpleCache"), Ls), Ds, Md = (Ds = class extends xd {
  constructor(e) {
...
}, s(Ds, "ContextCache"), Ds), xs, XN = (xs = class extends Md {
  /**
...
}, s(xs, "DocumentCache"), xs), Ms, Ug = (Ms = class extends Bg {
  /**
...
}, s(Ms, "WorkspaceCache"), Ms), Gs, JN = (Gs = class {
  constructor(e) {
   ...
   */
  getGlobalScope(e, r) {
    return this.globalScopeCache.get(e, () => new YN(this.indexManager.allElements(e)));
  }
}, s(Gs, "DefaultScopeProvider"), Gs);
function Kg(t) {
  return typeof t.$comment == "string";
}
s(Kg, "isAstNodeWithComment");
function Xm(t) {
  return typeof t == "object" && !!t && ("$ref" in t || "$error" in t);
}
s(Xm, "isIntermediateReference");
var Fs, ZN = (Fs = class {
  constructor(e) {
  ...
  serialize(e, r) {
    const n = r ?? {}, a = r == null ? void 0 : r.replacer, i = /* @__PURE__ */ s((u, l) => this.replacer(u, l, n), "defaultReplacer"), o = a ? (u, l) => a(u, l, i) : i;
    try {
      return this.currentDocument = Wt(e), JSON.stringify(e, o, r == null ? void 0 : r.space);
    } finally {
    ...
    if (!this.ignoreProperties.has(e))
      if (ct(r)) {
        ...
        if (d) {
          const h = Wt(d);
          let y = "";
          this.currentDocument && this.currentDocument !== h && (u ? y = u(h.uri, d) : y = h.uri.toString());
        ...
        const d = n ? r.$refText : void 0, p = [];
        for (const h of r.items) {
          const y = h.ref, v = Wt(h.ref);
          let E = "";
          this.currentDocument && this.currentDocument !== v && (u ? E = u(v.uri, y) : E = v.uri.toString());
          const T = this.astNodeLocator.getAstNodePath(y);
          p.push(`${E}#${T}`);
        }
        return {
          $refs: p,
        ...
        let d;
        if (i && (d = this.addAstNodeRegionWithAssignmentsTo({ ...r }), (!e || r.$document) && (d != null && d.$textRegion) && (d.$textRegion.documentURI = (c = this.currentDocument) == null ? void 0 : c.uri.toString())), a && !e && (d ?? (d = { ...r }), d.$sourceText = (f = r.$cstNode) == null ? void 0 : f.text), o) {
          d ?? (d = { ...r });
  ...
  linkNode(e, r, n, a, i, o) {
    for (const [l, c] of Object.entries(e))
      if (Array.isArray(c))
        for (let f = 0; f < c.length; f++) {
          const d = c[f];
          Xm(d) ? c[f] = this.reviveReference(e, l, r, d, n) : Be(d) && this.linkNode(d, r, n, e, l, f);
        }
      else Xm(c) ? e[l] = this.reviveReference(e, l, r, c, n) : Be(c) && this.linkNode(c, r, n, e, l);
    const u = e;
...
}, s(Fs, "DefaultJsonSerializer"), Fs), zs, QN = (zs = class {
  /**
...
}, s(zs, "DefaultServiceRegistry"), zs);
function Dn(t) {
  return { code: t };
}
s(Dn, "diagnosticData");
...
var js, eP = (js = class {
  constructor(e) {
    this.entries = new Dr(), this.knownCategories = new Set(If.defaults), this.entriesBefore = [], this.entriesAfter = [], this.reflection = e.shared.AstReflection;
  }
  /**
...
}, s(js, "ValidationRegistry"), js), tP = Object.freeze({
  validateNode: !0,
  validateChildren: !0
}), Bs, rP = (Bs = class {
  constructor(e) {
  ...
  async validateDocument(e, r = {}, n = Re.CancellationToken.None) {
    ...
    if (await Ye(n), (!r.categories || r.categories.includes("built-in")) && (this.processLexingErrors(a, i, r), r.stopAfterLexingErrors && i.some((o) => {
      var u;
      return ((u = o.data) == null ? void 0 : u.code) === xt.LexingError;
    }) || (this.processParsingErrors(a, i, r), r.stopAfterParsingErrors && i.some((o) => {
      var u;
      return ((u = o.data) == null ? void 0 : u.code) === xt.ParsingError;
    })) || (this.processLinkingErrors(e, i, r), r.stopAfterLinkingErrors && i.some((o) => {
      var u;
      return ((u = o.data) == null ? void 0 : u.code) === xt.LinkingError;
    }))))
      return i;
    try {
  ...
  processLexingErrors(e, r, n) {
    var i;
    const a = [...e.lexerErrors, ...((i = e.lexerReport) == null ? void 0 : i.diagnostics) ?? []];
    for (const o of a) {
      const u = o.severity ?? "error", l = {
        severity: yu(u),
        range: {
          start: {
            line: o.line - 1,
            character: o.column - 1
          },
          end: {
            line: o.line - 1,
            character: o.column + o.length - 1
          }
        },
        message: o.message,
        data: qg(u),
...
}, s(Bs, "DefaultDocumentValidator"), Bs);
function Wg(t) {
  if (t.range)
    return t.range;
  let e;
  return typeof t.property == "string" ? e = Vf(t.node.$cstNode, t.property, t.index) : typeof t.keyword == "string" && (e = my(t.node.$cstNode, t.keyword, t.index)), e ?? (e = t.node.$cstNode), e ? e.range : {
    start: { line: 0, character: 0 },
    end: { line: 0, character: 0 }
  };
}
s(Wg, "getDiagnosticRange");
function yu(t) {
  switch (t) {
    case "error":
      return 1;
...
s(yu, "toDiagnosticSeverity");
function qg(t) {
  switch (t) {
    case "error":
      return Dn(xt.LexingError);
    case "warning":
      return Dn(xt.LexingWarning);
    case "info":
      return Dn(xt.LexingInfo);
    case "hint":
      return Dn(xt.LexingHint);
    default:
      throw new Error("Invalid diagnostic severity: " + t);
  }
}
s(qg, "toDiagnosticData");
var xt;
(function(t) {
...
var Us, nP = (Us = class {
  ...
  createDescription(e, r, n) {
    ...
    let o;
    const u = /* @__PURE__ */ s(() => o ?? (o = Zo(this.nameProvider.getNameNode(e) ?? e.$cstNode)), "nameSegmentGetter");
    return {
      node: e,
      name: r,
      get nameSegment() {
      ...
      selectionSegment: Zo(e.$cstNode),
      type: e.$type,
      documentUri: a.uri,
      path: i
    };
  }
}, s(Us, "DefaultAstNodeDescriptionProvider"), Us), Ks, aP = (Ks = class {
  constructor(e) {
  ...
  createInfoDescriptions(e) {
    ...
    const a = Wt(e.container).uri, i = this.nodeLocator.getAstNodePath(e.container), o = [], u = Zo(r.$refNode);
    for (const l of n)
      o.push({
        sourceUri: a,
        sourcePath: i,
...
}, s(Ks, "DefaultReferenceDescriptionProvider"), Ks), Ws, iP = (Ws = class {
  constructor() {
  ...
  getAstNode(e, r) {
    return r.split(this.segmentSeparator).reduce((a, i) => {
      ...
      if (o > 0) {
        const u = i.substring(0, o), l = parseInt(i.substring(o + 1)), c = a[u];
        return c == null ? void 0 : c[l];
      }
      return a[i];
    }, e);
  }
}, s(Ws, "DefaultAstNodeLocator"), Ws), Gd = {};
kf(Gd, $h(nl()));
var qs, sP = (qs = class {
  constructor(e) {
    this._ready = new Lr(), this.onConfigurationSectionUpdateEmitter = new Gd.Emitter(), this.settings = {}, this.workspaceConfig = !1, this.serviceRegistry = e.ServiceRegistry;
  }
  get ready() {
...
}, s(qs, "DefaultConfigurationProvider"), qs), lc = $h(Yk()), Gn;
(function(t) {
  function e(r) {
    return {
...
var Vs, oP = (Vs = class {
  ...
  async build(e, r = {}, n = Re.CancellationToken.None) {
    ...
    for (const i of e) {
      ...
      if (i.state === Q.Validated) {
        if (typeof r.validation == "boolean" && r.validation)
          this.resetToState(i, Q.IndexedReferences);
    ...
    this.currentState = Q.Changed, await this.emitUpdate(e.map((i) => i.uri), []), await this.buildDocuments(e, r, n);
  }
  async update(e, r, n = Re.CancellationToken.None) {
    ...
    const u = this.sortDocuments(this.langiumDocuments.all.filter((l) => {
      ...
      return (
        ...
        l.state < Q.Validated || !((c = this.buildState.get(l.uri.toString())) != null && c.completed) || this.resultsAreIncomplete(l, this.updateBuildOptions)
      );
    }).toArray());
  ...
  findMissingValidationCategories(e, r) {
    var u, l;
    const n = this.buildState.get(e.uri.toString()), a = this.serviceRegistry.getServices(e.uri).validation.ValidationRegistry.getAllValidationCategories(e), i = (u = n == null ? void 0 : n.result) != null && u.validationChecks ? new Set((l = n == null ? void 0 : n.result) == null ? void 0 : l.validationChecks) : n != null && n.completed ? a : /* @__PURE__ */ new Set(), o = r === void 0 || r.validation === !0 ? a : typeof r.validation == "object" ? r.validation.categories ?? a : [];
    return de(o).filter((c) => !i.has(c)).toArray();
  }
  async findChangedUris(e) {
    ...
    if (this.langiumDocuments.getDocument(e) ?? ((n = this.textDocuments) == null ? void 0 : n.get(e)))
      return [e];
    try {
      const a = await this.fileSystemProvider.stat(e);
      if (a.isDirectory)
        return await this.workspaceManager().searchFolder(e);
      if (this.workspaceManager().shouldIncludeEntry(a))
        return [e];
    } catch {
    }
    return [];
  ...
  onUpdate(e) {
    return this.updateListeners.push(e), Gn.create(() => {
  ...
  onBuildPhase(e, r) {
    return this.buildPhaseListeners.add(e, r), Gn.create(() => {
      this.buildPhaseListeners.delete(e, r);
    });
  }
  onDocumentPhase(e, r) {
    return this.documentPhaseListeners.add(e, r), Gn.create(() => {
      this.documentPhaseListeners.delete(e, r);
    });
  }
  waitUntil(e, r, n) {
    let a;
    return r && "path" in r ? a = r : n = r, n ?? (n = Re.CancellationToken.None), a ? this.awaitDocumentState(e, a, n) : this.awaitBuilderState(e, n);
  }
  awaitDocumentState(e, r, n) {
    ...
    if (a) {
      ...
      if (this.currentState >= e && e > a.state)
        return Promise.reject(new lc.ResponseError(lc.LSPErrorCodes.RequestFailed, `Document state of ${r.toString()} is ${Q[a.state]}, requiring ${Q[e]}, but workspace state is already ${Q[this.currentState]}. Returning undefined.`));
    } else return Promise.reject(new lc.ResponseError(lc.LSPErrorCodes.ServerCancelled, `No document found for URI: ${r.toString()}`));
...
}, s(Vs, "DefaultDocumentBuilder"), Vs), Hs, lP = (Hs = class {
  constructor(e) {
    this.symbolIndex = /* @__PURE__ */ new Map(), this.symbolByTypeIndex = new Md(), this.referenceIndex = /* @__PURE__ */ new Map(), this.documents = e.workspace.LangiumDocuments, this.serviceRegistry = e.ServiceRegistry, this.astReflection = e.AstReflection;
  }
...
}, s(Hs, "DefaultIndexManager"), Hs), Ys, uP = (Ys = class {
  constructor(e) {
...
}, s(Ys, "DefaultWorkspaceManager"), Ys), Xs, cP = (Xs = class {
  buildUnexpectedCharactersMessage(e, r, n, a, i) {
    return Nm.buildUnexpectedCharactersMessage(e, r, n, a, i);
  }
  buildUnableToPopLexerModeMessage(e) {
    return Nm.buildUnableToPopLexerModeMessage(e);
  }
}, s(Xs, "DefaultLexerErrorMessageProvider"), Xs), Vg = { mode: "full" }, Js, Hg = (Js = class {
  constructor(e) {
    ...
    const n = Nf(r) ? Object.values(r) : r, a = e.LanguageMetaData.mode === "production";
  ...
  tokenize(e, r = Vg) {
    ...
    return {
      ...
      report: (i = (a = this.tokenBuilder).flushLexingReport) == null ? void 0 : i.call(a, e)
    };
  }
  toTokenTypeDictionary(e) {
    if (Nf(e))
      return e;
    const r = zd(e) ? Object.values(e.modes).flat() : e, n = {};
...
s(Fd, "isTokenTypeArray");
function zd(t) {
  return t && "modes" in t && "defaultMode" in t;
}
s(zd, "isIMultiModeLexerDefinition");
function Nf(t) {
  return !Fd(t) && !zd(t);
}
s(Nf, "isTokenTypeDictionary");
Du();
function Yg(t, e, r) {
  let n, a;
  typeof t == "string" ? (a = e, n = r) : (a = t.range.start, n = e), a || (a = oe.create(0, 0));
  const i = Jg(t), o = jd(n), u = fP({
    lines: i,
    position: a,
    options: o
  });
...
function Jg(t) {
  let e = "";
  return typeof t == "string" ? e = t : e = t.text, e.split(hR);
}
s(Jg, "getLines");
var ST = /\s*(@([\p{L}][\p{L}\p{N}]*)?)/uy, yB = /\{(@[\p{L}][\p{L}\p{N}]*)(\s*)([^\r\n}]+)?\}/gu;
function fP(t) {
  var a, i, o;
  const e = [];
  let r = t.position.line, n = t.position.character;
  for (let u = 0; u < t.lines.length; u++) {
    const l = u === 0, c = u === t.lines.length - 1;
    let f = t.lines[u], d = 0;
    ...
    if (f = f.substring(0, pP(f)), Pf(f, d) >= f.length) {
      if (e.length > 0) {
        const h = oe.create(r, n);
        e.push({
          type: "break",
          content: "",
          range: te.create(h, h)
      ...
      const h = ST.exec(f);
      if (h) {
        const y = h[0], v = h[1], E = oe.create(r, n + d), T = oe.create(r, n + d + y.length);
        e.push({
          type: "tag",
          content: v,
          range: te.create(E, T)
      ...
      if (d < f.length) {
        const y = f.substring(d), v = Array.from(y.matchAll(yB));
        e.push(...dP(v, y, r, n + d));
      }
    }
    r++, n = 0;
...
s(dP, "buildInlineTokens");
var gB = /\S/, vB = /\s*$/;
function Pf(t, e) {
  const r = t.substring(e).match(gB);
...
function mP(t) {
  ...
  if (t.tokens.length === 0)
    return new wT([], te.create(e, e));
  const r = [];
  for (; t.index < t.tokens.length; ) {
    const u = hP(t, r[r.length - 1]);
    u && r.push(u);
  }
  const n = ((i = r[0]) == null ? void 0 : i.range.start) ?? e, a = ((o = r[r.length - 1]) == null ? void 0 : o.range.end) ?? e;
  return new wT(r, te.create(n, a));
}
s(mP, "parseJSDocComment");
function hP(t, e) {
...
s(hP, "parseJSDocElement");
function yP(t, e) {
  if (e) {
    const r = new $P("", t.range);
    "inlines" in e ? e.inlines.push(r) : e.content.inlines.push(r);
  }
}
s(yP, "appendEmptyLine");
function Zg(t) {
  ...
  for (; e && e.type !== "break" && e.type !== "tag"; )
    a.push(gP(t)), n = e, e = t.tokens[t.index];
  return new Jm(a, te.create(r.range.start, n.range.end));
}
s(Zg, "parseJSDocText");
function gP(t) {
  return t.tokens[t.index].type === "inline-tag" ? Qg(t, !0) : ev(t);
}
s(gP, "parseJSDocInline");
function Qg(t, e) {
  const r = t.tokens[t.index++], n = r.content.substring(1), a = t.tokens[t.index];
  if ((a == null ? void 0 : a.type) === "text")
    if (e) {
      const i = ev(t);
      return new Jd(n, new Jm([i], i.range), e, te.create(r.range.start, i.range.end));
    } else {
      const i = Zg(t);
      return new Jd(n, i, e, te.create(r.range.start, i.range.end));
    }
  else {
    const i = r.range;
    return new Jd(n, new Jm([], i), e, i);
  }
}
s(Qg, "parseJSDocTag");
function ev(t) {
  const e = t.tokens[t.index++];
  return new $P(e.content, e.range);
}
s(ev, "parseJSDocLine");
function jd(t) {
  if (!t)
...
s(jd, "normalizeOptions");
function zc(t, e) {
  if (typeof t == "string" || typeof t == "object") {
    const r = typeof t == "string" ? il(t) : t.source;
    return e ? new RegExp(`^\\s*${r}`) : new RegExp(`\\s*${r}\\s*$`);
  } else
    return t;
}
s(zc, "normalizeOption");
var Zs, wT = (Zs = class {
  constructor(e, r) {
...
}, s(Zs, "JSDocCommentImpl"), Zs), Qs, Jd = (Qs = class {
  constructor(e, r, n, a) {
...
function vP(t, e, r) {
  ...
  if (t === "linkplain" || t === "linkcode" || t === "link") {
    ...
    if (a > 0) {
      const u = Pf(e, a);
      i = e.substring(u), e = e.substring(0, a);
    }
    return (t === "linkcode" || t === "link" && r.link === "code") && (i = `\`${i}\``), ((n = r.renderLink) == null ? void 0 : n.call(r, e, i)) ?? TP(e, i);
  }
}
s(vP, "renderInlineTag");
function TP(t, e) {
  try {
...
}, s(eo, "JSDocTextImpl"), eo), to, $P = (to = class {
  constructor(e, r) {
...
var ro, RP = (ro = class {
...
}, s(ro, "JSDocDocumentationProvider"), ro), no, AP = (no = class {
  constructor(e) {
    this.grammarConfig = () => e.parser.GrammarConfig;
  }
  getComment(e) {
    var r;
    return Kg(e) ? e.$comment : (r = Zh(e.$cstNode, this.grammarConfig().multilineCommentRules)) == null ? void 0 : r.text;
  }
}, s(no, "DefaultCommentProvider"), no), ao, EP = (ao = class {
  constructor(e) {
...
}, s(ao, "DefaultAsyncParser"), ao), io, TB = (io = class {
  constructor(e) {
...
}, s(io, "AbstractThreadedAsyncParser"), io), so, $B = (so = class {
  get ready() {
    return this._ready;
  }
  get onReady() {
  ...
  constructor(e, r, n, a) {
    this.onReadyEmitter = new Gd.Emitter(), this.deferred = new Lr(), this._ready = !0, this._parsing = !1, this.sendMessage = e, this._terminate = a, r((i) => {
      const o = i;
...
}, s(so, "ParserWorker"), so), oo, CP = (oo = class {
  constructor() {
    this.previousTokenSource = new Re.CancellationTokenSource(), this.writeQueue = [], this.readQueue = [], this.done = !0;
  }
  write(e) {
    this.cancelWrite();
    const r = Dd();
  ...
  async performNextOperation() {
    ...
    this.done = !1, await Promise.all(e.map(async ({ action: r, deferred: n, cancellationToken: a }) => {
      try {
        ...
        fa(i) ? n.resolve(void 0) : n.reject(i);
      }
...
}, s(oo, "DefaultWorkspaceLock"), oo), lo, bP = (lo = class {
  constructor(e) {
    this.grammarElementIdMap = new wf(), this.tokenTypeIdMap = new wf(), this.grammar = e.Grammar, this.lexer = e.parser.Lexer, this.linker = e.references.Linker;
  }
  dehydrate(e) {
    return {
  ...
  createHydrationContext(e) {
    ...
    let a;
    if (e.$cstNode)
      for (const i of Jo(e.$cstNode)) {
        let o;
        "fullText" in i ? (o = new wg(i.fullText), a = o) : "content" in i ? o = new Nd() : "tokenType" in i && (o = this.hydrateCstLeafNode(i)), o && (n.set(i, o), o.root = a);
      }
    return {
      astNodes: r,
      cstNodes: n
  ...
  createGrammarElementIdMap() {
    ...
    for (const r of qt(this.grammar))
      xf(r) && this.grammarElementIdMap.set(r, e++);
  }
}, s(lo, "DefaultHydrator"), lo);
function Xe(t) {
  return {
    documentation: {
      CommentProvider: /* @__PURE__ */ s((e) => new AP(e), "CommentProvider"),
      DocumentationProvider: /* @__PURE__ */ s((e) => new RP(e), "DocumentationProvider")
    },
    parser: {
      AsyncParser: /* @__PURE__ */ s((e) => new EP(e), "AsyncParser"),
      GrammarConfig: /* @__PURE__ */ s((e) => Ay(e), "GrammarConfig"),
      LangiumParser: /* @__PURE__ */ s((e) => Lg(e), "LangiumParser"),
      CompletionParser: /* @__PURE__ */ s((e) => Og(e), "CompletionParser"),
      ValueConverter: /* @__PURE__ */ s(() => new xg(), "ValueConverter"),
      TokenBuilder: /* @__PURE__ */ s(() => new Od(), "TokenBuilder"),
      Lexer: /* @__PURE__ */ s((e) => new Hg(e), "Lexer"),
      ParserErrorMessageProvider: /* @__PURE__ */ s(() => new Ng(), "ParserErrorMessageProvider"),
      LexerErrorMessageProvider: /* @__PURE__ */ s(() => new cP(), "LexerErrorMessageProvider")
    },
    workspace: {
      AstNodeLocator: /* @__PURE__ */ s(() => new iP(), "AstNodeLocator"),
      AstNodeDescriptionProvider: /* @__PURE__ */ s((e) => new nP(e), "AstNodeDescriptionProvider"),
      ReferenceDescriptionProvider: /* @__PURE__ */ s((e) => new aP(e), "ReferenceDescriptionProvider")
    },
    references: {
      Linker: /* @__PURE__ */ s((e) => new WN(e), "Linker"),
      NameProvider: /* @__PURE__ */ s(() => new qN(), "NameProvider"),
      ScopeProvider: /* @__PURE__ */ s((e) => new JN(e), "ScopeProvider"),
      ScopeComputation: /* @__PURE__ */ s((e) => new HN(e), "ScopeComputation"),
      References: /* @__PURE__ */ s((e) => new VN(e), "References")
    },
    serializer: {
      Hydrator: /* @__PURE__ */ s((e) => new bP(e), "Hydrator"),
      JsonSerializer: /* @__PURE__ */ s((e) => new ZN(e), "JsonSerializer")
    },
    validation: {
      DocumentValidator: /* @__PURE__ */ s((e) => new rP(e), "DocumentValidator"),
      ValidationRegistry: /* @__PURE__ */ s((e) => new eP(e), "ValidationRegistry")
    },
...
function Je(t) {
  return {
    ServiceRegistry: /* @__PURE__ */ s((e) => new QN(e), "ServiceRegistry"),
    workspace: {
      LangiumDocuments: /* @__PURE__ */ s((e) => new KN(e), "LangiumDocuments"),
      LangiumDocumentFactory: /* @__PURE__ */ s((e) => new UN(e), "LangiumDocumentFactory"),
      DocumentBuilder: /* @__PURE__ */ s((e) => new oP(e), "DocumentBuilder"),
      IndexManager: /* @__PURE__ */ s((e) => new lP(e), "IndexManager"),
      WorkspaceManager: /* @__PURE__ */ s((e) => new uP(e), "WorkspaceManager"),
      FileSystemProvider: /* @__PURE__ */ s((e) => t.fileSystemProvider(e), "FileSystemProvider"),
      WorkspaceLock: /* @__PURE__ */ s(() => new CP(), "WorkspaceLock"),
      ConfigurationProvider: /* @__PURE__ */ s((e) => new sP(e), "ConfigurationProvider")
    },
    profilers: {}
  };
}
...
var Qm;
(function(t) {
  t.merge = (e, r) => rl(rl({}, e), r);
})(Qm || (Qm = {}));
function re(t, e, r, n, a, i, o, u, l) {
  const c = [t, e, r, n, a, i, o, u, l].reduce(rl, {});
  return rv(c);
}
s(re, "inject");
var _P = Symbol("isProxy");
function tv(t) {
  if (t && t[_P])
...
function rv(t, e) {
  const r = new Proxy({}, {
    ...
    get: /* @__PURE__ */ s((n, a) => a === _P ? !0 : eh(n, a, t, e || r), "get"),
    getOwnPropertyDescriptor: /* @__PURE__ */ s((n, a) => (eh(n, a, t, e || r), Object.getOwnPropertyDescriptor(n, a)), "getOwnPropertyDescriptor"),
    // used by for..in
...
function eh(t, e, r, n) {
  if (e in t) {
    ...
    t[e] = IT;
    try {
      t[e] = typeof a == "function" ? a(n) : rv(a, n);
    } catch (i) {
  ...
  if (e) {
    for (const [r, n] of Object.entries(e))
      if (n != null)
        if (typeof n == "object") {
          const a = t[r];
          typeof a == "object" && a !== null ? t[r] = rl(a, n) : t[r] = rl({}, n);
        } else
          t[r] = n;
  }
  return t;
...
var uo, SP = (uo = class extends Od {
  ...
  buildTokens(e, r) {
    ...
    for (const p of n) {
      for (const [h, y] of u)
        p.name === h ? p.PUSH_MODE = xn.IGNORE_INDENTATION : p.name === y && (p.POP_MODE = !0);
    ...
    return u.length > 0 ? {
      modes: {
        [xn.REGULAR]: [l, c, ...d, f],
        [xn.IGNORE_INDENTATION]: [...d, f]
      },
      defaultMode: xn.REGULAR
    } : [l, c, f, ...d];
  }
  flushLexingReport(e) {
    return {
...
`.includes(e[r - 1]);
  ...
  matchWhitespace(e, r, n, a) {
    ...
    return {
      currIndentLevel: (i == null ? void 0 : i[0].length) ?? 0,
  ...
  createIndentationTokenInstance(e, r, n, a) {
    ...
    return Zu(e, n, a, a + n.length, i, i, 1, n.length);
  }
  /**
  ...
  dedentMatcher(e, r, n, a) {
    ...
    if (l === -1)
      return this.diagnostics.push({
        ...
        offset: r,
        length: ((d = u == null ? void 0 : u[0]) == null ? void 0 : d.length) ?? 0,
        line: this.getLineNumber(e, r),
        column: 1
      }), null;
    const c = this.indentationStack.length - l - 1, f = ((p = e.substring(0, r).match(/[\r\n]+$/)) == null ? void 0 : p[0].length) ?? 1;
    for (let h = 0; h < c; h++) {
      const y = this.createIndentationTokenInstance(
      ...
      n.push(y), this.indentationStack.pop();
    }
    return null;
  }
  buildTerminalToken(e) {
    const r = super.buildTerminalToken(e), { indentTokenName: n, dedentTokenName: a, whitespaceTokenName: i } = this.options;
    return r.name === n ? this.indentTokenType : r.name === a ? this.dedentTokenType : r.name === i ? Xa({
      name: i,
...
}, s(uo, "IndentationAwareTokenBuilder"), uo), co, RB = (co = class extends Hg {
  constructor(e) {
    if (super(e), e.parser.TokenBuilder instanceof SP)
  ...
  tokenize(e, r = Vg) {
    ...
    for (let d = 0; d < f; d++) {
      const p = n.tokens[d], h = n.tokens[d + 1];
      if (p.tokenTypeIdx === u && h.tokenTypeIdx === l) {
        d++;
        continue;
      }
      c.push(p);
...
}, s(co, "IndentationAwareLexer"), co), nv = {};
en(nv, {
  AstUtils: () => _h,
  BiMap: () => wf,
  Cancellation: () => Re,
...
var fo, wP = (fo = class {
...
}, s(fo, "EmptyFileSystemProvider"), fo), st = {
  fileSystemProvider: /* @__PURE__ */ s(() => new wP(), "fileSystemProvider")
}, AB = {
  Grammar: /* @__PURE__ */ s(() => {
  }, "Grammar"),
  ...
  AstReflection: /* @__PURE__ */ s(() => new Vh(), "AstReflection")
};
function IP() {
  const t = re(Je(st), EB), e = re(Xe({ shared: t }), AB);
  return t.ServiceRegistry.register(e), e;
}
s(IP, "createMinimalGrammarServices");
function Ze(t) {
  const e = IP(), r = e.serializer.JsonSerializer.deserialize(t);
...
var po, CB = (po = class {
  ...
  createTask(e, r) {
    ...
    return console.log(`Creating profiling task for '${e}.${r}'.`), new NP((n) => this.records.add(e, this.dumpRecord(e, n)), r);
  }
  dumpRecord(e, r) {
...
}, s(po, "DefaultLangiumProfiler"), po), mo, NP = (mo = class {
  constructor(e, r) {
...
function NB(t) {
  return ze.isInstance(t, gh.$type);
}
s(NB, "isDomainItem");
var FT = {
  $type: "EbnfChoice",
...
function FB(t) {
  return ze.isInstance(t, Uc.$type);
}
s(FB, "isPieSection");
var pp = {
  $type: "Pipeline",
...
function KB(t) {
  return ze.isInstance(t, tu.$type);
}
s(KB, "isTransition");
var Fa = {
  $type: "Treemap",
...
function WB(t) {
  return ze.isInstance(t, Fa.$type);
}
s(WB, "isTreemap");
var gp = {
  $type: "TreemapRow",
...
var ho, PP = (ho = class extends bh {
  constructor() {
    super(...arguments), this.types = {
      ...
      EmGwt: {
        ...
        properties: {
          givenStatements: {
            name: Ml.givenStatements,
            defaultValue: []
          },
          sourceFrame: {
            name: Ml.sourceFrame,
            referenceType: un.$type
          },
          thenStatements: {
            name: Ml.thenStatements,
            defaultValue: []
          },
          whenStatements: {
            name: Ml.whenStatements,
            defaultValue: []
          }
        },
        superTypes: []
      ...
      EmGwtStatement: {
        ...
        properties: {
          entityIdentifier: {
            name: JT.entityIdentifier,
            referenceType: ip.$type
          }
        },
        superTypes: []
      },
      ...
      EmTimeFrame: {
        ...
        properties: {
          ...
          entityIdentifier: {
            name: Br.entityIdentifier
          },
          modelEntityType: {
            name: Br.modelEntityType
          },
          name: {
            name: Br.name
          },
      ...
      TreeNode: {
        ...
        properties: {
          classAnnotation: {
            name: Ca.classAnnotation
          },
          descAnnotation: {
            name: Ca.descAnnotation
          },
          iconAnnotation: {
            name: Ca.iconAnnotation
          },
          indent: {
            name: Ca.indent
          },
  ...
  AstReflection: /* @__PURE__ */ s(() => new PP(), "AstReflection")
}, EU = {
...
}, s(yo, "AbstractMermaidValueConverter"), yo), go, pl = (go = class extends gr {
  runCustomConverter(e, r, n) {
  }
}, s(go, "CommonValueConverter"), go), vo, Tt = (vo = class extends Od {
  constructor(e) {
...
}, s(vo, "AbstractMermaidTokenBuilder"), vo), To;
To = class extends Tt {
}, s(To, "CommonTokenBuilder");
...
lodash-es/lodash.js:
   ...
   *)
*/
var $o, BU = ($o = class extends Tt {
  constructor() {
    super(["radar-beta"]);
  }
}, s($o, "RadarTokenBuilder"), $o), kP = {
  parser: {
    TokenBuilder: /* @__PURE__ */ s(() => new BU(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ s(() => new pl(), "ValueConverter")
  }
};
function OP(t = st) {
  const e = re(
...
s(OP, "createRadarServices");
var Ro, UU = (Ro = class extends Tt {
  constructor() {
    super(["railroad-beta"]);
  }
}, s(Ro, "RailroadTokenBuilder"), Ro), w$ = /* @__PURE__ */ s((t) => {
  const e = t.slice(1, -1);
  let r = "";
...
`;
  ...
  return r;
}, "decodeEscapedString"), Ao, KU = (Ao = class extends gr {
  runConverter(e, r, n) {
...
}, s(Ao, "RailroadValueConverter"), Ao), LP = {
  parser: {
    TokenBuilder: /* @__PURE__ */ s(() => new UU(), "TokenBuilder"),
...
s(DP, "createRailroadServices");
var Eo, WU = (Eo = class extends Tt {
  constructor() {
    super(["railroad-ebnf-beta"]);
  }
}, s(Eo, "RailroadEbnfTokenBuilder"), Eo), I$ = /* @__PURE__ */ s((t) => {
  const e = t.slice(1, -1);
  let r = "";
  for (let n = 0; n < e.length; n++) {
    const a = e[n];
...
`;
  ...
  return r;
}, "decodeEscapedString"), Co, qU = (Co = class extends gr {
  runConverter(e, r, n) {
    const a = super.runConverter(e, r, n);
    if (e.name === "TITLE" && typeof a == "string") {
      const i = a.trim();
...
}, s(Co, "RailroadEbnfValueConverter"), Co), xP = {
  parser: {
...
s(MP, "createRailroadEbnfServices");
var bo, VU = (bo = class extends Tt {
  constructor() {
    super(["railroad-abnf-beta"]);
  }
}, s(bo, "RailroadAbnfTokenBuilder"), bo), _o, HU = (_o = class extends gr {
  runConverter(e, r, n) {
    const a = super.runConverter(e, r, n);
    if (e.name === "TITLE" && typeof a == "string") {
      const i = a.trim();
...
}, s(_o, "RailroadAbnfValueConverter"), _o), GP = {
  parser: {
    TokenBuilder: /* @__PURE__ */ s(() => new VU(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ s(() => new HU(), "ValueConverter")
  }
};
function FP(t = st) {
  const e = re(
...
s(FP, "createRailroadAbnfServices");
var So, YU = (So = class extends Tt {
  constructor() {
    super(["railroad-peg-beta"]);
  }
}, s(So, "RailroadPegTokenBuilder"), So), N$ = /* @__PURE__ */ s((t) => {
  const e = t.slice(1, -1);
  let r = "";
  for (let n = 0; n < e.length; n++) {
    const a = e[n];
...
`;
  ...
  return r;
}, "decodeEscapedString"), wo, XU = (wo = class extends gr {
  runConverter(e, r, n) {
    const a = super.runConverter(e, r, n);
    if (e.name === "TITLE" && typeof a == "string") {
      const i = a.trim();
...
}, s(wo, "RailroadPegValueConverter"), wo), zP = {
  parser: {
    TokenBuilder: /* @__PURE__ */ s(() => new YU(), "TokenBuilder"),
...
s(jP, "createRailroadPegServices");
var Io, JU = (Io = class extends Tt {
  constructor() {
    super(["treemap"]);
  }
}, s(Io, "TreemapTokenBuilder"), Io), ZU = /classDef\s+([A-Z_a-z]\w+)(?:\s+([^\n\r;]*))?;?/, No, QU = (No = class extends gr {
  runCustomConverter(e, r, n) {
    if (e.name === "NUMBER2")
...
}, s(Po, "TreemapValidator"), Po), UP = {
  parser: {
    TokenBuilder: /* @__PURE__ */ s(() => new JU(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ s(() => new QU(), "ValueConverter")
  },
  validation: {
    TreemapValidator: /* @__PURE__ */ s(() => new eK(), "TreemapValidator")
  }
};
function KP(t = st) {
  const e = re(
  ...
  return e.ServiceRegistry.register(r), BP(r), { shared: e, Treemap: r };
}
s(KP, "createTreemapServices");
var ko, tK = (ko = class extends gr {
  runCustomConverter(e, r, n) {
    switch (e.name.toUpperCase()) {
      case "LINK_LABEL":
...
}, s(ko, "WardleyValueConverter"), ko), WP = {
  parser: {
    ValueConverter: /* @__PURE__ */ s(() => new tK(), "ValueConverter")
  }
};
function qP(t = st) {
  const e = re(
...
var Oo, rK = (Oo = class extends Tt {
  constructor() {
    super(["cynefin-beta"]);
  }
}, s(Oo, "CynefinTokenBuilder"), Oo), VP = {
  parser: {
...
s(HP, "createCynefinServices");
var Lo, nK = (Lo = class extends Tt {
  constructor() {
    super(["gitGraph"]);
  }
}, s(Lo, "GitGraphTokenBuilder"), Lo), YP = {
  parser: {
...
s(XP, "createGitGraphServices");
var Do, aK = (Do = class extends Tt {
  constructor() {
    super(["info", "showInfo"]);
  }
}, s(Do, "InfoTokenBuilder"), Do), JP = {
  parser: {
    TokenBuilder: /* @__PURE__ */ s(() => new aK(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ s(() => new pl(), "ValueConverter")
  }
};
function ZP(t = st) {
...
s(ZP, "createInfoServices");
var xo, iK = (xo = class extends Tt {
  constructor() {
    super(["packet"]);
  }
}, s(xo, "PacketTokenBuilder"), xo), QP = {
  parser: {
    TokenBuilder: /* @__PURE__ */ s(() => new iK(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ s(() => new pl(), "ValueConverter")
  }
};
function ek(t = st) {
...
s(ek, "createPacketServices");
var Mo, sK = (Mo = class extends Tt {
  constructor() {
    super(["pie", "showData"]);
  }
}, s(Mo, "PieTokenBuilder"), Mo), Go, oK = (Go = class extends gr {
  runCustomConverter(e, r, n) {
    if (e.name === "PIE_SECTION_LABEL")
      return r.replace(/"/g, "").trim();
  }
}, s(Go, "PieValueConverter"), Go), tk = {
  parser: {
    TokenBuilder: /* @__PURE__ */ s(() => new sK(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ s(() => new oK(), "ValueConverter")
  }
};
function rk(t = st) {
  const e = re(
...
s(rk, "createPieServices");
var Fo, lK = (Fo = class extends gr {
  runCustomConverter(e, r, n) {
    if (e.name === "INDENTATION")
...
}, s(Fo, "TreeViewValueConverter"), Fo), zo, uK = (zo = class extends Tt {
  constructor() {
    super(["treeView-beta"]);
  }
}, s(zo, "TreeViewTokenBuilder"), zo), nk = {
  parser: {
...
s(ak, "createTreeViewServices");
var jo, cK = (jo = class extends Tt {
  constructor() {
    super(["architecture"]);
  }
}, s(jo, "ArchitectureTokenBuilder"), jo), Bo, fK = (Bo = class extends gr {
  runCustomConverter(e, r, n) {
    if (e.name === "ARCH_ICON")
      return r.replace(/[()]/g, "").trim();
...
}, s(Bo, "ArchitectureValueConverter"), Bo), ik = {
  parser: {
    TokenBuilder: /* @__PURE__ */ s(() => new cK(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ s(() => new fK(), "ValueConverter")
  }
};
function sk(t = st) {
  const e = re(
...
s(sk, "createArchitectureServices");
var Uo, dK = (Uo = class extends Tt {
  constructor() {
    super(["eventmodeling"]);
  }
}, s(Uo, "EventModelingTokenBuilder"), Uo), P$ = /* @__PURE__ */ new Set(["cmd", "command"]), k$ = /* @__PURE__ */ new Set(["evt", "event"]), vp = /* @__PURE__ */ new Set(["rmo", "readmodel"]), O$ = /* @__PURE__ */ new Set(["pcr", "processor"]), L$ = /* @__PURE__ */ new Set(["ui"]);
function ok(t) {
...
s(ok, "registerValidationChecks");
var Ko, pK = (Ko = class {
  checkSourceFrameTypes(e, r) {
    e.sourceFrames.length !== 0 && (P$.has(e.modelEntityType) ? this.validateSources(
      e,
      /* @__PURE__ */ new Set([...L$, ...O$]),
      "command",
      "ui or processor",
      r
    ) : k$.has(e.modelEntityType) ? this.validateSources(e, P$, "event", "command", r) : vp.has(e.modelEntityType) ? this.validateSources(e, k$, "read model", "event", r) : O$.has(e.modelEntityType) ? this.validateSources(e, vp, "processor", "read model", r) : L$.has(e.modelEntityType) && this.validateSources(e, vp, "ui", "read model", r));
  }
...
}, s(Ko, "EventModelingValidator"), Ko), lk = {
  parser: {
    TokenBuilder: /* @__PURE__ */ s(() => new dK(), "TokenBuilder"),
    ValueConverter: /* @__PURE__ */ s(() => new pl(), "ValueConverter")
  },
  validation: {
    EventModelingValidator: /* @__PURE__ */ s(() => new pK(), "EventModelingValidator")
  }
};
function uk(t = st) {
  const e = re(
  ...
  return e.ServiceRegistry.register(r), ok(r), { shared: e, EventModel: r };
}
s(uk, "createEventModelingServices");
var rt = {}, mK = {
  info: /* @__PURE__ */ s(async () => {
    const { createInfoServices: t } = await Promise.resolve().then(() => gK), e = t().Info.parser.LangiumParser;
    rt.info = e;
  }, "info"),
  packet: /* @__PURE__ */ s(async () => {
    const { createPacketServices: t } = await Promise.resolve().then(() => vK), e = t().Packet.parser.LangiumParser;
    rt.packet = e;
  }, "packet"),
  pie: /* @__PURE__ */ s(async () => {
    const { createPieServices: t } = await Promise.resolve().then(() => TK), e = t().Pie.parser.LangiumParser;
    rt.pie = e;
  }, "pie"),
  treeView: /* @__PURE__ */ s(async () => {
    const { createTreeViewServices: t } = await Promise.resolve().then(() => $K), e = t().TreeView.parser.LangiumParser;
    rt.treeView = e;
  }, "treeView"),
  architecture: /* @__PURE__ */ s(async () => {
    const { createArchitectureServices: t } = await Promise.resolve().then(() => RK), e = t().Architecture.parser.LangiumParser;
    rt.architecture = e;
  }, "architecture"),
  gitGraph: /* @__PURE__ */ s(async () => {
    const { createGitGraphServices: t } = await Promise.resolve().then(() => AK), e = t().GitGraph.parser.LangiumParser;
    rt.gitGraph = e;
  }, "gitGraph"),
  eventmodeling: /* @__PURE__ */ s(async () => {
    const { createEventModelingServices: t } = await Promise.resolve().then(() => EK), e = t().EventModel.parser.LangiumParser;
    rt.eventmodeling = e;
  }, "eventmodeling"),
  radar: /* @__PURE__ */ s(async () => {
    const { createRadarServices: t } = await Promise.resolve().then(() => CK), e = t().Radar.parser.LangiumParser;
    rt.radar = e;
  }, "radar"),
  railroad: /* @__PURE__ */ s(async () => {
    const { createRailroadServices: t } = await Promise.resolve().then(() => bK), e = t().Railroad.parser.LangiumParser;
    rt.railroad = e;
  }, "railroad"),
  railroadEbnf: /* @__PURE__ */ s(async () => {
    const { createRailroadEbnfServices: t } = await Promise.resolve().then(() => _K), e = t().RailroadEbnf.parser.LangiumParser;
    rt.railroadEbnf = e;
  }, "railroadEbnf"),
  railroadAbnf: /* @__PURE__ */ s(async () => {
    const { createRailroadAbnfServices: t } = await Promise.resolve().then(() => SK), e = t().RailroadAbnf.parser.LangiumParser;
    rt.railroadAbnf = e;
  }, "railroadAbnf"),
  railroadPeg: /* @__PURE__ */ s(async () => {
    const { createRailroadPegServices: t } = await Promise.resolve().then(() => wK), e = t().RailroadPeg.parser.LangiumParser;
    rt.railroadPeg = e;
  }, "railroadPeg"),
  treemap: /* @__PURE__ */ s(async () => {
    const { createTreemapServices: t } = await Promise.resolve().then(() => IK), e = t().Treemap.parser.LangiumParser;
    rt.treemap = e;
  }, "treemap"),
  wardley: /* @__PURE__ */ s(async () => {
    const { createWardleyServices: t } = await Promise.resolve().then(() => NK), e = t().Wardley.parser.LangiumParser;
    rt.wardley = e;
  }, "wardley"),
  cynefin: /* @__PURE__ */ s(async () => {
    const { createCynefinServices: t } = await Promise.resolve().then(() => PK), e = t().Cynefin.parser.LangiumParser;
    rt.cynefin = e;
  }, "cynefin")
};
...
s(hK, "parse");
var Wo, yK = (Wo = class extends Error {
  constructor(e) {
