import { A as F, a as y, c as kn, B as Pn, e as Q, C as nn, D as Nn, E as Qn, F as ne, l as ee, H as re, q as te, I as ie, v as A, J as ae, K as cn, L as oe, M as Ln, t as ue, y as R, k as de, N as fe, O as _n, P as Cn, Q as se, R as en, T as In, V as ce, W as Rn, z as D, n as le, X as he, Y as ve, G as g, Z as c, _ as pe, i as m, $ as T, a0 as O, a1 as G } from "./graph-D5uqWawC.js";
import { g as we, b as be, k as V, a as Tn, c as me, d as ge, e as ye, f as xe, i as Ee, h as Mn, j as Oe, m as w } from "./map-CNf5AhU0.js";
var ke = /\s/;
function Pe(n) {
  for (var e = n.length; e-- && ke.test(n.charAt(e)); )
    ;
  return e;
}
var Ne = /^\s+/;
function Le(n) {
  return n && n.slice(0, Pe(n) + 1).replace(Ne, "");
}
var ln = NaN, _e = /^[-+]0x[0-9a-f]+$/i, Ce = /^0b[01]+$/i, Ie = /^0o[0-7]+$/i, Re = parseInt;
function Te(n) {
  if (typeof n == "number")
    return n;
  if (F(n))
  ...
  n = Le(n);
  var r = Ce.test(n);
  return r || Ie.test(n) ? Re(n.slice(2), r ? 2 : 8) : _e.test(n) ? ln : +n;
}
var hn = 1 / 0, Me = 17976931348623157e292;
function S(n) {
  if (!n)
    return n === 0 ? n : 0;
  if (n = Te(n), n === hn || n === -hn) {
...
function _(n, e, r) {
  if (!y(r))
    return !1;
  var t = typeof e;
  return (t == "number" ? kn(r) && Pn(e, r.length) : t == "string" && e in r) ? Q(r[e], n) : !1;
}
function Fe(n) {
  return nn(function(e, r) {
    var t = -1, i = r.length, o = i > 1 ? r[i - 1] : void 0, a = i > 2 ? r[2] : void 0;
    for (o = n.length > 3 && typeof o == "function" ? (i--, o) : void 0, a && _(r[0], r[1], a) && (o = i < 3 ? void 0 : o, i = 1), e = Object(e); ++t < i; ) {
      var u = r[t];
      u && n(e, u, t, o);
    }
    return e;
...
function Ae(n) {
  return Qn(ne(n, void 0, P), n + "");
}
var Be = "[object Object]", je = Function.prototype, Ge = Object.prototype, Sn = je.toString, Ve = Ge.hasOwnProperty, Ye = Sn.call(Object);
function $e(n) {
  if (!ee(n) || re(n) != Be)
    return !1;
  var e = we(n);
  if (e === null)
    return !0;
  var r = Ve.call(e, "constructor") && e.constructor;
  return typeof r == "function" && r instanceof r && Sn.call(r) == Ye;
}
var De = 1, qe = 4;
function We(n) {
  return be(n, De | qe);
}
var Fn = Object.prototype, Xe = Fn.hasOwnProperty, He = nn(function(n, e) {
  n = Object(n);
  var r = -1, t = e.length, i = t > 2 ? e[2] : void 0;
  for (i && _(e[0], e[1], i) && (t = 1); ++r < t; )
    for (var o = e[r], a = V(o), u = -1, d = a.length; ++u < d; ) {
      var f = a[u], s = n[f];
      (s === void 0 || Q(s, Fn[f]) && !Xe.call(n, f)) && (n[f] = o[f]);
    }
  return n;
});
function U(n, e, r) {
  (r !== void 0 && !Q(n[e], r) || r === void 0 && !(e in n)) && Tn(n, e, r);
}
function J(n, e) {
...
function Ue(n, e, r, t, i, o, a) {
  var u = J(n, r), d = J(e, r), f = a.get(d);
  if (f) {
    U(n, r, f);
    return;
  }
  var s = o ? o(u, d, r + "", n, e, a) : void 0, l = s === void 0;
  if (l) {
    var h = A(d), v = !h && te(d), p = !h && !v && ie(d);
    s = d, h || v || p ? A(u) ? s = u : ae(u) ? s = ge(u) : v ? (l = !1, s = ye(d, !0)) : p ? (l = !1, s = xe(d, !0)) : s = [] : $e(d) || cn(d) ? (s = u, cn(u) ? s = ze(u) : (!y(u) || oe(u)) && (s = Ee(d))) : l = !1;
  }
  l && (a.set(d, s), i(s, d, t, o, a), a.delete(d)), U(n, r, s);
}
function An(n, e, r, t, i) {
  n !== e && Ln(e, function(o, a) {
    if (i || (i = new ue()), y(o))
      Ue(n, e, a, r, An, t, i);
    else {
      var u = t ? t(J(n, a), o, a + "", n, e, i) : void 0;
      u === void 0 && (u = o), U(n, a, u);
    }
  }, V);
}
function B(n) {
...
function Ze(n, e, r) {
  ...
  if (!t)
    return -1;
  var i = r == null ? 0 : Se(r);
  return i < 0 && (i = Ke(t + i, 0)), fe(n, R(e), i);
}
var rn = Je(Ze);
function Qe(n, e) {
  return n == null ? n : Ln(n, _n(e), V);
}
function nr(n, e) {
  return n && Cn(n, _n(e));
}
...
var rr = Object.prototype, tr = rr.hasOwnProperty;
function ir(n, e) {
  return n != null && tr.call(n, e);
}
function Bn(n, e) {
  return n != null && se(n, e, ir);
}
function jn(n, e) {
  return n < e;
}
function Y(n, e) {
  var r = {};
  return e = R(e), Cn(n, function(t, i, o) {
    Tn(r, i, e(t, i, o));
  }), r;
}
function tn(n, e, r) {
...
function x(n) {
  return n && n.length ? tn(n, en, er) : void 0;
}
var K = Fe(function(n, e, r) {
  An(n, e, r);
});
function C(n) {
  return n && n.length ? tn(n, en, jn) : void 0;
}
function an(n, e) {
  return n && n.length ? tn(n, R(e), jn) : void 0;
}
function ar(n, e, r, t) {
  if (!y(n))
    return n;
  ...
  for (var i = -1, o = e.length, a = o - 1, u = n; u != null && ++i < o; ) {
    ...
    if (i != a) {
      var s = u[d];
      f = void 0, f === void 0 && (f = y(s) ? s : Pn(e[i + 1]) ? [] : {});
    }
    Mn(u, d, f), u = u[d];
  }
  return n;
...
function sr(n, e, r) {
  e.length ? e = D(e, function(o) {
    return A(o) ? function(a) {
      return Rn(a, o.length === 1 ? o[0] : o);
    } : o;
  }) : e = [en];
  var t = -1;
  e = D(e, le(R));
  var i = Oe(n, function(o, a, u) {
    var d = D(e, function(f) {
      return f(o);
    });
    return { criteria: d, index: ++t, value: o };
  });
  return ur(i, function(o, a) {
    return fr(o, a, r);
  });
}
function cr(n, e) {
  return or(n, e, function(r, t) {
    return he(n, t);
  });
}
var j = Ae(function(n, e) {
  return n == null ? {} : cr(n, e);
}), lr = Math.ceil, hr = Math.max;
function vr(n, e, r, t) {
  for (var i = -1, o = hr(lr((e - n) / (r || 1)), 0), a = Array(o); o--; )
    a[++i] = n, n += r;
  return a;
}
function pr(n) {
  return function(e, r, t) {
    return t && typeof t != "number" && _(e, r, t) && (r = t = void 0), e = S(e), r === void 0 ? (r = e, e = 0) : r = S(r), t = t === void 0 ? e < r ? 1 : -1 : S(t), vr(e, r, t);
  };
}
var k = pr(), M = nn(function(n, e) {
  if (n == null)
    return [];
  var r = e.length;
  return r > 1 && _(n, e[0], e[1]) ? e = [] : r > 2 && _(e[0], e[1], e[2]) && (e = [e[0]]), sr(n, Nn(e), []);
}), wr = 0;
function on(n) {
  var e = ++wr;
  return ve(n) + e;
...
class gr {
  ...
  enqueue(e) {
    ...
    e._prev && e._next && vn(e), e._next = r._next, r._next._prev = e, r._next = e, e._prev = r;
  }
  toString() {
    for (var e = [], r = this._sentinel, t = r._prev; t !== r; )
      e.push(JSON.stringify(t, yr)), t = t._prev;
    return "[" + e.join(", ") + "]";
  }
}
function vn(n) {
...
function Er(n, e) {
  if (n.nodeCount() <= 1)
    return [];
  var r = kr(n, e || xr), t = Or(r.graph, r.buckets, r.zeroIdx);
  return P(
    w(t, function(i) {
...
function q(n, e, r, t, i) {
  var o = i ? [] : void 0;
  return c(n.inEdges(t.v), function(a) {
    var u = n.edge(a), d = n.node(a.v);
    i && o.push({ v: a.v, w: a.w }), d.out -= u, Z(e, r, d);
  }), c(n.outEdges(t.v), function(a) {
...
function kr(n, e) {
  ...
  c(n.nodes(), function(u) {
    ...
    var d = r.edge(u.v, u.w) || 0, f = e(u), s = d + f;
...
function Pr(n) {
  var e = n.graph().acyclicer === "greedy" ? Er(n, r(n)) : Nr(n);
  c(e, function(t) {
    var i = n.edge(t);
    n.removeEdge(t), i.forwardName = t.name, i.reversed = !0, n.setEdge(t.w, t.v, i, on("rev"));
  });
  function r(t) {
    return function(i) {
...
function Nr(n) {
  var e = [], r = {}, t = {};
  function i(o) {
    Object.prototype.hasOwnProperty.call(t, o) || (t[o] = !0, r[o] = !0, c(n.outEdges(o), function(a) {
...
function wn(n, e, r, t) {
  ...
  return arguments.length >= 4 && (i.rank = r, i.order = t), N(n, "border", i, e);
}
function Vn(n) {
  return x(
...
function Mr(n) {
  function e(r) {
    ...
    if (t.length && c(t, e), Object.prototype.hasOwnProperty.call(i, "minRank")) {
      i.borderLeft = [], i.borderRight = [];
      for (var o = i.minRank, a = i.maxRank + 1; o < a; ++o)
        bn(n, "borderLeft", "_bl", r, i, o), bn(n, "borderRight", "_br", r, i, o);
    }
  }
  c(n.children(), e);
}
function bn(n, e, r, t, i, o) {
  var a = { width: 0, height: 0, rank: o, borderType: e }, u = i[e][o - 1], d = N(n, "border", a, r);
...
function Fr(n) {
  var e = n.graph().rankdir.toLowerCase();
  (e === "bt" || e === "rl") && Ar(n), (e === "lr" || e === "rl") && (Br(n), Yn(n));
}
function Yn(n) {
...
function Ar(n) {
  c(n.nodes(), function(e) {
    ...
    var r = n.edge(e);
    c(r.points, W), Object.prototype.hasOwnProperty.call(r, "y") && W(r);
  });
}
function W(n) {
  n.y = -n.y;
...
function Br(n) {
  c(n.nodes(), function(e) {
    ...
    var r = n.edge(e);
    c(r.points, X), Object.prototype.hasOwnProperty.call(r, "x") && X(r);
  });
}
function X(n) {
  var e = n.x;
  ...
  if (o !== t + 1) {
    ...
    for (l = 0, ++t; t < o; ++l, ++t)
      u.points = [], f = {
        ...
        edgeObj: e,
        rank: t
      }, s = N(n, "edge", f, "_d"), t === d && (f.width = u.width, f.height = u.height, f.dummy = "edge-label", f.labelpos = u.labelpos), n.setEdge(r, s, { weight: u.weight }, a), l === 0 && n.graph().dummyChains.push(s), r = s;
...
function $n(n) {
  ...
  e.setNode(r, {});
  for (var i, o; Yr(e, n) < t; )
    i = $r(e, n), o = e.hasNode(i.v) ? I(n, i) : -I(n, i), Dr(e, n, o);
  return e;
}
function Yr(n, e) {
  function r(t) {
    c(e.nodeEdges(t), function(i) {
      ...
      !n.hasNode(a) && !I(e, i) && (n.setNode(a, {}), n.setEdge(t, a, {}), r(a));
    });
  }
  return c(n.nodes(), r), n.nodeCount();
}
function $r(n, e) {
  return an(e.edges(), function(r) {
...
function qn(n, e, r, t, i, o) {
  Object.prototype.hasOwnProperty.call(t, e) || (t[e] = !0, r || o.push(e), c(i(e), function(a) {
    qn(n, a, r, t, i, o);
  }), r && o.push(e));
}
function Wr(n, e) {
...
function Hr(n, e, r) {
  ...
  n.edge(r, i).cutvalue = Wn(n, e, r);
}
function Wn(n, e, r) {
  var t = n.node(r), i = t.parent, o = !0, a = e.edge(r, i), u = 0;
  return a || (o = !1, a = e.edge(i, r)), u = a.weight, c(e.nodeEdges(r), function(d) {
    var f = d.v === r, s = f ? d.w : d.v;
    if (s !== i) {
      var l = f === o, h = e.edge(d).weight;
      if (u += l ? h : -h, Ur(n, r, s)) {
        var v = n.edge(r, s).cutvalue;
        u += l ? -v : v;
      }
    }
  }), u;
...
function fn(n, e) {
  arguments.length < 2 && (e = n.nodes()[0]), Xn(n, {}, 1, e);
}
function Xn(n, e, r, t, i) {
  var o = r, a = n.node(t);
  return e[t] = !0, c(n.neighbors(t), function(u) {
    Object.prototype.hasOwnProperty.call(e, u) || (r = Xn(n, e, r, u, t));
  }), a.low = o, a.lim = r++, i ? a.parent = i : delete a.parent, r;
}
function Hn(n) {
  return rn(n.edges(), function(e) {
...
function zn(n, e, r) {
  ...
  o.lim > a.lim && (u = a, d = !0);
  var f = T(e.edges(), function(s) {
    return d === gn(n, n.node(s.v), u) && d !== gn(n, n.node(s.w), u);
  });
  return an(f, function(s) {
    return I(e, s);
  });
}
function Un(n, e, r, t) {
  var i = r.v, o = r.w;
  n.removeEdge(i, o), n.setEdge(t.v, t.w, {}), fn(n), dn(n, e), zr(n, e);
}
function zr(n, e) {
  var r = rn(n.nodes(), function(i) {
...
function Qr(n) {
  var e = N(n, "root", {}, "_root"), r = nt(n), t = x(O(r)) - 1, i = 2 * t + 1;
  n.graph().nestingRoot = e, c(n.edges(), function(a) {
    n.edge(a).minlen *= i;
  });
  var o = et(n) + 1;
  c(n.children(), function(a) {
    Jn(n, e, i, o, t, r, a);
  }), n.graph().nodeRankFactor = i;
}
function Jn(n, e, r, t, i, o, a) {
  var u = n.children(a);
  if (!u.length) {
    a !== e && n.setEdge(e, a, { weight: 0, minlen: r });
    return;
  }
  var d = wn(n, "_bt"), f = wn(n, "_bb"), s = n.node(a);
  n.setParent(d, a), s.borderTop = d, n.setParent(f, a), s.borderBottom = f, c(u, function(l) {
    Jn(n, e, r, t, i, o, l);
    var h = n.node(l), v = h.borderTop ? h.borderTop : l, p = h.borderBottom ? h.borderBottom : l, b = h.borderTop ? t : 2 * t, L = v !== p ? 1 : i - o[a] + 1;
    n.setEdge(d, v, {
      weight: b,
      minlen: L,
      nestingEdge: !0
...
function it(n, e, r) {
  var t = at(n), i = new g({ compound: !0 }).setGraph({ root: t }).setDefaultNodeLabel(function(o) {
    return n.node(o);
  });
  return c(n.nodes(), function(o) {
    var a = n.node(o), u = n.parent(o);
    (a.rank === e || a.minRank <= e && e <= a.maxRank) && (i.setNode(o), i.setParent(o, u || t), c(n[r](o), function(d) {
      var f = d.v === o ? d.w : d.v, s = i.edge(f, o), l = m(s) ? 0 : s.weight;
      i.setEdge(f, o, { weight: n.edge(d).weight + l });
...
function at(n) {
  for (var e; n.hasNode(e = on("_root")); ) ;
  return e;
}
function ot(n, e) {
...
function ut(n, e, r) {
  for (var t = mr(
    ...
    w(e, function(f) {
      return M(
        w(n.outEdges(f), function(s) {
          return { pos: t[s.w], weight: n.edge(s).weight };
        }),
        "pos"
      );
    })
  ...
  return c(
    ...
    i.forEach(function(f) {
      ...
      u[s] += f.weight;
      for (var l = 0; s > 0; )
        s % 2 && (l += u[s + 1]), s = s - 1 >> 1, u[s] += f.weight;
      d += f.weight * l;
    })
  ), d;
}
function dt(n) {
  ...
  function o(u) {
    if (!Bn(e, u)) {
      e[u] = !0;
      var d = n.node(u);
      i[d.rank].push(u), c(n.successors(u), o);
    }
  }
  var a = M(r, function(u) {
    return n.node(u).rank;
  });
  return c(a, o), i;
}
...
function ct(n) {
  ...
  function r(o) {
    return function(a) {
      a.merged || (m(a.barycenter) || m(o.barycenter) || a.barycenter >= o.barycenter) && lt(o, a);
    };
  }
  function t(o) {
    return function(a) {
...
function ht(n, e) {
  var r = Rr(n, function(s) {
    return Object.prototype.hasOwnProperty.call(s, "barycenter");
  }), t = r.lhs, i = M(r.rhs, function(s) {
    return -s.i;
  }), o = [], a = 0, u = 0, d = 0;
  t.sort(vt(!!e)), d = xn(o, i, d), c(t, function(s) {
    d += s.vs.length, o.push(s.vs), a += s.barycenter * s.weight, u += s.weight, d = xn(o, i, d);
  });
  var f = { vs: P(o) };
...
function Kn(n, e, r, t) {
  ...
  c(f, function(p) {
    if (n.children(p.v).length) {
      var b = Kn(n, p.v, r, t);
      d[p.v] = b, Object.prototype.hasOwnProperty.call(b, "barycenter") && wt(p, b);
    }
  });
  var s = st(f, r);
  pt(s, d);
  var l = ht(s, t);
  if (a && (l.vs = P([a, l.vs, u]), n.predecessors(a).length)) {
...
function bt(n) {
  var e = Vn(n), r = En(n, k(1, e + 1), "inEdges"), t = En(n, k(e - 1, -1, -1), "outEdges"), i = dt(n);
  On(n, i);
  for (var o = Number.POSITIVE_INFINITY, a, u = 0, d = 0; d < 4; ++u, ++d) {
    mt(u % 2 ? r : t, u % 4 >= 2), i = $(n);
    var f = ot(n, i);
    f < o && (d = 0, a = We(i), o = f);
  }
  On(n, a);
...
function mt(n, e) {
  var r = new g();
  c(n, function(t) {
    var i = t.graph().root, o = Kn(t, i, r, e);
    c(o.vs, function(a, u) {
      t.node(a).order = u;
    }), tt(t, r, o.vs);
  });
...
function gt(n) {
  ...
  c(n.graph().dummyChains, function(r) {
    for (var t = n.node(r), i = t.edgeObj, o = yt(n, e, i.v, i.w), a = o.path, u = o.lca, d = 0, f = a[d], s = !0; r !== i.w; ) {
      if (t = n.node(r), s) {
...
function xt(n) {
  ...
  function t(i) {
    var o = r;
    c(n.children(i), t), e[i] = { low: o, lim: r++ };
  }
...
function Et(n, e) {
  var r = {};
  function t(i, o) {
    var a = 0, u = 0, d = i.length, f = B(o);
    return c(o, function(s, l) {
      var h = kt(n, s), v = h ? n.node(h).order : d;
      (h || s === f) && (c(o.slice(u, l + 1), function(p) {
        c(n.predecessors(p), function(b) {
          var L = n.node(b), sn = L.order;
          (sn < a || v < sn) && !(L.dummy && n.node(p).dummy) && Zn(r, b, p);
        });
      }), u = l + 1, a = v);
    }), o;
  }
...
function Ot(n, e) {
  ...
  function t(o, a, u, d, f) {
    var s;
    c(k(a, u), function(l) {
      s = o[l], n.node(s).dummy && c(n.predecessors(s), function(h) {
        var v = n.node(h);
        v.dummy && (v.order < d || v.order > f) && Zn(r, h, s);
      });
    });
  }
  function i(o, a) {
    ...
    return c(a, function(s, l) {
      if (n.node(s).dummy === "border") {
        var h = n.predecessors(s);
        h.length && (d = n.node(h[0]).order, t(a, f, l, u, d), f = l, u = d);
      }
...
function kt(n, e) {
  if (n.node(e).dummy)
    return rn(n.predecessors(e), function(r) {
    ...
    c(u, function(f) {
      ...
      if (s.length) {
        ...
        for (var l = (s.length - 1) / 2, h = Math.floor(l), v = Math.ceil(l); h <= v; ++h) {
          var p = s[h];
          o[f] === f && d < a[p] && !Pt(r, f, p) && (o[p] = f, o[f] = i[f] = i[p], d = a[p]);
        }
      }
    });
  }), { root: i, align: o };
...
function Lt(n, e, r, t, i) {
  var o = {}, a = _t(n, e, r, i), u = i ? "borderLeft" : "borderRight";
  function d(l, h) {
  ...
  return d(f, a.predecessors.bind(a)), d(s, a.successors.bind(a)), c(t, function(l) {
    o[l] = o[r[l]];
  }), o;
}
function _t(n, e, r, t) {
  var i = new g(), o = n.graph(), a = Mt(o.nodesep, o.edgesep, t);
  return c(e, function(u) {
    var d;
    c(u, function(f) {
      var s = r[f];
      if (i.setNode(s), d) {
        var l = r[d], h = i.edge(l, s);
        i.setEdge(l, s, Math.max(a(n, f, d), h || 0));
      }
      d = f;
    });
  }), i;
...
function It(n, e) {
  var r = O(e), t = C(r), i = x(r);
  c(["u", "d"], function(o) {
    c(["l", "r"], function(a) {
      var u = o + a, d = n[u], f;
      if (d !== e) {
        var s = O(d);
        f = a === "l" ? t - C(s) : i - x(s), f && (n[u] = Y(d, function(l) {
          return l + f;
        }));
      }
    });
...
function Tt(n) {
  var e = $(n), r = K(Et(n, e), Ot(n, e)), t = {}, i;
  c(["u", "d"], function(a) {
    i = a === "u" ? e : O(e).reverse(), c(["l", "r"], function(u) {
      u === "r" && (i = w(i, function(l) {
        return O(l).reverse();
      }));
      var d = (a === "u" ? n.predecessors : n.successors).bind(n), f = Nt(n, i, r, d), s = Lt(n, i, f.root, f.align, u === "r");
      u === "r" && (s = Y(s, function(l) {
        return -l;
      })), t[a + u] = s;
    });
  });
  var o = Ct(n, t);
  return It(t, o), Rt(t, n.graph().align);
}
function Mt(n, e, r) {
  return function(t, i, o) {
    ...
    if (f && (d += r ? f : -f), f = 0, d += (a.dummy ? e : n) / 2, d += (u.dummy ? e : n) / 2, d += u.width / 2, Object.prototype.hasOwnProperty.call(u, "labelpos"))
...
function Ft(n) {
  n = Gn(n), At(n), nr(Tt(n), function(e, r) {
    n.node(r).x = e;
  });
}
function At(n) {
...
var Gt = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"], Vt = { ranksep: 50, edgesep: 20, nodesep: 50, rankdir: "tb" }, Yt = ["acyclicer", "ranker", "rankdir", "align"], $t = ["width", "height"], Dt = { width: 0, height: 0 }, qt = ["minlen", "weight", "width", "height", "labeloffset"], Wt = {
  minlen: 1,
  weight: 1,
  width: 0,
  height: 0,
...
function Ht(n) {
  var e = new g({ multigraph: !0, compound: !0 }), r = z(n.graph());
  return e.setGraph(
    K({}, Vt, H(r, Gt), j(r, Yt))
  ), c(n.nodes(), function(t) {
    var i = z(n.node(t));
    e.setNode(t, He(H(i, $t), Dt)), e.setParent(t, n.parent(t));
...
function Jt(n) {
  ...
  c(n.nodes(), function(r) {
    var t = n.node(r);
    t.borderTop && (t.minRank = n.node(t.borderTop).rank, t.maxRank = n.node(t.borderBottom).rank, e = x(e, t.maxRank));
  }), n.graph().maxRank = e;
}
function Kt(n) {
  c(n.nodes(), function(e) {
...
function Zt(n) {
  ...
  function d(f) {
    var s = f.x, l = f.y, h = f.width, v = f.height;
    e = Math.min(e, s - h / 2), r = Math.max(r, s + h / 2), t = Math.min(t, l - v / 2), i = Math.max(i, l + v / 2);
  }
  c(n.nodes(), function(f) {
    ...
    c(s.points, function(l) {
      l.x -= e, l.y -= t;
    }), Object.prototype.hasOwnProperty.call(s, "x") && (s.x -= e), Object.prototype.hasOwnProperty.call(s, "y") && (s.y -= t);
  }), o.width = r - e + a, o.height = i - t + u;
}
function Qt(n) {
  c(n.edges(), function(e) {
    var r = n.edge(e), t = n.node(e.v), i = n.node(e.w), o, a;
    r.points ? (o = r.points[0], a = r.points[r.points.length - 1]) : (r.points = [], o = i, a = t), r.points.unshift(pn(t, o)), r.points.push(pn(i, a));
  });
}
function ni(n) {
  c(n.edges(), function(e) {
