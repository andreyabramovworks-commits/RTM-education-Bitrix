import { g as ee } from "./chunk-XXDRQBXY-CodB0T6s.js";
import { s as se } from "./chunk-VR4S4FIN-D0pHRR9a.js";
import { _ as S, l as b, c as F, x as ie, y as re, a as ae, b as ne, g as oe, s as le, o as ce, p as he, a9 as ue, k as K, q as de, d as Dt, a5 as fe } from "./index-CJmYqQwh.js";
import { f as pe } from "./chunk-32BRIVSS-Buv07inh.js";
var Ct = function() {
  var t = /* @__PURE__ */ S(function(U, l, d, n) {
    for (d = d || {}, n = U.length; n--; d[U[n]] = l) ;
    return d;
  }, "o"), e = [1, 2], s = [1, 3], a = [1, 4], i = [2, 4], o = [1, 9], h = [1, 11], p = [1, 16], f = [1, 17], T = [1, 18], E = [1, 19], m = [1, 33], O = [1, 20], C = [1, 21], x = [1, 22], $ = [1, 23], R = [1, 24], u = [1, 26], L = [1, 27], k = [1, 28], V = [1, 29], P = [1, 30], v = [1, 31], B = [1, 32], j = [1, 35], nt = [1, 36], ot = [1, 37], lt = [1, 38], J = [1, 34], y = [1, 4, 5, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 41, 45, 48, 51, 52, 53, 54, 57], ct = [1, 4, 5, 14, 15, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 39, 40, 41, 45, 48, 51, 52, 53, 54, 57], Lt = [4, 5, 16, 17, 19, 21, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 41, 45, 48, 51, 52, 53, 54, 57], gt = {
    ...
    performAction: /* @__PURE__ */ S(function(l, d, n, g, _, r, Y) {
      var c = r.length - 1;
      switch (_) {
        case 3:
        ...
        case 13:
          const et = r[c - 1];
          et.description = g.trimColon(r[c]), this.$ = et;
          break;
        case 14:
        ...
        case 19:
          ...
          break;
        case 20:
          var G = r[c], q = r[c - 2].trim();
          if (r[c].match(":")) {
            var ut = r[c].split(":");
            G = ut[0], q = [q, ut[1]];
          }
          this.$ = { stmt: "state", id: G, type: "default", description: q };
          break;
        case 21:
    ...
    parse: /* @__PURE__ */ S(function(l) {
      var d = this, n = [0], g = [], _ = [null], r = [], Y = this.table, c = "", G = 0, q = 0, ut = 2, et = 1, Tt = r.slice.call(arguments, 1), D = Object.create(this.lexer), H = { yy: {} };
      for (var Et in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, Et) && (H.yy[Et] = this.yy[Et]);
      D.setInput(l, H.yy), H.yy.lexer = D, H.yy.parser = this, typeof D.yylloc > "u" && (D.yylloc = {});
      var _t = D.yylloc;
      r.push(_t);
      ...
      function te(I) {
        n.length = n.length - 2 * I, _.length = _.length - I, r.length = r.length - I;
      }
      S(te, "popStack");
      function wt() {
        var I;
        return I = g.pop() || D.lex() || et, typeof I != "number" && (I instanceof Array && (g = I, I = g.pop()), I = d.symbols_[I] || I), I;
      }
      S(wt, "lex");
      for (var w, z, N, mt, Q = {}, dt, M, Ot, ft; ; ) {
        if (z = n[n.length - 1], this.defaultActions[z] ? N = this.defaultActions[z] : ((w === null || typeof w > "u") && (w = wt()), N = Y[z] && Y[z][w]), typeof N > "u" || !N.length || !N[0]) {
          var bt = "";
          ft = [];
          for (dt in Y[z])
            this.terminals_[dt] && dt > ut && ft.push("'" + this.terminals_[dt] + "'");
          D.showPosition ? bt = "Parse error on line " + (G + 1) + `:
` + D.showPosition() + `
Expecting ` + ft.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : bt = "Parse error on line " + (G + 1) + ": Unexpected " + (w == et ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(bt, {
            text: D.match,
        ...
        switch (N[0]) {
          case 1:
            n.push(w), _.push(D.yytext), r.push(D.yylloc), n.push(N[1]), w = null, q = D.yyleng, c = D.yytext, G = D.yylineno, _t = D.yylloc;
            break;
          case 2:
            if (M = this.productions_[N[1]][1], Q.$ = _[_.length - M], Q._$ = {
              ...
              return mt;
            M && (n = n.slice(0, -1 * M * 2), _ = _.slice(0, -1 * M), r = r.slice(0, -1 * M)), n.push(this.productions_[N[1]][0]), _.push(Q.$), r.push(Q._$), Ot = Y[n[n.length - 2]][n[n.length - 1]], n.push(Ot);
            break;
          case 3:
            return !0;
        }
    ...
    var U = {
      ...
      parseError: /* @__PURE__ */ S(function(d, n) {
        if (this.yy.parser)
          this.yy.parser.parseError(d, n);
        else
          throw new Error(d);
      }, "parseError"),
      // resets the lexer, sets new input
      setInput: /* @__PURE__ */ S(function(l, d) {
      ...
      unput: /* @__PURE__ */ S(function(l) {
        ...
        return this.yylloc = {
          ...
          last_column: n ? (n.length === g.length ? this.yylloc.first_column : 0) + g[g.length - n.length].length - n[0].length : this.yylloc.first_column - d
...
` + d + "^";
      ...
      test_match: /* @__PURE__ */ S(function(l, d) {
        var n, g, _;
        ...
        }, this.yytext += l[0], this.match += l[0], this.matches = l, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(l[0].length), this.matched += l[0], n = this.performAction.call(this, this.yy, this, d, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), n)
          return n;
        if (this._backtrack) {
          for (var r in _)
            this[r] = _[r];
      ...
      next: /* @__PURE__ */ S(function() {
        ...
        for (var _ = this._currentRules(), r = 0; r < _.length; r++)
          if (n = this._input.match(this.rules[_[r]]), n && (!d || n[0].length > d[0].length)) {
            if (d = n, g = r, this.options.backtrack_lexer) {
        ...
        return d ? (l = this.test_match(d, _[g]), l !== !1 ? l : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      performAction: /* @__PURE__ */ S(function(d, n, g, _) {
        function r() {
          const Y = n.yytext.indexOf("%%");
          if (Y === 0)
            return !1;
          if (Y > 0) {
            const c = n.yytext.slice(0, Y), G = n.yytext.slice(Y);
            G && d.lexer.unput(G), n.yytext = c;
          }
          return !0;
        }
        switch (S(r, "processId"), g) {
          case 0:
            return 38;
          case 1:
            return 40;
...
Ct.parser = Ct;
var We = Ct, Se = "TB", Yt = "TB", Rt = "dir", tt = "state", Z = "root", At = "relation", ye = "classDef", ge = "style", Te = "applyClass", rt = "default", Gt = "divider", Vt = "fill:none", Mt = "fill: #333", Ut = "c", Wt = "markdown", jt = "normal", kt = "rect", vt = "rectWithTitle", Ee = "stateStart", _e = "stateEnd", It = "divider", Nt = "roundedWithTitle", me = "note", be = "noteGroup", at = "statediagram", De = "state", ke = `${at}-${De}`, Ht = "transition", ve = "note", Ce = "note-edge", Ae = `${Ht} ${Ce}`, xe = `${at}-${ve}`, Le = "cluster", we = `${at}-${Le}`, Oe = "cluster-alt", Re = `${at}-${Oe}`, zt = "parent", Kt = "note", Ie = "state", xt = "----", Ne = `${xt}${Kt}`, $t = `${xt}${zt}`, Xt = /* @__PURE__ */ S((t, e = Yt) => {
  if (!t.doc)
    return e;
  let s = e;
  ...
  return s;
}, "getDir"), $e = /* @__PURE__ */ S(function(t, e) {
  return e.db.getClasses();
}, "getClasses"), Fe = /* @__PURE__ */ S(async function(t, e, s, a) {
  b.info("REF0:"), b.info("Drawing state diagram (v2)", e);
  const { securityLevel: i, state: o, layout: h } = F();
  a.db.extract(a.db.getRootDocV2());
  const p = a.db.getData(), f = ee(e, i);
  p.type = a.type, p.layoutAlgorithm = h, p.nodeSpacing = (o == null ? void 0 : o.nodeSpacing) || 50, p.rankSpacing = (o == null ? void 0 : o.rankSpacing) || 50, F().look === "neo" ? p.markers = ["barbNeo"] : p.markers = ["barb"], p.diagramId = e, await ie(p, f);
  const E = 8;
  try {
    (typeof a.db.getLinks == "function" ? a.db.getLinks() : /* @__PURE__ */ new Map()).forEach((O, C) => {
      var P;
      const x = typeof C == "string" ? C : typeof (C == null ? void 0 : C.id) == "string" ? C.id : "", $ = p.nodes.find((v) => v.id === x);
      if (!x) {
        b.warn("⚠️ Invalid or missing stateId from key:", JSON.stringify(C));
        return;
      }
      const R = (P = f.node()) == null ? void 0 : P.querySelectorAll("g.node, g.rough-node");
      let u;
      if (R == null || R.forEach((v) => {
        var j;
        const B = (j = v.textContent) == null ? void 0 : j.trim();
        (v.id === ($ == null ? void 0 : $.domId) || B === x) && (u = v);
      }), !u) {
        b.warn("⚠️ Could not find node matching text:", x);
        return;
      }
      const L = u.parentNode;
      if (!L) {
        b.warn("⚠️ Node has no parent, cannot wrap:", x);
        return;
      }
      const k = document.createElementNS("http://www.w3.org/2000/svg", "a"), V = O.url.replace(/^"+|"+$/g, "");
      if (k.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", V), k.setAttribute("target", "_blank"), O.tooltip) {
        const v = O.tooltip.replace(/^"+|"+$/g, "");
        k.setAttribute("title", v), u.setAttribute("title", v);
      }
      L.replaceChild(k, u), k.appendChild(u), b.info("🔗 Wrapped node in <a> tag for:", x, O.url);
    });
  } catch (m) {
  ...
  ), se(f, E, at, (o == null ? void 0 : o.useMaxWidth) ?? !0);
}, "draw"), je = {
  getClasses: $e,
  draw: Fe,
  getDir: Xt
}, St = /* @__PURE__ */ new Map(), W = 0;
function yt(t = "", e = 0, s = "", a = xt) {
  const i = s !== null && s.length > 0 ? `${a}${s}` : "";
  return `${Ie}-${t}${i}-${e}`;
}
S(yt, "stateDomId");
var Pe = /* @__PURE__ */ S((t, e, s, a, i, o, h, p) => {
      ...
      case At:
        {
          ...
          const T = h === "neo", E = {
            ...
            style: Vt,
            labelStyle: "",
            label: K.sanitizeText(f.description ?? "", F()),
            arrowheadStyle: Mt,
            labelpos: Ut,
            labelType: Wt,
            thickness: jt,
...
var it = /* @__PURE__ */ S((t, e, s, a, i, o, h, p) => {
  ...
  if (b.info("dataFetcher parsedItem", e, T, m), f !== "root") {
    ...
    if (L.shape === It && (L.label = ""), t && t.id !== "root" && (b.trace("Setting node ", f, " to be child of its parent ", t.id), L.parentId = t.id), L.centerLabel = !0, e.note) {
      const k = {
        labelStyle: "",
        shape: me,
        label: e.note.text,
        ...
        type: u.type,
        isGroup: u.type === "group",
        padding: ($ = O.flowchart) == null ? void 0 : $.padding,
        look: h,
      ...
      W++, P.id = V, k.parentId = V, st(a, P, p), st(a, k, p), st(a, L, p);
      let v = f, B = k.id;
      e.note.position === "left of" && (v = k.id, B = f), i.push({
        id: v + "-" + B,
        start: v,
        end: B,
        arrowhead: "none",
  ...
  e.doc && (b.trace("Adding nodes children "), Pe(e, e.doc, s, a, i, !o, h, p));
}, "dataFetcher"), Be = /* @__PURE__ */ S(() => {
  St.clear(), W = 0;
}, "reset"), A = {
  START_NODE: "[*]",
  START_TYPE: "start",
  ...
  BG_FILL: "bgFill",
  STYLECLASS_SEP: ","
}, Pt = /* @__PURE__ */ S(() => /* @__PURE__ */ new Map(), "newClassesList"), Bt = /* @__PURE__ */ S(() => ({
  relations: [],
  states: /* @__PURE__ */ new Map(),
  documents: {}
}), "newDoc"), pt = /* @__PURE__ */ S((t) => JSON.parse(JSON.stringify(t)), "clone"), X, He = (X = class {
  constructor(e) {
    this.version = e, this.nodes = [], this.edges = [], this.rootDoc = [], this.classes = Pt(), this.documents = { root: Bt() }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.dividerCnt = 0, this.links = /* @__PURE__ */ new Map(), this.funs = [], this.getAccTitle = ae, this.setAccTitle = ne, this.getAccDescription = oe, this.setAccDescription = le, this.setDiagramTitle = ce, this.getDiagramTitle = he, this.clear(), this.setRootDoc = this.setRootDoc.bind(this), this.getDividerId = this.getDividerId.bind(this), this.setDirection = this.setDirection.bind(this), this.trimColon = this.trimColon.bind(this), this.bindFunctions = this.bindFunctions.bind(this);
  }
  /**
  ...
  handleStyleDef(e) {
    ...
    for (const i of s) {
      ...
      if (!o) {
        const h = i.trim();
        this.addState(h), o = this.getState(h);
      }
      o && (o.styles = a.map((h) => {
        var p;
        return (p = h.replace(/;/g, "")) == null ? void 0 : p.trim();
      }));
    }
  }
  setRootDoc(e) {
  ...
  docTranslator(e, s, a) {
    ...
    if (s.stmt === tt && (s.id === A.START_NODE ? (s.id = e.id + (a ? "_start" : "_end"), s.start = a) : s.id = s.id.trim()), s.stmt !== Z && s.stmt !== tt || !s.doc)
      return;
    const i = [];
    let o = [];
    for (const h of s.doc)
      if (h.type === Gt) {
        const p = pt(h);
    ...
    s.doc.forEach((h) => this.docTranslator(s, h, !0));
  }
  getRootDocV2() {
   ...
   */
  addState(e, s = rt, a = void 0, i = void 0, o = void 0, h = void 0, p = void 0, f = void 0) {
    ...
    if (i && (b.info("Setting state description", T, i), (Array.isArray(i) ? i : [i]).forEach((m) => this.addDescription(T, m.trim()))), o) {
      ...
      if (!E)
        throw new Error(`State not found: ${T}`);
      E.note = o, E.note.text = K.sanitizeText(E.note.text, F());
    }
    h && (b.info("Setting state classes", T, h), (Array.isArray(h) ? h : [h]).forEach((m) => this.setCssClass(T, m.trim()))), p && (b.info("Setting state styles", T, p), (Array.isArray(p) ? p : [p]).forEach((m) => this.setStyle(T, m.trim()))), f && (b.info("Setting state styles", T, p), (Array.isArray(f) ? f : [f]).forEach((m) => this.setTextStyle(T, m.trim())));
  }
  clear(e) {
    this.nodes = [], this.edges = [], this.funs = [this.setupToolTips.bind(this)], this.documents = { root: Bt() }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.classes = Pt(), e || (this.links = /* @__PURE__ */ new Map(), de());
  }
  getState(e) {
   ...
   *
   */
  endTypeIfNeeded(e = "", s = rt) {
    return e === A.END_NODE ? A.END_TYPE : s;
  }
  addRelationObjs(e, s, a = "") {
    const i = this.startIdIfNeeded(e.id.trim()), o = this.startTypeIfNeeded(e.id.trim(), e.type), h = this.startIdIfNeeded(s.id.trim()), p = this.startTypeIfNeeded(s.id.trim(), s.type);
    this.addState(
      i,
      o,
      e.doc,
  ...
  addRelation(e, s, a) {
    if (typeof e == "object" && typeof s == "object")
      ...
      const i = this.startIdIfNeeded(e.trim()), o = this.startTypeIfNeeded(e), h = this.endIdIfNeeded(s.trim()), p = this.endTypeIfNeeded(s);
      this.addState(i, o), this.addState(h, p), this.currentDocument.relations.push({
        id1: i,
        id2: h,
  ...
  addDescription(e, s) {
    ...
    (o = a == null ? void 0 : a.descriptions) == null || o.push(K.sanitizeText(i, F()));
  }
  cleanupLabel(e) {
  ...
  setupToolTips(e) {
    const s = pe();
    Dt(e).select("svg").selectAll("g.node, g.rough-node").on("mouseover", (o) => {
      var T;
      const h = Dt(o.currentTarget), p = h.attr("title");
      if (p === null)
        return;
      const f = (T = o.currentTarget) == null ? void 0 : T.getBoundingClientRect();
      s.transition().duration(200).style("opacity", ".9"), s.style("left", window.scrollX + f.left + (f.right - f.left) / 2 + "px").style("top", window.scrollY + f.bottom + "px"), s.html(fe.sanitize(p)), h.classed("hover", !0);
    }).on("mouseout", (o) => {
  ...
  setCssClass(e, s) {
    e.split(",").forEach((a) => {
      ...
      if (!i) {
        const h = a.trim();
        this.addState(h), i = this.getState(h);
      }
  ...
  getDirection() {
    var e;
    return ((e = this.getDirectionStatement()) == null ? void 0 : e.value) ?? Se;
  }
  setDirection(e) {
  ...
  getData() {
    ...
    return {
      ...
      other: {},
      config: e,
      direction: Xt(this.getRootDocV2())
    };
  }
  getConfig() {
    return F().state;
  }
}, S(X, "StateDB"), X.relationType = {
  AGGREGATION: 0,
  EXTENSION: 1,
  COMPOSITION: 2,
  DEPENDENCY: 3
