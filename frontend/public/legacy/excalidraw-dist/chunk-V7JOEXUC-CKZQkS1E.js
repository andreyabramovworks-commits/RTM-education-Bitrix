import { g as st } from "./chunk-5VM5RSS4-CGIUH4bS.js";
import { g as it } from "./chunk-XXDRQBXY-CPVj6w0f.js";
import { s as at } from "./chunk-VR4S4FIN-Ctv02BtH.js";
import { _ as g, l as we, c as F, v as rt, x as nt, y as Ve, d as fe, a5 as ut, b as lt, a as ct, s as ot, g as ht, o as dt, p as pt, k as I, q as At, r as ft, i as gt, a6 as z } from "./index-Cy1zwdz5.js";
import { f as mt } from "./chunk-32BRIVSS-B1UBYmjm.js";
var Pe = function() {
  var s = /* @__PURE__ */ g(function(O, o, d, p) {
    for (d = d || {}, p = O.length; p--; d[O[p]] = o) ;
    return d;
  }, "o"), i = [1, 18], a = [1, 19], r = [1, 20], n = [1, 41], u = [1, 26], h = [1, 42], f = [1, 24], c = [1, 25], m = [1, 32], B = [1, 33], R = [1, 34], b = [1, 45], me = [1, 35], Ce = [1, 36], be = [1, 37], ke = [1, 38], Ee = [1, 27], Te = [1, 28], ye = [1, 29], De = [1, 30], Fe = [1, 31], k = [1, 44], E = [1, 46], T = [1, 43], y = [1, 47], Be = [1, 9], A = [1, 8, 9], te = [1, 58], se = [1, 59], ie = [1, 60], ae = [1, 61], re = [1, 62], _e = [1, 63], Se = [1, 64], S = [1, 8, 9, 41], Me = [1, 77], G = [1, 8, 9, 12, 13, 22, 39, 41, 44, 46, 68, 69, 70, 71, 72, 73, 74, 79, 81], ne = [1, 8, 9, 12, 13, 18, 20, 22, 39, 41, 44, 46, 47, 60, 68, 69, 70, 71, 72, 73, 74, 79, 81, 86, 100, 102, 103], ue = [13, 60, 86, 100, 102, 103], K = [13, 60, 73, 74, 86, 100, 102, 103], Re = [13, 60, 68, 69, 70, 71, 72, 86, 100, 102, 103], le = [1, 103], W = [1, 121], Q = [1, 117], j = [1, 113], X = [1, 119], q = [1, 114], H = [1, 115], J = [1, 116], Z = [1, 118], $ = [1, 120], Ge = [22, 50, 60, 61, 82, 86, 87, 88, 89, 90], Ue = [1, 128], ce = [12, 39], Ne = [1, 8, 9, 39, 41, 44, 46], oe = [1, 8, 9, 22], ze = [1, 153], Ye = [1, 8, 9, 61], x = [1, 8, 9, 22, 50, 60, 61, 82, 86, 87, 88, 89, 90], Le = {
    ...
    performAction: /* @__PURE__ */ g(function(o, d, p, l, C, e, ee) {
      var t = e.length - 1;
      switch (C) {
        case 8:
          this.$ = e[t - 1];
    ...
    parse: /* @__PURE__ */ g(function(o) {
      var d = this, p = [0], l = [], C = [null], e = [], ee = this.table, t = "", de = 0, Ke = 0, Ze = 2, We = 1, $e = e.slice.call(arguments, 1), D = Object.create(this.lexer), V = { yy: {} };
      ...
      function tt(N) {
        p.length = p.length - 2 * N, C.length = C.length - N, e.length = e.length - N;
      }
      g(tt, "popStack");
      function Qe() {
        var N;
        return N = l.pop() || D.lex() || We, typeof N != "number" && (N instanceof Array && (l = N, N = l.pop()), N = d.symbols_[N] || N), N;
      }
      g(Qe, "lex");
      for (var _, P, L, Ie, U = {}, pe, v, je, Ae; ; ) {
        if (P = p[p.length - 1], this.defaultActions[P] ? L = this.defaultActions[P] : ((_ === null || typeof _ > "u") && (_ = Qe()), L = ee[P] && ee[P][_]), typeof L > "u" || !L.length || !L[0]) {
          var Oe = "";
          Ae = [];
          for (pe in ee[P])
            this.terminals_[pe] && pe > Ze && Ae.push("'" + this.terminals_[pe] + "'");
          D.showPosition ? Oe = "Parse error on line " + (de + 1) + `:
` + D.showPosition() + `
Expecting ` + Ae.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : Oe = "Parse error on line " + (de + 1) + ": Unexpected " + (_ == We ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(Oe, {
            text: D.match,
        ...
        switch (L[0]) {
          case 1:
            p.push(_), C.push(D.yytext), e.push(D.yylloc), p.push(L[1]), _ = null, Ke = D.yyleng, t = D.yytext, de = D.yylineno, ve = D.yylloc;
            break;
          case 2:
            if (v = this.productions_[L[1]][1], U.$ = C[C.length - v], U._$ = {
              ...
              return Ie;
            v && (p = p.slice(0, -1 * v * 2), C = C.slice(0, -1 * v), e = e.slice(0, -1 * v)), p.push(this.productions_[L[1]][0]), C.push(U.$), e.push(U._$), je = ee[p[p.length - 2]][p[p.length - 1]], p.push(je);
            break;
          case 3:
            return !0;
        }
    ...
    var O = {
      EOF: 1,
      parseError: /* @__PURE__ */ g(function(d, p) {
        if (this.yy.parser)
      ...
      setInput: /* @__PURE__ */ g(function(o, d) {
      ...
      unput: /* @__PURE__ */ g(function(o) {
        var d = o.length, p = o.split(/(?:\r\n?|\n)/g);
        ...
        return this.yylloc = {
          ...
          last_column: p ? (p.length === l.length ? this.yylloc.first_column : 0) + l[l.length - p.length].length - p[0].length : this.yylloc.first_column - d
        }, this.options.ranges && (this.yylloc.range = [C[0], C[0] + this.yyleng - d]), this.yyleng = this.yytext.length, this;
      }, "unput"),
...
` + d + "^";
      ...
      test_match: /* @__PURE__ */ g(function(o, d) {
        var p, l, C;
        ...
        }, this.yytext += o[0], this.match += o[0], this.matches = o, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(o[0].length), this.matched += o[0], p = this.performAction.call(this, this.yy, this, d, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), p)
          return p;
        if (this._backtrack) {
          for (var e in C)
            this[e] = C[e];
      ...
      next: /* @__PURE__ */ g(function() {
        ...
        for (var C = this._currentRules(), e = 0; e < C.length; e++)
          if (p = this._input.match(this.rules[C[e]]), p && (!d || p[0].length > d[0].length)) {
            if (d = p, l = e, this.options.backtrack_lexer) {
        ...
        return d ? (o = this.test_match(d, C[l]), o !== !1 ? o : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      options: {},
      performAction: /* @__PURE__ */ g(function(d, p, l, C) {
        switch (l) {
          case 0:
            return 62;
          case 1:
  ...
  return g(he, "Parser"), he.prototype = Le, Le.Parser = he, new he();
}();
Pe.parser = Pe;
var _t = Pe, Xe = ["#", "+", "~", "-", ""], Y, qe = (Y = class {
  constructor(i, a) {
  ...
  parseMember(i) {
    ...
    if (this.memberType === "method") {
      const u = /([#+~-])?(.+)\((.*)\)([\s$*])?(.*)([$*])?/.exec(i);
      if (u) {
        const h = u[1] ? u[1].trim() : "";
        if (Xe.includes(h) && (this.visibility = h), this.id = u[2], this.parameters = u[3] ? u[3].trim() : "", a = u[4] ? u[4].trim() : "", this.returnType = u[5] ? u[5].trim() : "", a === "") {
      ...
      const n = i.length, u = i.substring(0, 1), h = i.substring(n - 1);
      Xe.includes(u) && (this.visibility = u), /[$*]/.exec(h) && (a = h), this.id = i.substring(
        this.visibility === "" ? 0 : 1,
        a === "" ? n : n - 1
      );
    }
    this.classifier = a, this.id = this.id.startsWith(" ") ? " " + this.id.trim() : this.id.trim();
    const r = `${this.visibility ? "\\" + this.visibility : ""}${z(this.id)}${this.memberType === "method" ? `(${z(this.parameters)})${this.returnType ? " : " + z(this.returnType) : ""}` : ""}`;
...
}, g(Y, "ClassMember"), Y), ge = "classId-", He = 0, M = /* @__PURE__ */ g((s) => I.sanitizeText(s, F()), "sanitizeText"), w, St = (w = class {
  constructor() {
  ...
  addMember(i, a) {
    ...
    if (typeof a == "string") {
      const u = a.trim();
      u.startsWith("<<") && u.endsWith(">>") ? n.annotations.push(M(u.substring(2, u.length - 2))) : u.indexOf(")") > 0 ? n.methods.push(new qe(u, "method")) : u && n.members.push(new qe(u, "attribute"));
    }
  }
  addMembers(i, a) {
  ...
  setCssClass(i, a) {
    i.split(",").forEach((r) => {
      let n = r;
      /\d/.exec(r[0]) && (n = ge + n), n = this.splitClassNameAndType(n).className;
  ...
  defineClass(i, a) {
    for (const r of i) {
      ...
      n === void 0 && (n = { id: r, styles: [], textStyles: [] }, this.styleClasses.set(r, n)), a && a.forEach((u) => {
        if (/color/.exec(u)) {
          const h = u.replace("fill", "bgFill");
          n.textStyles.push(h);
        }
        n.styles.push(u);
      }), this.classes.forEach((u) => {
        u.cssClasses.includes(r) && u.styles.push(...a.flatMap((h) => h.split(",")));
      });
    }
  }
  /**
  ...
  setTooltip(i, a) {
    i.split(",").forEach((r) => {
      if (a !== void 0) {
        const n = this.splitClassNameAndType(r).className, u = this.classes.get(n);
        u && (u.tooltip = M(a));
      }
    });
  }
  ...
  setLink(i, a, r) {
    ...
    i.split(",").forEach((u) => {
      let h = u;
      /\d/.exec(u[0]) && (h = ge + h), h = this.splitClassNameAndType(h).className;
      const f = this.classes.get(h);
      f && (f.link = Ve.formatUrl(a, n), n.securityLevel === "sandbox" ? f.linkTarget = "_top" : typeof r == "string" ? f.linkTarget = M(r) : f.linkTarget = "_blank");
  ...
  setClickEvent(i, a, r) {
    i.split(",").forEach((n) => {
      ...
      const u = this.splitClassNameAndType(n).className, h = this.classes.get(u);
      h && (h.haveCallback = !0);
    }), this.setCssClass(i, "clickable");
  }
  setClickFunc(i, a, r) {
    ...
    if (F().securityLevel !== "loose" || a === void 0)
      return;
    const h = this.splitClassNameAndType(n).className;
    if (this.classes.has(h)) {
      ...
      if (typeof r == "string") {
        ...
        for (let c = 0; c < f.length; c++) {
          let m = f[c].trim();
          m.startsWith('"') && m.endsWith('"') && (m = m.substr(1, m.length - 2)), f[c] = m;
        }
      }
      f.length === 0 && f.push(h), this.functions.push(() => {
        const c = this.lookUpDomId(h), m = document.querySelector(`[id="${c}"]`);
  ...
  createNamespaceNode(i, a, r, n = !1) {
    return {
      ...
      domId: ge + i + "-" + this.namespaceCounter++,
      parent: r,
      explicit: n
    };
  }
  ...
  addNamespace(i, a) {
    ...
    if (this.namespaceStack.push(r), this.namespaces.has(r)) {
      ...
      return h.explicit = !0, a && (h.label = a), r;
    }
    const n = r.split("."), u = w.getAncestorIds(r);
    for (let h = 0; h < u.length; h++) {
      const f = u[h], c = h > 0 ? u[h - 1] : void 0, m = h === u.length - 1, B = m && a ? a : n[h];
      this.namespaces.has(f) ? m && (this.namespaces.get(f).explicit = !0) : this.namespaces.set(
        f,
        this.createNamespaceNode(f, B, c, m)
      ), c && this.linkParentChild(c, f);
    }
    return r;
  }
  popNamespace() {
  ...
  addClassesToNamespace(i, a, r) {
    if (this.namespaces.has(i)) {
      for (const n of a) {
        const { className: u } = this.splitClassNameAndType(n), h = this.getClass(u);
        h.parent = i, this.namespaces.get(i).classes.set(u, h);
      }
      for (const n of r) {
        const u = this.getNote(n);
        u.parent = i, this.namespaces.get(i).notes.set(n, u);
      }
    }
  }
  setCssStyle(i, a) {
  ...
  getData() {
    var h, f;
    const i = [], a = [], r = F(), n = ((h = r.class) == null ? void 0 : h.hierarchicalNamespaces) ?? !0;
    for (const c of this.namespaces.values()) {
      if (!n && !c.explicit)
        continue;
      const m = {
        id: c.id,
        label: n ? c.label : c.id,
        isGroup: !0,
        ...
        cssStyles: [],
        look: r.look,
        parentId: n ? c.parent : void 0
      };
      i.push(m);
    }
    for (const c of this.classes.values()) {
      const m = n ? c.parent : this.resolveExplicitAncestor(c.parent), B = {
        ...c,
        type: void 0,
        isGroup: !1,
        parentId: m,
    ...
    for (const c of this.notes.values()) {
      const m = n ? c.parent : this.resolveExplicitAncestor(c.parent), B = {
        id: c.id,
        label: c.text,
        isGroup: !1,
      ...
      i.push(B);
      const R = (f = this.classes.get(c.class)) == null ? void 0 : f.id;
      if (R) {
        const b = {
          id: `edgeNote${c.index}`,
          start: c.id,
...
}, g(w, "ClassDB"), w), Ct = /* @__PURE__ */ g((s) => `g.classGroup text {
...
.edgeLabel[data-look="neo"] {
  ...
  ${st()}
`, "getStyles"), Nt = Ct, bt = /* @__PURE__ */ g((s, i = "TB") => {
  if (!s.doc)
    return i;
  let a = i;
  ...
  return a;
}, "getDir"), kt = /* @__PURE__ */ g(function(s, i) {
  return i.db.getClasses();
}, "getClasses"), Et = /* @__PURE__ */ g(async function(s, i, a, r) {
  we.info("REF0:"), we.info("Drawing class diagram (v3)", i);
  const { securityLevel: n, state: u, layout: h } = F();
  r.db.setDiagramId(i);
  const f = r.db.getData(), c = it(i, n);
  f.type = r.type, f.layoutAlgorithm = rt(h), f.nodeSpacing = (u == null ? void 0 : u.nodeSpacing) || 50, f.rankSpacing = (u == null ? void 0 : u.rankSpacing) || 50, f.markers = ["aggregation", "extension", "composition", "dependency", "lollipop"], f.diagramId = i, await nt(f, c);
  const m = 8;
  Ve.insertTitle(
    c,
  ...
  ), at(c, m, "classDiagram", (u == null ? void 0 : u.useMaxWidth) ?? !0);
}, "draw"), Lt = {
  getClasses: kt,
  draw: Et,
  getDir: bt
