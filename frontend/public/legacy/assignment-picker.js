  ...
  function mount(host, options) {
    ...
    function render() {
      ...
      host.innerHTML =
        ...
        '<section class="rtm-picker-group rtm-picker-all"><h3>Общий выбор</h3><label class="rtm-picker-choice rtm-picker-master"><input type="checkbox" data-picker-all '+(allActive?'checked':'')+'><span class="rtm-picker-check" aria-hidden="true"></span><span>Все активные сотрудники</span></label></section>'+
