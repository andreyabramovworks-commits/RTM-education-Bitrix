...
class KnowledgeDocument(SQLModel, table=True):
    ...
    light_test_reviewers: list = Field(default_factory=list, sa_column=Column(JSON, nullable=False))
    full_test_reviewers: list = Field(default_factory=list, sa_column=Column(JSON, nullable=False))
    light_test_editors: list = Field(default_factory=list, sa_column=Column(JSON, nullable=False))
    full_test_editors: list = Field(default_factory=list, sa_column=Column(JSON, nullable=False))
    inherit_test_assignments: bool = Field(default=False, sa_column=Column(Boolean, nullable=False))
    active: bool = Field(default=True, sa_column=Column(Boolean, nullable=False))
